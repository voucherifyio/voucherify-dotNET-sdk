...
{
    public class CreateAndValidateAndRedeemGiftVoucher : IUseCase
    {
        public async Task Run(Voucherify.Api api)
        {
            try
            {
                ...
                Console.WriteLine("[Vouchers][CreateAndValidateAndRedeemGiftVoucher] Ok");
                Console.ResetColor();
            }
            catch (Exception e)
            {
                Console.ForegroundColor = ConsoleColor.DarkRed;
                Console.WriteLine("[Vouchers][CreateAndValidateAndRedeemGiftVoucher] SomethingWentWrong: {0}", e);
                Console.ResetColor();
            }
        }
    }
