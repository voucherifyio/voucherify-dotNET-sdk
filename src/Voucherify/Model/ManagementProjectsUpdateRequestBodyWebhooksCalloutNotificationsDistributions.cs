...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManagementProjectsUpdateRequestBodyWebhooksCalloutNotificationsDistributions")]
    public partial class ManagementProjectsUpdateRequestBodyWebhooksCalloutNotificationsDistributions : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagementProjectsUpdateRequestBodyWebhooksCalloutNotificationsDistributions" /> class.
        /// </summary>
        ...
        public ManagementProjectsUpdateRequestBodyWebhooksCalloutNotificationsDistributions(bool? email = default(bool?), bool? inApp = default(bool?), List<string> emails = default(List<string>))
        {
            this._Email = email;
            if (this.Email != null)
            {
