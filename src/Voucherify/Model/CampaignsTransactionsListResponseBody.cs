...
namespace Voucherify.Model
{
    ...
    public partial class CampaignsTransactionsListResponseBody : IValidatableObject
    {
        ...
        public CampaignsTransactionsListResponseBody(ObjectEnum? varObject = ObjectEnum.List, DataRefEnum? dataRef = DataRefEnum.Data, List<VoucherTransaction> data = default(List<VoucherTransaction>), bool? hasMore = default(bool?), string moreStartingAfter = default(string))
        {
            this._Data = data;
            if (this.Data != null)
            {
