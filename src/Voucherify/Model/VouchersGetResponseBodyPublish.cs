...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VouchersGetResponseBodyPublish")]
    public partial class VouchersGetResponseBodyPublish : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VouchersGetResponseBodyPublish" /> class.
        /// </summary>
        ...
        public VouchersGetResponseBodyPublish(string varObject = default(string), int? count = default(int?), string url = default(string))
        {
