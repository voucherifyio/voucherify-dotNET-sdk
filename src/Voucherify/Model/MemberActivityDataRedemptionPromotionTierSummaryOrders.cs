...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MemberActivityDataRedemptionPromotionTierSummaryOrders")]
    public partial class MemberActivityDataRedemptionPromotionTierSummaryOrders : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MemberActivityDataRedemptionPromotionTierSummaryOrders" /> class.
        /// </summary>
        ...
        public MemberActivityDataRedemptionPromotionTierSummaryOrders(int? totalAmount = default(int?), int? totalDiscountAmount = default(int?))
        {
