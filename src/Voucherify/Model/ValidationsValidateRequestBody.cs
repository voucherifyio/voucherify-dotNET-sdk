...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ValidationsValidateRequestBody")]
    public partial class ValidationsValidateRequestBody : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidationsValidateRequestBody" /> class.
        /// </summary>
        ...
        public ValidationsValidateRequestBody(ValidationsValidateRequestBodyOptions options = default(ValidationsValidateRequestBodyOptions), List<ValidationsValidateRequestBodyRedeemablesItem> redeemables = default(List<ValidationsValidateRequestBodyRedeemablesItem>), Order order = default(Order), Customer customer = default(Customer), Session session = default(Session), string trackingId = default(string), Object metadata = default(Object))
        {
        ...
        public ValidationsValidateRequestBodyOptions Options
        {
            get{ return _Options;}
            set
            {
        ...
        private ValidationsValidateRequestBodyOptions _Options;
        ...
        public List<ValidationsValidateRequestBodyRedeemablesItem> Redeemables
        {
        ...
        private List<ValidationsValidateRequestBodyRedeemablesItem> _Redeemables;
