...
namespace Voucherify.Model
{
    ...
    public partial class Voucher : IValidatableObject
    {
        ...
        public Voucher(string id = default(string), string code = default(string), string campaign = default(string), string campaignId = default(string), string category = default(string), string categoryId = default(string), TypeEnum? type = default(TypeEnum?), Discount discount = default(Discount), VoucherGift gift = default(VoucherGift), VoucherLoyaltyCard loyaltyCard = default(VoucherLoyaltyCard), DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? expirationDate = default(DateTimeOffset?), ValidityTimeframe validityTimeframe = default(ValidityTimeframe), List<ValidityDayOfWeekEnum> validityDayOfWeek = default(List<ValidityDayOfWeekEnum>), ValidityHours validityHours = default(ValidityHours), bool? active = default(bool?), string additionalInfo = default(string), Object metadata = default(Object), VoucherAssets assets = default(VoucherAssets), bool? isReferralCode = default(bool?), DateTimeOffset? createdAt = default(DateTimeOffset?), DateTimeOffset? updatedAt = default(DateTimeOffset?), string holderId = default(string), string referrerId = default(string), string varObject = default(string), VoucherPublish publish = default(VoucherPublish), VoucherRedemption redemption = default(VoucherRedemption), List<Category> categories = default(List<Category>), ValidationRulesAssignmentsList validationRulesAssignments = default(ValidationRulesAssignmentsList))
        {
            this._Id = id;
            if (this.Id != null)
            {
        ...
        */
        ...
        public VoucherLoyaltyCard LoyaltyCard
        {
        ...
        private VoucherLoyaltyCard _LoyaltyCard;
        ...
        */
        ...
        public List<Voucher.ValidityDayOfWeekEnum> ValidityDayOfWeek
        {
        ...
        private List<Voucher.ValidityDayOfWeekEnum> _ValidityDayOfWeek;
        ...
        */
        ...
        private VoucherPublish _Publish;
        ...
        private VoucherRedemption _Redemption;
