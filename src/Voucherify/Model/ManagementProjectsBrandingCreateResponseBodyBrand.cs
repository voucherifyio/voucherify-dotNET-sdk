...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManagementProjectsBrandingCreateResponseBodyBrand")]
    public partial class ManagementProjectsBrandingCreateResponseBodyBrand : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagementProjectsBrandingCreateResponseBodyBrand" /> class.
        /// </summary>
        ...
        public ManagementProjectsBrandingCreateResponseBodyBrand(string name = default(string), string privacyPolicyUrl = default(string), string termsOfUseUrl = default(string), string permissionReminder = default(string), string websiteUrl = default(string))
        {
            this._Name = name;
            if (this.Name != null)
            {
