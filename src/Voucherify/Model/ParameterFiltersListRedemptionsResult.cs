...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ParameterFiltersListRedemptionsResult")]
    public partial class ParameterFiltersListRedemptionsResult : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ParameterFiltersListRedemptionsResult" /> class.
        /// </summary>
        /// <param name="conditions">conditions.</param>
        public ParameterFiltersListRedemptionsResult(FilterConditionsString conditions = default(FilterConditionsString))
        {
