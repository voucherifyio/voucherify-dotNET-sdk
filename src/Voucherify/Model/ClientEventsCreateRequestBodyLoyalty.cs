...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ClientEventsCreateRequestBodyLoyalty")]
    public partial class ClientEventsCreateRequestBodyLoyalty : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientEventsCreateRequestBodyLoyalty" /> class.
        /// </summary>
        ...
        public ClientEventsCreateRequestBodyLoyalty(string code = default(string))
        {
            this._Code = code;
            if (this.Code != null)
            {
