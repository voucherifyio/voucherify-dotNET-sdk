...
namespace Voucherify.Model
{
    ...
    public partial class LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderTotalAmount : IValidatableObject
    {
        ...
        public LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderTotalAmount(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string))
        {
            this._Every = every;
            if (this.Every != null)
            {
