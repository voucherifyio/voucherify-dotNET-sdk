...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "QualificationsRedeemableBase")]
    public partial class QualificationsRedeemableBase : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QualificationsRedeemableBase" /> class.
        /// </summary>
        ...
        public QualificationsRedeemableBase(string id = default(string), ObjectEnum? varObject = default(ObjectEnum?), DateTimeOffset? createdAt = default(DateTimeOffset?), RedeemableResult result = default(RedeemableResult), QualificationsRedeemableBaseOrder order = default(QualificationsRedeemableBaseOrder), string validationRuleId = default(string), ApplicableToResultList applicableTo = default(ApplicableToResultList), InapplicableToResultList inapplicableTo = default(InapplicableToResultList), Object metadata = default(Object), List<CategoryWithStackingRulesType> categories = default(List<CategoryWithStackingRulesType>), string banner = default(string), string name = default(string), string campaignName = default(string), string campaignId = default(string), ValidationRulesAssignmentsList validationRulesAssignments = default(ValidationRulesAssignmentsList))
        {
            this._Id = id;
            if (this.Id != null)
            {
        ...
        */
        ...
        public QualificationsRedeemableBaseOrder Order
        {
            get{ return _Order;}
            set
            {
        ...
        private QualificationsRedeemableBaseOrder _Order;
