...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MemberActivityDataRedemptionVoucherPublish")]
    public partial class MemberActivityDataRedemptionVoucherPublish : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MemberActivityDataRedemptionVoucherPublish" /> class.
        /// </summary>
        ...
        public MemberActivityDataRedemptionVoucherPublish(string varObject = default(string), int? count = default(int?), string url = default(string))
        {
