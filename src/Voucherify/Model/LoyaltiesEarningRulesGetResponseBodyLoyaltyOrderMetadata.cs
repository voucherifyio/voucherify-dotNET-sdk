...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderMetadata")]
    public partial class LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderMetadata : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderMetadata" /> class.
        /// </summary>
        ...
        public LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderMetadata(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string), string property = default(string))
        {
            this._Every = every;
            if (this.Every != null)
            {
