...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesTiersCreateInBulkRequestBodyItem")]
    public partial class LoyaltiesTiersCreateInBulkRequestBodyItem : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesTiersCreateInBulkRequestBodyItem" /> class.
        /// </summary>
        ...
        public LoyaltiesTiersCreateInBulkRequestBodyItem(string name = default(string), Dictionary<string, MappingPoints> earningRules = default(Dictionary<string, MappingPoints>), Dictionary<string, MappingPoints> rewards = default(Dictionary<string, MappingPoints>), LoyaltyTierBasePoints points = default(LoyaltyTierBasePoints), Object metadata = default(Object))
        {
            this._Name = name;
            if (this.Name != null)
            {
