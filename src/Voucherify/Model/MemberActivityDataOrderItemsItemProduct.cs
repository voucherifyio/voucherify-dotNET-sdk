...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MemberActivityDataOrderItemsItemProduct")]
    public partial class MemberActivityDataOrderItemsItemProduct : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MemberActivityDataOrderItemsItemProduct" /> class.
        /// </summary>
        ...
        public MemberActivityDataOrderItemsItemProduct(string id = default(string), string sourceId = default(string), bool? varOverride = default(bool?), string name = default(string), Object metadata = default(Object), decimal? price = default(decimal?))
        {
            this._Id = id;
            if (this.Id != null)
            {
