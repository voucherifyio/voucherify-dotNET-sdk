...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsAmount")]
    public partial class LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsAmount : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsAmount" /> class.
        /// </summary>
        ...
        public LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsAmount(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string), ObjectEnum? varObject = default(ObjectEnum?), string id = default(string), List<LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsAmountApplicableToItem> applicableTo = default(List<LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsAmountApplicableToItem>))
        {
            this._Every = every;
            if (this.Every != null)
            {
        ...
        public List<LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsAmountApplicableToItem> ApplicableTo
        {
        ...
        private List<LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsAmountApplicableToItem> _ApplicableTo;
