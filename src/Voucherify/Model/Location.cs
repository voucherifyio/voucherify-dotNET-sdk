...
namespace Voucherify.Model
{
    ...
    public partial class Location : IValidatableObject
    {
        ...
        public Location(string id = default(string), ObjectEnum? varObject = ObjectEnum.Location, string name = default(string), LocationShape shape = default(LocationShape), DateTimeOffset? createdAt = default(DateTimeOffset?), DateTimeOffset? updatedAt = default(DateTimeOffset?))
        {
            this._Id = id;
            if (this.Id != null)
            {
