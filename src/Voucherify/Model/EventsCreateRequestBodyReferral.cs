...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EventsCreateRequestBodyReferral")]
    public partial class EventsCreateRequestBodyReferral : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EventsCreateRequestBodyReferral" /> class.
        /// </summary>
        ...
        public EventsCreateRequestBodyReferral(string code = default(string), string referrerId = default(string))
        {
            this._Code = code;
            if (this.Code != null)
            {
