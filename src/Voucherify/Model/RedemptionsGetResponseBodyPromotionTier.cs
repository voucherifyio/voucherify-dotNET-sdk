...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RedemptionsGetResponseBodyPromotionTier")]
    public partial class RedemptionsGetResponseBodyPromotionTier : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RedemptionsGetResponseBodyPromotionTier" /> class.
        /// </summary>
        ...
        public RedemptionsGetResponseBodyPromotionTier(string id = default(string), DateTimeOffset? createdAt = default(DateTimeOffset?), DateTimeOffset? updatedAt = default(DateTimeOffset?), string name = default(string), string banner = default(string), RedemptionsGetResponseBodyPromotionTierAction action = default(RedemptionsGetResponseBodyPromotionTierAction), Object metadata = default(Object), int? hierarchy = default(int?), string promotionId = default(string), RedemptionsGetResponseBodyPromotionTierCampaign campaign = default(RedemptionsGetResponseBodyPromotionTierCampaign), string campaignId = default(string), bool? active = default(bool?), DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? expirationDate = default(DateTimeOffset?), ValidityTimeframe validityTimeframe = default(ValidityTimeframe), List<ValidityDayOfWeekEnum> validityDayOfWeek = default(List<ValidityDayOfWeekEnum>), ValidityHours validityHours = default(ValidityHours), RedemptionsGetResponseBodyPromotionTierSummary summary = default(RedemptionsGetResponseBodyPromotionTierSummary), string varObject = @"promotion_tier", ValidationRuleAssignmentsList validationRuleAssignments = default(ValidationRuleAssignmentsList), string categoryId = default(string), List<Category> categories = default(List<Category>))
        {
            this._Id = id;
            if (this.Id != null)
            {
        ...
        */
        ...
        public RedemptionsGetResponseBodyPromotionTierAction Action
        {
            get{ return _Action;}
            set
            {
        ...
        private RedemptionsGetResponseBodyPromotionTierAction _Action;
        ...
        public RedemptionsGetResponseBodyPromotionTierCampaign Campaign
        {
        ...
        private RedemptionsGetResponseBodyPromotionTierCampaign _Campaign;
        ...
        */
        ...
        public List<RedemptionsGetResponseBodyPromotionTier.ValidityDayOfWeekEnum> ValidityDayOfWeek
        {
        ...
        private List<RedemptionsGetResponseBodyPromotionTier.ValidityDayOfWeekEnum> _ValidityDayOfWeek;
        ...
        public RedemptionsGetResponseBodyPromotionTierSummary Summary
        {
            get{ return _Summary;}
            set
            {
        ...
        private RedemptionsGetResponseBodyPromotionTierSummary _Summary;
