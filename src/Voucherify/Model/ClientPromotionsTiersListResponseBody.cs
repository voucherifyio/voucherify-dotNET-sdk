...
namespace Voucherify.Model
{
    ...
    public partial class ClientPromotionsTiersListResponseBody : IValidatableObject
    {
        ...
        public ClientPromotionsTiersListResponseBody(string varObject = @"list", string dataRef = @"tiers", List<PromotionTier> tiers = default(List<PromotionTier>), int? total = default(int?), bool? hasMore = default(bool?))
        {
            this._Tiers = tiers;
            if (this.Tiers != null)
            {
