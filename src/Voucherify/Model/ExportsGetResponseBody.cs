...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ExportsGetResponseBody")]
    public partial class ExportsGetResponseBody : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExportsGetResponseBody" /> class.
        /// </summary>
        ...
        public ExportsGetResponseBody(string id = default(string), ObjectEnum? varObject = default(ObjectEnum?), DateTimeOffset? createdAt = default(DateTimeOffset?), StatusEnum? status = default(StatusEnum?), string channel = default(string), ExportsGetResponseBodyResult result = default(ExportsGetResponseBodyResult), string userId = default(string), ExportedObjectEnum? exportedObject = default(ExportedObjectEnum?), ExportsGetResponseBodyParameters parameters = default(ExportsGetResponseBodyParameters))
        {
            this._Id = id;
            if (this.Id != null)
            {
        ...
        public ExportsGetResponseBodyResult Result
        {
            get{ return _Result;}
            set
            {
        ...
        private ExportsGetResponseBodyResult _Result;
        ...
        public ExportsGetResponseBodyParameters Parameters
        {
        ...
        private ExportsGetResponseBodyParameters _Parameters;
