...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RedemptionsGetResponseBodyVoucher")]
    public partial class RedemptionsGetResponseBodyVoucher : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RedemptionsGetResponseBodyVoucher" /> class.
        /// </summary>
        ...
        public RedemptionsGetResponseBodyVoucher(string id = default(string), string code = default(string), string campaign = default(string), string campaignId = default(string), string category = default(string), string categoryId = default(string), TypeEnum? type = default(TypeEnum?), Discount discount = default(Discount), RedemptionsGetResponseBodyVoucherGift gift = default(RedemptionsGetResponseBodyVoucherGift), RedemptionsGetResponseBodyVoucherLoyaltyCard loyaltyCard = default(RedemptionsGetResponseBodyVoucherLoyaltyCard), DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? expirationDate = default(DateTimeOffset?), ValidityTimeframe validityTimeframe = default(ValidityTimeframe), List<ValidityDayOfWeekEnum> validityDayOfWeek = default(List<ValidityDayOfWeekEnum>), ValidityHours validityHours = default(ValidityHours), bool? active = default(bool?), string additionalInfo = default(string), Object metadata = default(Object), VoucherAssets assets = default(VoucherAssets), bool? isReferralCode = default(bool?), DateTimeOffset? createdAt = default(DateTimeOffset?), DateTimeOffset? updatedAt = default(DateTimeOffset?), string holderId = default(string), string referrerId = default(string), string varObject = default(string), RedemptionsGetResponseBodyVoucherPublish publish = default(RedemptionsGetResponseBodyVoucherPublish), RedemptionsGetResponseBodyVoucherRedemption redemption = default(RedemptionsGetResponseBodyVoucherRedemption), List<Category> categories = default(List<Category>), ValidationRulesAssignmentsList validationRulesAssignments = default(ValidationRulesAssignmentsList), SimpleCustomer holder = default(SimpleCustomer))
        {
            this._Id = id;
            if (this.Id != null)
            {
        ...
        */
        ...
        public RedemptionsGetResponseBodyVoucherGift Gift
        {
            get{ return _Gift;}
            set
            {
        ...
        private RedemptionsGetResponseBodyVoucherGift _Gift;
        ...
        public RedemptionsGetResponseBodyVoucherLoyaltyCard LoyaltyCard
        {
        ...
        private RedemptionsGetResponseBodyVoucherLoyaltyCard _LoyaltyCard;
        ...
        */
        ...
        public List<RedemptionsGetResponseBodyVoucher.ValidityDayOfWeekEnum> ValidityDayOfWeek
        {
        ...
        private List<RedemptionsGetResponseBodyVoucher.ValidityDayOfWeekEnum> _ValidityDayOfWeek;
        ...
        */
        ...
        public RedemptionsGetResponseBodyVoucherPublish Publish
        {
            get{ return _Publish;}
            set
            {
        ...
        private RedemptionsGetResponseBodyVoucherPublish _Publish;
        ...
        public RedemptionsGetResponseBodyVoucherRedemption Redemption
        {
        ...
        private RedemptionsGetResponseBodyVoucherRedemption _Redemption;
