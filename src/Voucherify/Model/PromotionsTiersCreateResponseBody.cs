...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PromotionsTiersCreateResponseBody")]
    public partial class PromotionsTiersCreateResponseBody : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PromotionsTiersCreateResponseBody" /> class.
        /// </summary>
        ...
        public PromotionsTiersCreateResponseBody(string id = default(string), DateTimeOffset? createdAt = default(DateTimeOffset?), DateTimeOffset? updatedAt = default(DateTimeOffset?), string name = default(string), string banner = default(string), PromotionsTiersCreateResponseBodyAction action = default(PromotionsTiersCreateResponseBodyAction), Object metadata = default(Object), int? hierarchy = default(int?), string promotionId = default(string), PromotionsTiersCreateResponseBodyCampaign campaign = default(PromotionsTiersCreateResponseBodyCampaign), string campaignId = default(string), bool? active = default(bool?), DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? expirationDate = default(DateTimeOffset?), ValidityTimeframe validityTimeframe = default(ValidityTimeframe), List<ValidityDayOfWeekEnum> validityDayOfWeek = default(List<ValidityDayOfWeekEnum>), ValidityHours validityHours = default(ValidityHours), PromotionsTiersCreateResponseBodySummary summary = default(PromotionsTiersCreateResponseBodySummary), string varObject = @"promotion_tier", ValidationRuleAssignmentsList validationRuleAssignments = default(ValidationRuleAssignmentsList), string categoryId = default(string), List<Category> categories = default(List<Category>))
        {
            this._Id = id;
            if (this.Id != null)
            {
        ...
        */
        ...
        public PromotionsTiersCreateResponseBodyAction Action
        {
            get{ return _Action;}
            set
            {
        ...
        private PromotionsTiersCreateResponseBodyAction _Action;
        ...
        public PromotionsTiersCreateResponseBodyCampaign Campaign
        {
        ...
        private PromotionsTiersCreateResponseBodyCampaign _Campaign;
        ...
        */
        ...
        public List<PromotionsTiersCreateResponseBody.ValidityDayOfWeekEnum> ValidityDayOfWeek
        {
        ...
        private List<PromotionsTiersCreateResponseBody.ValidityDayOfWeekEnum> _ValidityDayOfWeek;
        ...
        public PromotionsTiersCreateResponseBodySummary Summary
        {
            get{ return _Summary;}
            set
            {
        ...
        private PromotionsTiersCreateResponseBodySummary _Summary;
