...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CustomersGetResponseBodyAssets")]
    public partial class CustomersGetResponseBodyAssets : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomersGetResponseBodyAssets" /> class.
        /// </summary>
        ...
        public CustomersGetResponseBodyAssets(string cockpitUrl = default(string), string cockpitPreferenceCenterUrl = default(string))
        {
