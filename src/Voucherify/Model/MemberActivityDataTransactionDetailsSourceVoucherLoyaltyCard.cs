...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MemberActivityDataTransactionDetailsSourceVoucherLoyaltyCard")]
    public partial class MemberActivityDataTransactionDetailsSourceVoucherLoyaltyCard : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MemberActivityDataTransactionDetailsSourceVoucherLoyaltyCard" /> class.
        /// </summary>
        ...
        public MemberActivityDataTransactionDetailsSourceVoucherLoyaltyCard(int? points = default(int?), int? balance = default(int?), string nextExpirationDate = default(string), int? nextExpirationPoints = default(int?), int? pendingPoints = default(int?), int? expiredPoints = default(int?), int? subtractedPoints = default(int?))
        {
            this._Points = points;
            if (this.Points != null)
            {
