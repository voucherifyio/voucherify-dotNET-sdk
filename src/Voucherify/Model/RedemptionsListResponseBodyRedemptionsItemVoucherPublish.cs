...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RedemptionsListResponseBodyRedemptionsItemVoucherPublish")]
    public partial class RedemptionsListResponseBodyRedemptionsItemVoucherPublish : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RedemptionsListResponseBodyRedemptionsItemVoucherPublish" /> class.
        /// </summary>
        ...
        public RedemptionsListResponseBodyRedemptionsItemVoucherPublish(string varObject = default(string), int? count = default(int?), string url = default(string))
        {
