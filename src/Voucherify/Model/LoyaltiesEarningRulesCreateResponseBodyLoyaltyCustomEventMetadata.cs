...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesCreateResponseBodyLoyaltyCustomEventMetadata")]
    public partial class LoyaltiesEarningRulesCreateResponseBodyLoyaltyCustomEventMetadata : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesCreateResponseBodyLoyaltyCustomEventMetadata" /> class.
        /// </summary>
        ...
        public LoyaltiesEarningRulesCreateResponseBodyLoyaltyCustomEventMetadata(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string), string property = default(string))
        {
            this._Every = every;
            if (this.Every != null)
            {
