...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RedeemableVoucherRedemption")]
    public partial class RedeemableVoucherRedemption : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RedeemableVoucherRedemption" /> class.
        /// </summary>
        ...
        public RedeemableVoucherRedemption(int? quantity = default(int?), int? redeemedQuantity = default(int?), int? redeemedPoints = default(int?), string varObject = default(string), string url = default(string))
        {
