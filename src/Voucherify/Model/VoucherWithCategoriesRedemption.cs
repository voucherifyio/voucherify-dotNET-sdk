...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VoucherWithCategoriesRedemption")]
    public partial class VoucherWithCategoriesRedemption : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VoucherWithCategoriesRedemption" /> class.
        /// </summary>
        ...
        public VoucherWithCategoriesRedemption(int? quantity = default(int?), int? redeemedQuantity = default(int?), int? redeemedPoints = default(int?), string varObject = default(string), string url = default(string))
        {
