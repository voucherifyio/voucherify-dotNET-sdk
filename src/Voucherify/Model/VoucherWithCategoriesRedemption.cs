...
namespace Voucherify.Model
{
    ...
    public partial class VoucherWithCategoriesRedemption : IValidatableObject
    {
        ...
        public VoucherWithCategoriesRedemption(int? quantity = default(int?), int? redeemedQuantity = default(int?), int? redeemedPoints = default(int?), string varObject = @"list", string url = default(string))
        {
