...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PromotionTierSummaryRedemptions")]
    public partial class PromotionTierSummaryRedemptions : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PromotionTierSummaryRedemptions" /> class.
        /// </summary>
        /// <param name="totalRedeemed">Number of times the promotion tier was redeemed..</param>
        public PromotionTierSummaryRedemptions(int? totalRedeemed = default(int?))
        {
