...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderTotalAmount")]
    public partial class LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderTotalAmount : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderTotalAmount" /> class.
        /// </summary>
        ...
        public LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderTotalAmount(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string))
        {
            this._Every = every;
            if (this.Every != null)
            {
