...
namespace Voucherify.Model
{
    ...
    public partial class User : IValidatableObject
    {
        ...
        public User(string id = default(string), string login = default(string), string email = default(string), string firstName = default(string), string lastName = default(string), Dictionary<string, string> projects = default(Dictionary<string, string>), bool? isOwner = default(bool?))
        {
            this._Id = id;
            if (this.Id != null)
            {
