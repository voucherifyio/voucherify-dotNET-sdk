...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MemberActivityDataRedemptionRelatedRedemptionsRedemptionsItem")]
    public partial class MemberActivityDataRedemptionRelatedRedemptionsRedemptionsItem : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MemberActivityDataRedemptionRelatedRedemptionsRedemptionsItem" /> class.
        /// </summary>
        ...
        public MemberActivityDataRedemptionRelatedRedemptionsRedemptionsItem(string id = default(string), DateTimeOffset date = default(DateTimeOffset))
        {
            this._Id = id;
            if (this.Id != null)
            {
