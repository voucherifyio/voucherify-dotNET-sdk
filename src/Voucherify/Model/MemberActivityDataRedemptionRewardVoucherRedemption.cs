...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MemberActivityDataRedemptionRewardVoucherRedemption")]
    public partial class MemberActivityDataRedemptionRewardVoucherRedemption : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MemberActivityDataRedemptionRewardVoucherRedemption" /> class.
        /// </summary>
        ...
        public MemberActivityDataRedemptionRewardVoucherRedemption(int? quantity = default(int?), int? redeemedQuantity = default(int?), int? redeemedPoints = default(int?), string varObject = default(string), string url = default(string))
        {
