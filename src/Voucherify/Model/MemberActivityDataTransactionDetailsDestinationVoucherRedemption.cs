...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MemberActivityDataTransactionDetailsDestinationVoucherRedemption")]
    public partial class MemberActivityDataTransactionDetailsDestinationVoucherRedemption : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MemberActivityDataTransactionDetailsDestinationVoucherRedemption" /> class.
        /// </summary>
        ...
        public MemberActivityDataTransactionDetailsDestinationVoucherRedemption(int? quantity = default(int?), int? redeemedQuantity = default(int?), int? redeemedPoints = default(int?))
        {
