...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ParameterFiltersListRedemptionsRelatedObjectId")]
    public partial class ParameterFiltersListRedemptionsRelatedObjectId : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ParameterFiltersListRedemptionsRelatedObjectId" /> class.
        /// </summary>
        /// <param name="conditions">conditions.</param>
        public ParameterFiltersListRedemptionsRelatedObjectId(FilterConditionsString conditions = default(FilterConditionsString))
        {
