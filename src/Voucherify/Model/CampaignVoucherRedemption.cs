...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CampaignVoucherRedemption")]
    public partial class CampaignVoucherRedemption : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignVoucherRedemption" /> class.
        /// </summary>
        /// <param name="quantity">How many times a voucher can be redeemed. A &#x60;null&#x60; value means unlimited..</param>
        public CampaignVoucherRedemption(int? quantity = default(int?))
        {
