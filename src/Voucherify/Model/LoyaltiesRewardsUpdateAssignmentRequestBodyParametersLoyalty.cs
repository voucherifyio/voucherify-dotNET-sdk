...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesRewardsUpdateAssignmentRequestBodyParametersLoyalty")]
    public partial class LoyaltiesRewardsUpdateAssignmentRequestBodyParametersLoyalty : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesRewardsUpdateAssignmentRequestBodyParametersLoyalty" /> class.
        /// </summary>
        /// <param name="points">Defines how many points are required to obtain the reward..</param>
        ...
        public LoyaltiesRewardsUpdateAssignmentRequestBodyParametersLoyalty(int? points = default(int?), bool? autoRedeem = default(bool?))
        {
            this._Points = points;
            if (this.Points != null)
            {
        ...
        /// </summary>
        /// <value>Defines how many points are required to obtain the reward.</value>
