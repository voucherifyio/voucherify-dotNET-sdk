...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RedemptionsListResponseBodyRedemptionsItemPromotionTierSummaryOrders")]
    public partial class RedemptionsListResponseBodyRedemptionsItemPromotionTierSummaryOrders : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RedemptionsListResponseBodyRedemptionsItemPromotionTierSummaryOrders" /> class.
        /// </summary>
        ...
        public RedemptionsListResponseBodyRedemptionsItemPromotionTierSummaryOrders(int? totalAmount = default(int?), int? totalDiscountAmount = default(int?))
        {
