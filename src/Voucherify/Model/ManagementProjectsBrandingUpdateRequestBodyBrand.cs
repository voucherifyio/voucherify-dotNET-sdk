...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManagementProjectsBrandingUpdateRequestBodyBrand")]
    public partial class ManagementProjectsBrandingUpdateRequestBodyBrand : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagementProjectsBrandingUpdateRequestBodyBrand" /> class.
        /// </summary>
        /// <param name="name">Defines brand name..</param>
        /// <param name="privacyPolicyUrl">Defines the URL to the brand&#39;s privacy policy..</param>
        /// <param name="termsOfUseUrl">Defines the URL to the brand&#39;s terms of use..</param>
        /// <param name="permissionReminder">Defines the message that is displayed to customers who opted in an email newsletter..</param>
        /// <param name="websiteUrl">Defines the URL to the brand&#39;s website..</param>
        public ManagementProjectsBrandingUpdateRequestBodyBrand(string name = default(string), string privacyPolicyUrl = default(string), string termsOfUseUrl = default(string), string permissionReminder = default(string), string websiteUrl = default(string))
        {
            this._Name = name;
            if (this.Name != null)
            {
        ...
        /// </summary>
        /// <value>Defines the URL to the brand&#39;s privacy policy.</value>
        ...
        /// </summary>
        /// <value>Defines the URL to the brand&#39;s terms of use.</value>
        ...
        /// </summary>
        /// <value>Defines the URL to the brand&#39;s website.</value>
