...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsSubtotalAmount")]
    public partial class LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsSubtotalAmount : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsSubtotalAmount" /> class.
        /// </summary>
        ...
        public LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsSubtotalAmount(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string), ObjectEnum? varObject = default(ObjectEnum?), string id = default(string), List<LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsSubtotalAmountApplicableToItem> applicableTo = default(List<LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsSubtotalAmountApplicableToItem>))
        {
            this._Every = every;
            if (this.Every != null)
            {
        ...
        public List<LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsSubtotalAmountApplicableToItem> ApplicableTo
        {
        ...
        private List<LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsSubtotalAmountApplicableToItem> _ApplicableTo;
