...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManagementProjectsBrandingCreateRequestBodyAddress")]
    public partial class ManagementProjectsBrandingCreateRequestBodyAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagementProjectsBrandingCreateRequestBodyAddress" /> class.
        /// </summary>
        ...
        public ManagementProjectsBrandingCreateRequestBodyAddress(string street = default(string), string city = default(string), string postal = default(string), string state = default(string), string country = default(string))
        {
            this._Street = street;
            if (this.Street != null)
            {
