...
namespace Voucherify.Model
{
    ...
    public partial class Product : IValidatableObject
    {
        ...
        public Product(string id = default(string), string sourceId = default(string), string name = default(string), int? price = default(int?), List<string> attributes = default(List<string>), Object metadata = default(Object), string imageUrl = default(string), DateTimeOffset? createdAt = default(DateTimeOffset?), DateTimeOffset? updatedAt = default(DateTimeOffset?), ObjectEnum? varObject = ObjectEnum.Product, SkusListForProduct skus = default(SkusListForProduct))
        {
            this._Id = id;
            if (this.Id != null)
            {
