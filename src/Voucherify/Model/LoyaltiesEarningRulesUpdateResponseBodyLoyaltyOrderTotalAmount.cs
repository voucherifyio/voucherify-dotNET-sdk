...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderTotalAmount")]
    public partial class LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderTotalAmount : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderTotalAmount" /> class.
        /// </summary>
        ...
        public LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderTotalAmount(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string))
        {
            this._Every = every;
            if (this.Every != null)
            {
