...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManagementProjectWebhooksCalloutNotificationsWebhooks")]
    public partial class ManagementProjectWebhooksCalloutNotificationsWebhooks : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagementProjectWebhooksCalloutNotificationsWebhooks" /> class.
        /// </summary>
        ...
        public ManagementProjectWebhooksCalloutNotificationsWebhooks(bool? email = default(bool?), bool? inApp = default(bool?), List<string> emails = default(List<string>))
        {
            this._Email = email;
            if (this.Email != null)
            {
