...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManagementProjectsBrandingUpdateRequestBodyAddress")]
    public partial class ManagementProjectsBrandingUpdateRequestBodyAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagementProjectsBrandingUpdateRequestBodyAddress" /> class.
        /// </summary>
        ...
        public ManagementProjectsBrandingUpdateRequestBodyAddress(string street = default(string), string city = default(string), string postal = default(string), string state = default(string), string country = default(string))
        {
            this._Street = street;
            if (this.Street != null)
            {
