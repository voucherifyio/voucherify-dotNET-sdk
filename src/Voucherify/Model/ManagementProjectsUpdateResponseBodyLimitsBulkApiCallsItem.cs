...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManagementProjectsUpdateResponseBodyLimitsBulkApiCallsItem")]
    public partial class ManagementProjectsUpdateResponseBodyLimitsBulkApiCallsItem : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagementProjectsUpdateResponseBodyLimitsBulkApiCallsItem" /> class.
        /// </summary>
        ...
        public ManagementProjectsUpdateResponseBodyLimitsBulkApiCallsItem(int value = default(int), string duration = default(string))
        {
            this._Value = value;
            if (this.Value != null)
            {
