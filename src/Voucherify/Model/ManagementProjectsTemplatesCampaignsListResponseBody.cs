...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManagementProjectsTemplatesCampaignsListResponseBody")]
    public partial class ManagementProjectsTemplatesCampaignsListResponseBody : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagementProjectsTemplatesCampaignsListResponseBody" /> class.
        /// </summary>
        /// <param name="varObject">The type of the object represented by JSON. This object stores information about campaign templates. (default to ObjectEnum.List).</param>
        /// <param name="dataRef">Identifies the name of the JSON property that contains the array of campaign templates. (default to DataRefEnum.Data).</param>
        ...
        public ManagementProjectsTemplatesCampaignsListResponseBody(ObjectEnum? varObject = ObjectEnum.List, DataRefEnum? dataRef = DataRefEnum.Data, List<CampaignTemplate> data = default(List<CampaignTemplate>), int? total = default(int?), bool? hasMore = default(bool?), string moreStartingAfter = default(string))
        {
            this._Data = data;
            if (this.Data != null)
            {
