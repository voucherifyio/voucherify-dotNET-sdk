...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltyTierPoints")]
    public partial class LoyaltyTierPoints : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltyTierPoints" /> class.
        /// </summary>
        /// <param name="from">Bottom points threshold value..</param>
        /// <param name="to">Top points threshold value..</param>
        public LoyaltyTierPoints(int? from = default(int?), int? to = default(int?))
        {
            this._From = from;
            if (this.From != null)
            {
