...
namespace Voucherify.Model
{
    ...
    public partial class ValidationRulesUpdateRequestBody : IValidatableObject
    {
        ...
        public ValidationRulesUpdateRequestBody(string name = default(string), Object rules = default(Object), Object bundleRules = default(Object), ValidationRuleError error = default(ValidationRuleError), ValidationRulesUpdateRequestBodyApplicableTo applicableTo = default(ValidationRulesUpdateRequestBodyApplicableTo), TypeEnum? type = default(TypeEnum?), ContextTypeEnum? contextType = default(ContextTypeEnum?))
        {
            this._Name = name;
            if (this.Name != null)
            {
