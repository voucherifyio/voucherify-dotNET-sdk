...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PromotionsTiersDisableResponseBodySummaryRedemptions")]
    public partial class PromotionsTiersDisableResponseBodySummaryRedemptions : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PromotionsTiersDisableResponseBodySummaryRedemptions" /> class.
        /// </summary>
        /// <param name="totalRedeemed">Number of times the promotion tier was redeemed..</param>
        public PromotionsTiersDisableResponseBodySummaryRedemptions(int? totalRedeemed = default(int?))
        {
