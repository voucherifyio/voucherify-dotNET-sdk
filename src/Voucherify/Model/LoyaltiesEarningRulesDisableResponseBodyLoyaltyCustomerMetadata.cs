...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesDisableResponseBodyLoyaltyCustomerMetadata")]
    public partial class LoyaltiesEarningRulesDisableResponseBodyLoyaltyCustomerMetadata : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesDisableResponseBodyLoyaltyCustomerMetadata" /> class.
        /// </summary>
        ...
        public LoyaltiesEarningRulesDisableResponseBodyLoyaltyCustomerMetadata(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string), string property = default(string))
        {
            this._Every = every;
            if (this.Every != null)
            {
