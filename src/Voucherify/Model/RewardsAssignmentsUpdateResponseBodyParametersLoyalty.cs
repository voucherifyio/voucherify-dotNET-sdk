...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RewardsAssignmentsUpdateResponseBodyParametersLoyalty")]
    public partial class RewardsAssignmentsUpdateResponseBodyParametersLoyalty : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RewardsAssignmentsUpdateResponseBodyParametersLoyalty" /> class.
        /// </summary>
        ...
        public RewardsAssignmentsUpdateResponseBodyParametersLoyalty(int? points = default(int?), bool? autoRedeem = default(bool?))
        {
            this._Points = points;
            if (this.Points != null)
            {
