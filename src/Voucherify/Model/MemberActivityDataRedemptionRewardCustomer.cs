...
namespace Voucherify.Model
{
    ...
    public partial class MemberActivityDataRedemptionRewardCustomer : IValidatableObject
    {
        ...
        public MemberActivityDataRedemptionRewardCustomer(string id = default(string), string name = default(string), string email = default(string), string sourceId = default(string), Object metadata = default(Object), ObjectEnum? varObject = default(ObjectEnum?))
        {
            this._Id = id;
            if (this.Id != null)
            {
