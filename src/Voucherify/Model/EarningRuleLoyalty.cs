...
namespace Voucherify.Model
{
    ...
    /// EarningRuleLoyalty
    /// </summary>
    [DataContract(Name = "EarningRuleLoyalty")]
    public partial class EarningRuleLoyalty : IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EarningRuleLoyalty" /> class.
        /// </summary>
        ...
        public EarningRuleLoyalty(TypeEnum? type = default(TypeEnum?), int? points = default(int?), string pointsFormula = default(string), CalculationTypeEnum? calculationType = default(CalculationTypeEnum?), EarningRuleLoyaltyOrder order = default(EarningRuleLoyaltyOrder), EarningRuleLoyaltyOrderItems orderItems = default(EarningRuleLoyaltyOrderItems), EarningRuleLoyaltyCustomer customer = default(EarningRuleLoyaltyCustomer), EarningRuleLoyaltyCustomEvent customEvent = default(EarningRuleLoyaltyCustomEvent))
        {
            this._Type = type;
            if (this.Type != null)
            {
        ...
        public EarningRuleLoyaltyOrder Order
        {
            get{ return _Order;}
            set
            {
        ...
        private EarningRuleLoyaltyOrder _Order;
        ...
        public EarningRuleLoyaltyOrderItems OrderItems
        {
        ...
        private EarningRuleLoyaltyOrderItems _OrderItems;
        ...
        public EarningRuleLoyaltyCustomer Customer
        {
        ...
        private EarningRuleLoyaltyCustomer _Customer;
        ...
        public EarningRuleLoyaltyCustomEvent CustomEvent
        {
        ...
        private EarningRuleLoyaltyCustomEvent _CustomEvent;
