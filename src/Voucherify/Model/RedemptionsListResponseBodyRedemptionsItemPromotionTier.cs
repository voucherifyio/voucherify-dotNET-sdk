...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RedemptionsListResponseBodyRedemptionsItemPromotionTier")]
    public partial class RedemptionsListResponseBodyRedemptionsItemPromotionTier : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RedemptionsListResponseBodyRedemptionsItemPromotionTier" /> class.
        /// </summary>
        ...
        public RedemptionsListResponseBodyRedemptionsItemPromotionTier(string id = default(string), DateTimeOffset? createdAt = default(DateTimeOffset?), DateTimeOffset? updatedAt = default(DateTimeOffset?), string name = default(string), string banner = default(string), RedemptionsListResponseBodyRedemptionsItemPromotionTierAction action = default(RedemptionsListResponseBodyRedemptionsItemPromotionTierAction), Object metadata = default(Object), int? hierarchy = default(int?), string promotionId = default(string), RedemptionsListResponseBodyRedemptionsItemPromotionTierCampaign campaign = default(RedemptionsListResponseBodyRedemptionsItemPromotionTierCampaign), string campaignId = default(string), bool? active = default(bool?), DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? expirationDate = default(DateTimeOffset?), ValidityTimeframe validityTimeframe = default(ValidityTimeframe), List<ValidityDayOfWeekEnum> validityDayOfWeek = default(List<ValidityDayOfWeekEnum>), ValidityHours validityHours = default(ValidityHours), RedemptionsListResponseBodyRedemptionsItemPromotionTierSummary summary = default(RedemptionsListResponseBodyRedemptionsItemPromotionTierSummary), string varObject = @"promotion_tier", ValidationRuleAssignmentsList validationRuleAssignments = default(ValidationRuleAssignmentsList), string categoryId = default(string), List<Category> categories = default(List<Category>))
        {
            this._Id = id;
            if (this.Id != null)
            {
        ...
        */
        ...
        public RedemptionsListResponseBodyRedemptionsItemPromotionTierAction Action
        {
            get{ return _Action;}
            set
            {
        ...
        private RedemptionsListResponseBodyRedemptionsItemPromotionTierAction _Action;
        ...
        public RedemptionsListResponseBodyRedemptionsItemPromotionTierCampaign Campaign
        {
        ...
        private RedemptionsListResponseBodyRedemptionsItemPromotionTierCampaign _Campaign;
        ...
        */
        ...
        public List<RedemptionsListResponseBodyRedemptionsItemPromotionTier.ValidityDayOfWeekEnum> ValidityDayOfWeek
        {
        ...
        private List<RedemptionsListResponseBodyRedemptionsItemPromotionTier.ValidityDayOfWeekEnum> _ValidityDayOfWeek;
        ...
        public RedemptionsListResponseBodyRedemptionsItemPromotionTierSummary Summary
        {
            get{ return _Summary;}
            set
            {
        ...
        private RedemptionsListResponseBodyRedemptionsItemPromotionTierSummary _Summary;
