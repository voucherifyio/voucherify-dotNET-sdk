...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RedemptionEntryVoucherPublish")]
    public partial class RedemptionEntryVoucherPublish : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RedemptionEntryVoucherPublish" /> class.
        /// </summary>
        ...
        public RedemptionEntryVoucherPublish(string varObject = default(string), int? count = default(int?), string url = default(string))
        {
