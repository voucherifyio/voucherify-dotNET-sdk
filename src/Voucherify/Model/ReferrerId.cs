...
namespace Voucherify.Model
{
    ...
    /// ReferrerId
    /// </summary>
    [DataContract(Name = "ReferrerId")]
    public partial class ReferrerId : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ReferrerId" /> class.
        /// </summary>
        ...
        public ReferrerId(string id = default(string), ObjectEnum? varObject = ObjectEnum.Customer)
        {
            this._Id = id;
            if (this.Id != null)
            {
