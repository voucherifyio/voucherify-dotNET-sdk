...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesRewardsGetResponseBodyParametersLoyalty")]
    public partial class LoyaltiesRewardsGetResponseBodyParametersLoyalty : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesRewardsGetResponseBodyParametersLoyalty" /> class.
        /// </summary>
        ...
        public LoyaltiesRewardsGetResponseBodyParametersLoyalty(int? points = default(int?), bool? autoRedeem = default(bool?))
        {
            this._Points = points;
            if (this.Points != null)
            {
