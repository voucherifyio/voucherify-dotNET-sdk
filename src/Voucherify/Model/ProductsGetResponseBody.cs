...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProductsGetResponseBody")]
    public partial class ProductsGetResponseBody : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductsGetResponseBody" /> class.
        /// </summary>
        ...
        public ProductsGetResponseBody(string id = default(string), string sourceId = default(string), string name = default(string), int? price = default(int?), List<string> attributes = default(List<string>), Object metadata = default(Object), string imageUrl = default(string), DateTimeOffset? createdAt = default(DateTimeOffset?), DateTimeOffset? updatedAt = default(DateTimeOffset?), ObjectEnum? varObject = default(ObjectEnum?), SkusListForProduct skus = default(SkusListForProduct))
        {
            this._Id = id;
            if (this.Id != null)
            {
