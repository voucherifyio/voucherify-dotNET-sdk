...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyCustomerMetadata")]
    public partial class LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyCustomerMetadata : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyCustomerMetadata" /> class.
        /// </summary>
        ...
        /// <param name="property">Customer metadata property..</param>
        public LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyCustomerMetadata(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string), string property = default(string))
        {
            this._Every = every;
            if (this.Every != null)
            {
        ...
        /// </summary>
        /// <value>Customer metadata property.</value>
