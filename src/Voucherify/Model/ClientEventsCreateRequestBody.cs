...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ClientEventsCreateRequestBody")]
    public partial class ClientEventsCreateRequestBody : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientEventsCreateRequestBody" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ClientEventsCreateRequestBody() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientEventsCreateRequestBody" /> class.
        /// </summary>
        ...
        public ClientEventsCreateRequestBody(string varEvent = default(string), Customer customer = default(Customer), ClientEventsCreateRequestBodyReferral referral = default(ClientEventsCreateRequestBodyReferral), ClientEventsCreateRequestBodyLoyalty loyalty = default(ClientEventsCreateRequestBodyLoyalty), Object metadata = default(Object))
        {
            // to ensure "customer" is required (not null)
            if (customer == null)
            {
                throw new ArgumentNullException("customer is a required property for ClientEventsCreateRequestBody and cannot be null");
            }
        ...
        public ClientEventsCreateRequestBodyReferral Referral
        {
        ...
        private ClientEventsCreateRequestBodyReferral _Referral;
        ...
        public ClientEventsCreateRequestBodyLoyalty Loyalty
        {
            get{ return _Loyalty;}
            set
            {
        ...
        private ClientEventsCreateRequestBodyLoyalty _Loyalty;
