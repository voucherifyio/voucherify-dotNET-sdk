...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderMetadata")]
    public partial class LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderMetadata : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderMetadata" /> class.
        /// </summary>
        ...
        public LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderMetadata(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string), string property = default(string))
        {
            this._Every = every;
            if (this.Every != null)
            {
