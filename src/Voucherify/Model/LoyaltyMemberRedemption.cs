...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltyMemberRedemption")]
    public partial class LoyaltyMemberRedemption : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltyMemberRedemption" /> class.
        /// </summary>
        ...
        public LoyaltyMemberRedemption(int? quantity = default(int?), int? redeemedQuantity = default(int?), int? redeemedPoints = default(int?), string varObject = default(string), string url = default(string))
        {
