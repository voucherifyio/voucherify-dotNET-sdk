...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VouchersImportCreateItemRequestBodyRedemption")]
    public partial class VouchersImportCreateItemRequestBodyRedemption : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VouchersImportCreateItemRequestBodyRedemption" /> class.
        /// </summary>
        /// <param name="quantity">How many times a voucher can be redeemed. A &#x60;null&#x60; value means unlimited..</param>
        public VouchersImportCreateItemRequestBodyRedemption(int? quantity = default(int?))
        {
