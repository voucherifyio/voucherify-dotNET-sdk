...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RedemptionVoucher")]
    public partial class RedemptionVoucher : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RedemptionVoucher" /> class.
        /// </summary>
        ...
        public RedemptionVoucher(string id = default(string), string code = default(string), string campaign = default(string), string campaignId = default(string), string category = default(string), string categoryId = default(string), TypeEnum? type = default(TypeEnum?), Discount discount = default(Discount), RedemptionVoucherGift gift = default(RedemptionVoucherGift), RedemptionVoucherLoyaltyCard loyaltyCard = default(RedemptionVoucherLoyaltyCard), DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? expirationDate = default(DateTimeOffset?), ValidityTimeframe validityTimeframe = default(ValidityTimeframe), List<ValidityDayOfWeekEnum> validityDayOfWeek = default(List<ValidityDayOfWeekEnum>), ValidityHours validityHours = default(ValidityHours), bool? active = default(bool?), string additionalInfo = default(string), Object metadata = default(Object), VoucherAssets assets = default(VoucherAssets), bool? isReferralCode = default(bool?), DateTimeOffset? createdAt = default(DateTimeOffset?), DateTimeOffset? updatedAt = default(DateTimeOffset?), string holderId = default(string), string referrerId = default(string), string varObject = default(string), RedemptionVoucherPublish publish = default(RedemptionVoucherPublish), RedemptionVoucherRedemption redemption = default(RedemptionVoucherRedemption), List<CategoryWithStackingRulesType> categories = default(List<CategoryWithStackingRulesType>), ValidationRulesAssignmentsList validationRulesAssignments = default(ValidationRulesAssignmentsList), SimpleCustomer holder = default(SimpleCustomer))
        {
            this._Id = id;
            if (this.Id != null)
            {
        ...
        */
        ...
        public RedemptionVoucherGift Gift
        {
            get{ return _Gift;}
            set
            {
        ...
        private RedemptionVoucherGift _Gift;
        ...
        public RedemptionVoucherLoyaltyCard LoyaltyCard
        {
        ...
        private RedemptionVoucherLoyaltyCard _LoyaltyCard;
        ...
        */
        ...
        public List<RedemptionVoucher.ValidityDayOfWeekEnum> ValidityDayOfWeek
        {
        ...
        private List<RedemptionVoucher.ValidityDayOfWeekEnum> _ValidityDayOfWeek;
        ...
        */
        ...
        public RedemptionVoucherPublish Publish
        {
            get{ return _Publish;}
            set
            {
        ...
        private RedemptionVoucherPublish _Publish;
        ...
        public RedemptionVoucherRedemption Redemption
        {
        ...
        private RedemptionVoucherRedemption _Redemption;
