...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MemberActivityDataRedemptionVoucherGift")]
    public partial class MemberActivityDataRedemptionVoucherGift : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MemberActivityDataRedemptionVoucherGift" /> class.
        /// </summary>
        ...
        public MemberActivityDataRedemptionVoucherGift(decimal? amount = default(decimal?), int? subtractedAmount = default(int?), decimal? balance = default(decimal?), EffectEnum? effect = default(EffectEnum?))
        {
            this._Amount = amount;
            if (this.Amount != null)
            {
