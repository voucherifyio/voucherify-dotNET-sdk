...
namespace Voucherify.Model
{
    ...
    /// Customer&#39;s address.
    /// </summary>
    [DataContract(Name = "CustomersUpdateRequestBodyAddress")]
    public partial class CustomersUpdateRequestBodyAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomersUpdateRequestBodyAddress" /> class.
        /// </summary>
        ...
        public CustomersUpdateRequestBodyAddress(string city = default(string), string state = default(string), string line1 = default(string), string line2 = default(string), string country = default(string), string postalCode = default(string))
        {
            this._City = city;
            if (this.City != null)
            {
