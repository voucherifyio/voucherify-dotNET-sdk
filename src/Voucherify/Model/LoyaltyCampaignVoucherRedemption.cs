...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltyCampaignVoucherRedemption")]
    public partial class LoyaltyCampaignVoucherRedemption : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltyCampaignVoucherRedemption" /> class.
        /// </summary>
        /// <param name="quantity">How many times a voucher can be redeemed. A &#x60;null&#x60; value means unlimited..</param>
        public LoyaltyCampaignVoucherRedemption(int? quantity = default(int?))
        {
