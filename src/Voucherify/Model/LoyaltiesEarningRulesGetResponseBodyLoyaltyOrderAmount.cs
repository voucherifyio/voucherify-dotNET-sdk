...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderAmount")]
    public partial class LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderAmount : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderAmount" /> class.
        /// </summary>
        ...
        public LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderAmount(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string))
        {
            this._Every = every;
            if (this.Every != null)
            {
