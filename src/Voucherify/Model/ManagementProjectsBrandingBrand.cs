...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManagementProjectsBrandingBrand")]
    public partial class ManagementProjectsBrandingBrand : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagementProjectsBrandingBrand" /> class.
        /// </summary>
        ...
        public ManagementProjectsBrandingBrand(string name = default(string), string privacyPolicyUrl = default(string), string termsOfUseUrl = default(string), string permissionReminder = default(string), string websiteUrl = default(string))
        {
            this._Name = name;
            if (this.Name != null)
            {
