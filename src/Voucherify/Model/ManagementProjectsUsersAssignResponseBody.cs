...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManagementProjectsUsersAssignResponseBody")]
    public partial class ManagementProjectsUsersAssignResponseBody : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagementProjectsUsersAssignResponseBody" /> class.
        /// </summary>
        ...
        public ManagementProjectsUsersAssignResponseBody(string id = default(string), string login = default(string), string email = default(string), string firstName = default(string), string lastName = default(string), Dictionary<string, string> projects = default(Dictionary<string, string>), bool? isOwner = default(bool?))
        {
            this._Id = id;
            if (this.Id != null)
            {
