...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesCreateResponseBodyLoyaltyCustomerMetadata")]
    public partial class LoyaltiesEarningRulesCreateResponseBodyLoyaltyCustomerMetadata : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesCreateResponseBodyLoyaltyCustomerMetadata" /> class.
        /// </summary>
        ...
        public LoyaltiesEarningRulesCreateResponseBodyLoyaltyCustomerMetadata(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string), string property = default(string))
        {
            this._Every = every;
            if (this.Every != null)
            {
