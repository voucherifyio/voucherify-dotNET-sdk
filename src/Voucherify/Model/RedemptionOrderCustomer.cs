...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RedemptionOrderCustomer")]
    public partial class RedemptionOrderCustomer : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RedemptionOrderCustomer" /> class.
        /// </summary>
        ...
        public RedemptionOrderCustomer(string id = default(string), ObjectEnum? varObject = ObjectEnum.Customer)
        {
            this._Id = id;
            if (this.Id != null)
            {
