...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PromotionsTiersGetResponseBodySummaryOrders")]
    public partial class PromotionsTiersGetResponseBodySummaryOrders : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PromotionsTiersGetResponseBodySummaryOrders" /> class.
        /// </summary>
        ...
        public PromotionsTiersGetResponseBodySummaryOrders(int? totalAmount = default(int?), int? totalDiscountAmount = default(int?))
        {
