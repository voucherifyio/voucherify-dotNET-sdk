...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManagementProjectsGetResponseBodyWebhooksCalloutNotificationsWebhooks")]
    public partial class ManagementProjectsGetResponseBodyWebhooksCalloutNotificationsWebhooks : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagementProjectsGetResponseBodyWebhooksCalloutNotificationsWebhooks" /> class.
        /// </summary>
        ...
        public ManagementProjectsGetResponseBodyWebhooksCalloutNotificationsWebhooks(bool? email = default(bool?), bool? inApp = default(bool?), List<string> emails = default(List<string>))
        {
            this._Email = email;
            if (this.Email != null)
            {
