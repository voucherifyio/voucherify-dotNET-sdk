...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RedemptionsListResponseBodyRedemptionsItemCustomer")]
    public partial class RedemptionsListResponseBodyRedemptionsItemCustomer : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RedemptionsListResponseBodyRedemptionsItemCustomer" /> class.
        /// </summary>
        ...
        public RedemptionsListResponseBodyRedemptionsItemCustomer(string id = default(string), string name = default(string), string email = default(string), string sourceId = default(string), Object metadata = default(Object), ObjectEnum? varObject = ObjectEnum.Customer)
        {
            this._Id = id;
            if (this.Id != null)
            {
