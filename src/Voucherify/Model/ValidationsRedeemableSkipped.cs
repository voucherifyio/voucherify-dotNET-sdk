...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ValidationsRedeemableSkipped")]
    public partial class ValidationsRedeemableSkipped : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidationsRedeemableSkipped" /> class.
        /// </summary>
        /// <param name="status">Indicates whether the redeemable can be applied or not applied based on the validation rules. (default to StatusEnum.SKIPPED).</param>
        ...
        public ValidationsRedeemableSkippedResult Result
        {
            get{ return _Result;}
            set
            {
        ...
        private ValidationsRedeemableSkippedResult _Result;
