...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderAmount")]
    public partial class LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderAmount : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderAmount" /> class.
        /// </summary>
        ...
        public LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderAmount(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string))
        {
            this._Every = every;
            if (this.Every != null)
            {
