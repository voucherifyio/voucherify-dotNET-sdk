...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesCreateRequestBodyItemSource")]
    public partial class LoyaltiesEarningRulesCreateRequestBodyItemSource : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesCreateRequestBodyItemSource" /> class.
        /// </summary>
        /// <param name="banner">Name of the earning rule. This is displayed as a header for the earning rule in the Dashboard..</param>
        public LoyaltiesEarningRulesCreateRequestBodyItemSource(string banner = default(string))
        {
            this._Banner = banner;
            if (this.Banner != null)
            {
