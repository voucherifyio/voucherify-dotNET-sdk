...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SegmentsCreateResponseBody")]
    public partial class SegmentsCreateResponseBody : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SegmentsCreateResponseBody" /> class.
        /// </summary>
        ...
        public SegmentsCreateResponseBody(string id = default(string), string name = default(string), DateTimeOffset? createdAt = default(DateTimeOffset?), DateTimeOffset? updatedAt = default(DateTimeOffset?), TypeEnum? type = default(TypeEnum?), Object filter = default(Object), ObjectEnum? varObject = default(ObjectEnum?))
        {
            this._Id = id;
            if (this.Id != null)
            {
