...
namespace Voucherify.Model
{
    ...
    public partial class SegmentsCreateResponseBody : IValidatableObject
    {
        ...
        public SegmentsCreateResponseBody(string id = default(string), string name = default(string), DateTimeOffset? createdAt = default(DateTimeOffset?), TypeEnum? type = default(TypeEnum?), Object filter = default(Object), ObjectEnum? varObject = default(ObjectEnum?), DateTimeOffset? updatedAt = default(DateTimeOffset?))
        {
            this._Id = id;
            if (this.Id != null)
            {
