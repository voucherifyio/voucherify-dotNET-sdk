...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MemberActivityDataRedemptionOrderItemsItemSku")]
    public partial class MemberActivityDataRedemptionOrderItemsItemSku : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MemberActivityDataRedemptionOrderItemsItemSku" /> class.
        /// </summary>
        ...
        public MemberActivityDataRedemptionOrderItemsItemSku(string id = default(string), string sourceId = default(string), bool? varOverride = default(bool?), string sku = default(string), decimal? price = default(decimal?), Object metadata = default(Object))
        {
            this._Id = id;
            if (this.Id != null)
            {
