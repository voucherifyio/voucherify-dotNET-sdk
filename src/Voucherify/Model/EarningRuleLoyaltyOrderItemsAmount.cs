...
namespace Voucherify.Model
{
    ...
    public partial class EarningRuleLoyaltyOrderItemsAmount : IValidatableObject
    {
        ...
        public EarningRuleLoyaltyOrderItemsAmount(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string), ObjectEnum? varObject = default(ObjectEnum?), string id = default(string), List<EarningRuleLoyaltyOrderItemsAmountApplicableToItem> applicableTo = default(List<EarningRuleLoyaltyOrderItemsAmountApplicableToItem>))
        {
            this._Every = every;
            if (this.Every != null)
            {
        ...
        public List<EarningRuleLoyaltyOrderItemsAmountApplicableToItem> ApplicableTo
        {
        ...
        private List<EarningRuleLoyaltyOrderItemsAmountApplicableToItem> _ApplicableTo;
