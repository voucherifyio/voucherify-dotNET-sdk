...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManagementProjectsCreateRequestBodyWebhooksCalloutNotificationsWebhooks")]
    public partial class ManagementProjectsCreateRequestBodyWebhooksCalloutNotificationsWebhooks : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagementProjectsCreateRequestBodyWebhooksCalloutNotificationsWebhooks" /> class.
        /// </summary>
        ...
        public ManagementProjectsCreateRequestBodyWebhooksCalloutNotificationsWebhooks(bool? email = default(bool?), bool? inApp = default(bool?), List<string> emails = default(List<string>))
        {
            this._Email = email;
            if (this.Email != null)
            {
