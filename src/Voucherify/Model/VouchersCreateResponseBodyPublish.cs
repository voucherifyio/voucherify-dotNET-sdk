...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VouchersCreateResponseBodyPublish")]
    public partial class VouchersCreateResponseBodyPublish : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VouchersCreateResponseBodyPublish" /> class.
        /// </summary>
        ...
        public VouchersCreateResponseBodyPublish(string varObject = default(string), int? count = default(int?), string url = default(string))
        {
