...
namespace Voucherify.Model
{
    ...
    public partial class Category : IValidatableObject
    {
        ...
        public Category(string id = default(string), string name = default(string), int? hierarchy = default(int?), ObjectEnum? varObject = ObjectEnum.Category, DateTimeOffset? createdAt = default(DateTimeOffset?), DateTimeOffset? updatedAt = default(DateTimeOffset?))
        {
            this._Id = id;
            if (this.Id != null)
            {
