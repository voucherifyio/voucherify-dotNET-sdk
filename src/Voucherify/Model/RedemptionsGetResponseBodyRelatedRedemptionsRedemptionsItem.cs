...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RedemptionsGetResponseBodyRelatedRedemptionsRedemptionsItem")]
    public partial class RedemptionsGetResponseBodyRelatedRedemptionsRedemptionsItem : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RedemptionsGetResponseBodyRelatedRedemptionsRedemptionsItem" /> class.
        /// </summary>
        ...
        public RedemptionsGetResponseBodyRelatedRedemptionsRedemptionsItem(string id = default(string), DateTimeOffset date = default(DateTimeOffset))
        {
            this._Id = id;
            if (this.Id != null)
            {
