...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CampaignLoyaltyVoucherRedemption")]
    public partial class CampaignLoyaltyVoucherRedemption : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignLoyaltyVoucherRedemption" /> class.
        /// </summary>
        /// <param name="quantity">How many times a voucher can be redeemed. A &#x60;null&#x60; value means unlimited..</param>
        public CampaignLoyaltyVoucherRedemption(int? quantity = default(int?))
        {
