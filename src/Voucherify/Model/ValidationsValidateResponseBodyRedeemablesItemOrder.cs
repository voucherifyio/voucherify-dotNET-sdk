...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ValidationsValidateResponseBodyRedeemablesItemOrder")]
    public partial class ValidationsValidateResponseBodyRedeemablesItemOrder : IValidatableObject
    {
        /// <summary>
        /// The order status.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidationsValidateResponseBodyRedeemablesItemOrder" /> class.
        /// </summary>
        ...
        public ValidationsValidateResponseBodyRedeemablesItemOrder(string id = default(string), string sourceId = default(string), StatusEnum? status = default(StatusEnum?), int? amount = default(int?), int? initialAmount = default(int?), int? discountAmount = default(int?), int? itemsDiscountAmount = default(int?), int? totalDiscountAmount = default(int?), int? totalAmount = default(int?), int? appliedDiscountAmount = default(int?), int? itemsAppliedDiscountAmount = default(int?), int? totalAppliedDiscountAmount = default(int?), Object metadata = default(Object), ObjectEnum? varObject = default(ObjectEnum?), DateTimeOffset? createdAt = default(DateTimeOffset?), DateTimeOffset? updatedAt = default(DateTimeOffset?), string customerId = default(string), string referrerId = default(string), ValidationsValidateResponseBodyRedeemablesItemOrderCustomer customer = default(ValidationsValidateResponseBodyRedeemablesItemOrderCustomer), ValidationsValidateResponseBodyRedeemablesItemOrderReferrer referrer = default(ValidationsValidateResponseBodyRedeemablesItemOrderReferrer), Dictionary<string, OrderRedemptionsEntry> redemptions = default(Dictionary<string, OrderRedemptionsEntry>), List<OrderCalculatedItem> items = default(List<OrderCalculatedItem>))
        {
            this._Id = id;
            if (this.Id != null)
            {
        ...
        */
        ...
        public ValidationsValidateResponseBodyRedeemablesItemOrderCustomer Customer
        {
        ...
        private ValidationsValidateResponseBodyRedeemablesItemOrderCustomer _Customer;
        ...
        public ValidationsValidateResponseBodyRedeemablesItemOrderReferrer Referrer
        {
        ...
        private ValidationsValidateResponseBodyRedeemablesItemOrderReferrer _Referrer;
