...
namespace Voucherify.Model
{
    ...
    public partial class LoyaltiesEarningRulesUpdateRequestBodyLoyalty : IValidatableObject
    {
        ...
        public LoyaltiesEarningRulesUpdateRequestBodyLoyalty(TypeEnum? type = default(TypeEnum?), int? points = default(int?), CalculationTypeEnum? calculationType = default(CalculationTypeEnum?), LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrder order = default(LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrder), LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItems orderItems = default(LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItems), LoyaltiesEarningRulesUpdateRequestBodyLoyaltyCustomer customer = default(LoyaltiesEarningRulesUpdateRequestBodyLoyaltyCustomer), LoyaltiesEarningRulesUpdateRequestBodyLoyaltyCustomEvent customEvent = default(LoyaltiesEarningRulesUpdateRequestBodyLoyaltyCustomEvent))
        {
            this._Type = type;
            if (this.Type != null)
            {
