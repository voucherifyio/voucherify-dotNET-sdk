...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesUpdateRequestBodyLoyalty")]
    public partial class LoyaltiesEarningRulesUpdateRequestBodyLoyalty : IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesUpdateRequestBodyLoyalty" /> class.
        /// </summary>
        ...
        public LoyaltiesEarningRulesUpdateRequestBodyLoyalty(TypeEnum? type = default(TypeEnum?), int? points = default(int?), string pointsFormula = default(string), CalculationTypeEnum? calculationType = default(CalculationTypeEnum?), LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrder order = default(LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrder), LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItems orderItems = default(LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItems), LoyaltiesEarningRulesUpdateRequestBodyLoyaltyCustomer customer = default(LoyaltiesEarningRulesUpdateRequestBodyLoyaltyCustomer), LoyaltiesEarningRulesUpdateRequestBodyLoyaltyCustomEvent customEvent = default(LoyaltiesEarningRulesUpdateRequestBodyLoyaltyCustomEvent))
        {
            this._Type = type;
            if (this.Type != null)
            {
        ...
        public LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrder Order
        {
            get{ return _Order;}
            set
            {
        ...
        private LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrder _Order;
        ...
        public LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItems OrderItems
        {
        ...
        private LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItems _OrderItems;
        ...
        public LoyaltiesEarningRulesUpdateRequestBodyLoyaltyCustomer Customer
        {
        ...
        private LoyaltiesEarningRulesUpdateRequestBodyLoyaltyCustomer _Customer;
        ...
        public LoyaltiesEarningRulesUpdateRequestBodyLoyaltyCustomEvent CustomEvent
        {
        ...
        private LoyaltiesEarningRulesUpdateRequestBodyLoyaltyCustomEvent _CustomEvent;
