...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsAmount")]
    public partial class LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsAmount : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsAmount" /> class.
        /// </summary>
        ...
        public LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsAmount(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string), ObjectEnum? varObject = default(ObjectEnum?), string id = default(string), List<LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsAmountApplicableToItem> applicableTo = default(List<LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsAmountApplicableToItem>))
        {
            this._Every = every;
            if (this.Every != null)
            {
        ...
        public List<LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsAmountApplicableToItem> ApplicableTo
        {
        ...
        private List<LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItemsAmountApplicableToItem> _ApplicableTo;
