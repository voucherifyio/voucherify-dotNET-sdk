...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsSubtotalAmount")]
    public partial class LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsSubtotalAmount : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsSubtotalAmount" /> class.
        /// </summary>
        ...
        public LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsSubtotalAmount(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string), ObjectEnum? varObject = default(ObjectEnum?), string id = default(string), List<LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsSubtotalAmountApplicableToItem> applicableTo = default(List<LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsSubtotalAmountApplicableToItem>))
        {
            this._Every = every;
            if (this.Every != null)
            {
        ...
        public List<LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsSubtotalAmountApplicableToItem> ApplicableTo
        {
        ...
        private List<LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsSubtotalAmountApplicableToItem> _ApplicableTo;
