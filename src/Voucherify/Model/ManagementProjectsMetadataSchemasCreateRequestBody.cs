...
namespace Voucherify.Model
{
    ...
    public partial class ManagementProjectsMetadataSchemasCreateRequestBody : IValidatableObject
    {
        ...
        public ManagementProjectsMetadataSchemasCreateRequestBody(string relatedObject = default(string), bool? allowDefinedOnly = default(bool?), Dictionary<string, ManagementProjectsMetadataSchemaDefinition> properties = default(Dictionary<string, ManagementProjectsMetadataSchemaDefinition>))
        {
