...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RewardsAssignmentsUpdateRequestBodyParametersLoyalty")]
    public partial class RewardsAssignmentsUpdateRequestBodyParametersLoyalty : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RewardsAssignmentsUpdateRequestBodyParametersLoyalty" /> class.
        /// </summary>
        ...
        public RewardsAssignmentsUpdateRequestBodyParametersLoyalty(int? points = default(int?), bool? autoRedeem = default(bool?))
        {
            this._Points = points;
            if (this.Points != null)
            {
