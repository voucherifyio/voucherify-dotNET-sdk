...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrdersExportCreateRequestBodyParameters")]
    public partial class OrdersExportCreateRequestBodyParameters : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OrdersExportCreateRequestBodyParameters" /> class.
        /// </summary>
        ...
        public OrdersExportCreateRequestBodyParameters(ExportOrderOrder? order = default(ExportOrderOrder?), List<ExportOrderFields> fields = default(List<ExportOrderFields>), Object filters = default(Object))
        {
            this._Order = order;
            if (this.Order != null)
            {
