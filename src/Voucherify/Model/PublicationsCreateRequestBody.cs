...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PublicationsCreateRequestBody")]
    public partial class PublicationsCreateRequestBody : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PublicationsCreateRequestBody" /> class.
        /// </summary>
        /// <param name="voucher">Code of the voucher being published..</param>
        ...
        public PublicationsCreateRequestBody(string voucher = default(string), string sourceId = default(string), Customer customer = default(Customer), Object metadata = default(Object), string channel = default(string), CreatePublicationCampaign campaign = default(CreatePublicationCampaign))
        {
        ...
        /// </summary>
        /// <value>Code of the voucher being published.</value>
        ...
        public CreatePublicationCampaign Campaign
        {
        ...
        private CreatePublicationCampaign _Campaign;
