...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PromotionsTiersEnableResponseBody")]
    public partial class PromotionsTiersEnableResponseBody : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PromotionsTiersEnableResponseBody" /> class.
        /// </summary>
        ...
        public PromotionsTiersEnableResponseBody(string id = default(string), DateTimeOffset? createdAt = default(DateTimeOffset?), DateTimeOffset? updatedAt = default(DateTimeOffset?), string name = default(string), string banner = default(string), PromotionsTiersEnableResponseBodyAction action = default(PromotionsTiersEnableResponseBodyAction), Object metadata = default(Object), int? hierarchy = default(int?), string promotionId = default(string), PromotionsTiersEnableResponseBodyCampaign campaign = default(PromotionsTiersEnableResponseBodyCampaign), string campaignId = default(string), bool? active = default(bool?), DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? expirationDate = default(DateTimeOffset?), ValidityTimeframe validityTimeframe = default(ValidityTimeframe), List<ValidityDayOfWeekEnum> validityDayOfWeek = default(List<ValidityDayOfWeekEnum>), ValidityHours validityHours = default(ValidityHours), PromotionsTiersEnableResponseBodySummary summary = default(PromotionsTiersEnableResponseBodySummary), string varObject = @"promotion_tier", ValidationRuleAssignmentsList validationRuleAssignments = default(ValidationRuleAssignmentsList), string categoryId = default(string), List<Category> categories = default(List<Category>))
        {
            this._Id = id;
            if (this.Id != null)
            {
        ...
        */
        ...
        public PromotionsTiersEnableResponseBodyAction Action
        {
            get{ return _Action;}
            set
            {
        ...
        private PromotionsTiersEnableResponseBodyAction _Action;
        ...
        public PromotionsTiersEnableResponseBodyCampaign Campaign
        {
        ...
        private PromotionsTiersEnableResponseBodyCampaign _Campaign;
        ...
        */
        ...
        public List<PromotionsTiersEnableResponseBody.ValidityDayOfWeekEnum> ValidityDayOfWeek
        {
        ...
        private List<PromotionsTiersEnableResponseBody.ValidityDayOfWeekEnum> _ValidityDayOfWeek;
        ...
        public PromotionsTiersEnableResponseBodySummary Summary
        {
            get{ return _Summary;}
            set
            {
        ...
        private PromotionsTiersEnableResponseBodySummary _Summary;
