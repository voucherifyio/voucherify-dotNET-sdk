...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManagementProjectsGetResponseBodyLimits")]
    public partial class ManagementProjectsGetResponseBodyLimits : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagementProjectsGetResponseBodyLimits" /> class.
        /// </summary>
        /// <param name="apiCalls">apiCalls.</param>
        /// <param name="bulkApiCalls">bulkApiCalls.</param>
        public ManagementProjectsGetResponseBodyLimits(List<ManagementProjectsGetResponseBodyLimitsApiCallsItem> apiCalls = default(List<ManagementProjectsGetResponseBodyLimitsApiCallsItem>), List<ManagementProjectsGetResponseBodyLimitsBulkApiCallsItem> bulkApiCalls = default(List<ManagementProjectsGetResponseBodyLimitsBulkApiCallsItem>))
        {
        ...
        public List<ManagementProjectsGetResponseBodyLimitsApiCallsItem> ApiCalls
        {
        ...
        private List<ManagementProjectsGetResponseBodyLimitsApiCallsItem> _ApiCalls;
        ...
        public List<ManagementProjectsGetResponseBodyLimitsBulkApiCallsItem> BulkApiCalls
        {
        ...
        private List<ManagementProjectsGetResponseBodyLimitsBulkApiCallsItem> _BulkApiCalls;
