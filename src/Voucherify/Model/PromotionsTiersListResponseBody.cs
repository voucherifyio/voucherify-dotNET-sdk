...
namespace Voucherify.Model
{
    ...
    public partial class PromotionsTiersListResponseBody : IValidatableObject
    {
        ...
        public PromotionsTiersListResponseBody(string varObject = default(string), string dataRef = default(string), List<PromotionTier> tiers = default(List<PromotionTier>), int? total = default(int?), bool? hasMore = default(bool?))
        {
