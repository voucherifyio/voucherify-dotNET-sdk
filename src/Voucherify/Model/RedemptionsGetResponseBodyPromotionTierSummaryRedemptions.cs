...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RedemptionsGetResponseBodyPromotionTierSummaryRedemptions")]
    public partial class RedemptionsGetResponseBodyPromotionTierSummaryRedemptions : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RedemptionsGetResponseBodyPromotionTierSummaryRedemptions" /> class.
        /// </summary>
        /// <param name="totalRedeemed">Number of times the promotion tier was redeemed..</param>
        public RedemptionsGetResponseBodyPromotionTierSummaryRedemptions(int? totalRedeemed = default(int?))
        {
