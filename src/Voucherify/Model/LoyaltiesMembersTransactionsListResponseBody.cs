...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesMembersTransactionsListResponseBody")]
    public partial class LoyaltiesMembersTransactionsListResponseBody : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesMembersTransactionsListResponseBody" /> class.
        /// </summary>
        ...
        public LoyaltiesMembersTransactionsListResponseBody(ObjectEnum? varObject = default(ObjectEnum?), DataRefEnum? dataRef = default(DataRefEnum?), List<LoyaltyCardTransaction> data = default(List<LoyaltyCardTransaction>), bool? hasMore = default(bool?), string moreStartingAfter = default(string))
        {
        ...
        public List<LoyaltyCardTransaction> Data
        {
            get{ return _Data;}
            set
            {
        ...
        private List<LoyaltyCardTransaction> _Data;
