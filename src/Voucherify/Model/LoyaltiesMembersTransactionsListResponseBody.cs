...
namespace Voucherify.Model
{
    ...
    public partial class LoyaltiesMembersTransactionsListResponseBody : IValidatableObject
    {
        ...
        public LoyaltiesMembersTransactionsListResponseBody(ObjectEnum? varObject = ObjectEnum.List, DataRefEnum? dataRef = DataRefEnum.Data, List<LoyaltyCardTransaction> data = default(List<LoyaltyCardTransaction>), bool? hasMore = default(bool?), string moreStartingAfter = default(string))
        {
            this._Data = data;
            if (this.Data != null)
            {
