...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CustomersUpdateRequestBody")]
    public partial class CustomersUpdateRequestBody : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomersUpdateRequestBody" /> class.
        /// </summary>
        ...
        public CustomersUpdateRequestBody(string name = default(string), string description = default(string), string email = default(string), string phone = default(string), DateTime? birthday = default(DateTime?), DateTime? birthdate = default(DateTime?), CustomersUpdateRequestBodyAddress address = default(CustomersUpdateRequestBodyAddress), Object metadata = default(Object))
        {
            this._Name = name;
            if (this.Name != null)
            {
        ...
        public CustomersUpdateRequestBodyAddress Address
        {
            get{ return _Address;}
            set
            {
        ...
        private CustomersUpdateRequestBodyAddress _Address;
