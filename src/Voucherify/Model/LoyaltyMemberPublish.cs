...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltyMemberPublish")]
    public partial class LoyaltyMemberPublish : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltyMemberPublish" /> class.
        /// </summary>
        ...
        public LoyaltyMemberPublish(string varObject = default(string), int? count = default(int?), string url = default(string))
        {
