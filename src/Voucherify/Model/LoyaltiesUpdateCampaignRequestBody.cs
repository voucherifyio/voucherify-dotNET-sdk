...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesUpdateCampaignRequestBody")]
    public partial class LoyaltiesUpdateCampaignRequestBody : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesUpdateCampaignRequestBody" /> class.
        /// </summary>
        ...
        public LoyaltiesUpdateCampaignRequestBody(DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? expirationDate = default(DateTimeOffset?), ValidityTimeframe validityTimeframe = default(ValidityTimeframe), List<ValidityDayOfWeekEnum> validityDayOfWeek = default(List<ValidityDayOfWeekEnum>), ValidityHours validityHours = default(ValidityHours), string description = default(string), string category = default(string), Object metadata = default(Object), List<string> unsetMetadataFields = default(List<string>), string categoryId = default(string), AccessSettings accessSettings = default(AccessSettings), string activityDurationAfterPublishing = default(string), bool? joinOnce = default(bool?), bool? autoJoin = default(bool?), TypeEnum? type = default(TypeEnum?), LoyaltyTiersExpirationAll loyaltyTiersExpiration = default(LoyaltyTiersExpirationAll), LoyaltiesUpdateCampaignRequestBodyOptions options = default(LoyaltiesUpdateCampaignRequestBodyOptions))
        {
        ...
        */
        ...
        public List<LoyaltiesUpdateCampaignRequestBody.ValidityDayOfWeekEnum> ValidityDayOfWeek
        {
        ...
        private List<LoyaltiesUpdateCampaignRequestBody.ValidityDayOfWeekEnum> _ValidityDayOfWeek;
        ...
        */
        ...
        public LoyaltiesUpdateCampaignRequestBodyOptions Options
        {
            get{ return _Options;}
            set
            {
        ...
        private LoyaltiesUpdateCampaignRequestBodyOptions _Options;
