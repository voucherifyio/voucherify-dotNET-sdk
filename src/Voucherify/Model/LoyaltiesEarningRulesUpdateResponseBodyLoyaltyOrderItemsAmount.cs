...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsAmount")]
    public partial class LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsAmount : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsAmount" /> class.
        /// </summary>
        ...
        public LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsAmount(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string), ObjectEnum? varObject = default(ObjectEnum?), string id = default(string), List<LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsAmountApplicableToItem> applicableTo = default(List<LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsAmountApplicableToItem>))
        {
            this._Every = every;
            if (this.Every != null)
            {
        ...
        public List<LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsAmountApplicableToItem> ApplicableTo
        {
        ...
        private List<LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItemsAmountApplicableToItem> _ApplicableTo;
