...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VouchersGetResponseBody")]
    public partial class VouchersGetResponseBody : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VouchersGetResponseBody" /> class.
        /// </summary>
        ...
        public VouchersGetResponseBody(string id = default(string), string code = default(string), string campaign = default(string), string campaignId = default(string), string category = default(string), string categoryId = default(string), TypeEnum? type = default(TypeEnum?), Discount discount = default(Discount), VouchersGetResponseBodyGift gift = default(VouchersGetResponseBodyGift), VouchersGetResponseBodyLoyaltyCard loyaltyCard = default(VouchersGetResponseBodyLoyaltyCard), DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? expirationDate = default(DateTimeOffset?), ValidityTimeframe validityTimeframe = default(ValidityTimeframe), List<ValidityDayOfWeekEnum> validityDayOfWeek = default(List<ValidityDayOfWeekEnum>), ValidityHours validityHours = default(ValidityHours), bool? active = default(bool?), string additionalInfo = default(string), Object metadata = default(Object), VoucherAssets assets = default(VoucherAssets), bool? isReferralCode = default(bool?), DateTimeOffset? createdAt = default(DateTimeOffset?), DateTimeOffset? updatedAt = default(DateTimeOffset?), string holderId = default(string), string referrerId = default(string), string varObject = default(string), VouchersGetResponseBodyPublish publish = default(VouchersGetResponseBodyPublish), VouchersGetResponseBodyRedemption redemption = default(VouchersGetResponseBodyRedemption), List<Category> categories = default(List<Category>), ValidationRulesAssignmentsList validationRulesAssignments = default(ValidationRulesAssignmentsList))
        {
            this._Id = id;
            if (this.Id != null)
            {
        ...
        */
        ...
        public VouchersGetResponseBodyGift Gift
        {
            get{ return _Gift;}
            set
            {
        ...
        private VouchersGetResponseBodyGift _Gift;
        ...
        public VouchersGetResponseBodyLoyaltyCard LoyaltyCard
        {
        ...
        private VouchersGetResponseBodyLoyaltyCard _LoyaltyCard;
        ...
        */
        ...
        public List<VouchersGetResponseBody.ValidityDayOfWeekEnum> ValidityDayOfWeek
        {
        ...
        private List<VouchersGetResponseBody.ValidityDayOfWeekEnum> _ValidityDayOfWeek;
        ...
        */
        ...
        public VouchersGetResponseBodyPublish Publish
        {
            get{ return _Publish;}
            set
            {
        ...
        private VouchersGetResponseBodyPublish _Publish;
        ...
        public VouchersGetResponseBodyRedemption Redemption
        {
        ...
        private VouchersGetResponseBodyRedemption _Redemption;
