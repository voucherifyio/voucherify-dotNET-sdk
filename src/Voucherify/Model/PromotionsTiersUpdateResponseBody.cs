...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PromotionsTiersUpdateResponseBody")]
    public partial class PromotionsTiersUpdateResponseBody : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PromotionsTiersUpdateResponseBody" /> class.
        /// </summary>
        ...
        public PromotionsTiersUpdateResponseBody(string id = default(string), DateTimeOffset? createdAt = default(DateTimeOffset?), DateTimeOffset? updatedAt = default(DateTimeOffset?), string name = default(string), string banner = default(string), PromotionsTiersUpdateResponseBodyAction action = default(PromotionsTiersUpdateResponseBodyAction), Object metadata = default(Object), int? hierarchy = default(int?), string promotionId = default(string), PromotionsTiersUpdateResponseBodyCampaign campaign = default(PromotionsTiersUpdateResponseBodyCampaign), string campaignId = default(string), bool? active = default(bool?), DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? expirationDate = default(DateTimeOffset?), ValidityTimeframe validityTimeframe = default(ValidityTimeframe), List<ValidityDayOfWeekEnum> validityDayOfWeek = default(List<ValidityDayOfWeekEnum>), ValidityHours validityHours = default(ValidityHours), PromotionsTiersUpdateResponseBodySummary summary = default(PromotionsTiersUpdateResponseBodySummary), string varObject = default(string), ValidationRuleAssignmentsList validationRuleAssignments = default(ValidationRuleAssignmentsList), string categoryId = default(string), List<Category> categories = default(List<Category>))
        {
            this._Id = id;
            if (this.Id != null)
            {
        ...
        */
        ...
        public PromotionsTiersUpdateResponseBodyAction Action
        {
            get{ return _Action;}
            set
            {
        ...
        private PromotionsTiersUpdateResponseBodyAction _Action;
        ...
        public PromotionsTiersUpdateResponseBodyCampaign Campaign
        {
        ...
        private PromotionsTiersUpdateResponseBodyCampaign _Campaign;
        ...
        */
        ...
        public List<PromotionsTiersUpdateResponseBody.ValidityDayOfWeekEnum> ValidityDayOfWeek
        {
        ...
        private List<PromotionsTiersUpdateResponseBody.ValidityDayOfWeekEnum> _ValidityDayOfWeek;
        ...
        public PromotionsTiersUpdateResponseBodySummary Summary
        {
            get{ return _Summary;}
            set
            {
        ...
        private PromotionsTiersUpdateResponseBodySummary _Summary;
