...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VouchersUpdateResponseBodyPublish")]
    public partial class VouchersUpdateResponseBodyPublish : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VouchersUpdateResponseBodyPublish" /> class.
        /// </summary>
        ...
        public VouchersUpdateResponseBodyPublish(string varObject = default(string), int? count = default(int?), string url = default(string))
        {
