...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RewardTypeProduct")]
    public partial class RewardTypeProduct : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RewardTypeProduct" /> class.
        /// </summary>
        ...
        public RewardTypeProduct(string id = default(string), string skuId = default(string))
        {
            this._Id = id;
            if (this.Id != null)
            {
