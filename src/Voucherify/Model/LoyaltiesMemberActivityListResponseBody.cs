...
namespace Voucherify.Model
{
    ...
    public partial class LoyaltiesMemberActivityListResponseBody : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="varObject">The type of the object represented by JSON. This object stores information about member activities in a dictionary. (default to ObjectEnum.List).</param>
        /// <param name="dataRef">Identifies the name of the attribute that contains the array of member activity objects. (default to &quot;data&quot;).</param>
        ...
        public LoyaltiesMemberActivityListResponseBody(ObjectEnum? varObject = ObjectEnum.List, string dataRef = @"data", List<MemberActivity> data = default(List<MemberActivity>), bool? hasMore = default(bool?), string moreStartingAfter = default(string))
        {
            this._Data = data;
            if (this.Data != null)
            {
