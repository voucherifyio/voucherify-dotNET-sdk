...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SimpleVoucherRedemption")]
    public partial class SimpleVoucherRedemption : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SimpleVoucherRedemption" /> class.
        /// </summary>
        ...
        public SimpleVoucherRedemption(int? quantity = default(int?), int? redeemedQuantity = default(int?), int? redeemedPoints = default(int?))
        {
