...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VoucherPublish")]
    public partial class VoucherPublish : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VoucherPublish" /> class.
        /// </summary>
        ...
        public VoucherPublish(string varObject = default(string), int? count = default(int?), string url = default(string))
        {
