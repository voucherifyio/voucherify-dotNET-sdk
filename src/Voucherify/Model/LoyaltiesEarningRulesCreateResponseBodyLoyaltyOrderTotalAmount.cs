...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderTotalAmount")]
    public partial class LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderTotalAmount : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderTotalAmount" /> class.
        /// </summary>
        ...
        public LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderTotalAmount(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string))
        {
            this._Every = every;
            if (this.Every != null)
            {
