...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderMetadata")]
    public partial class LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderMetadata : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderMetadata" /> class.
        /// </summary>
        ...
        public LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderMetadata(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string), string property = default(string))
        {
            this._Every = every;
            if (this.Every != null)
            {
