...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ClientRedemptionsRedeemRequestBody")]
    public partial class ClientRedemptionsRedeemRequestBody : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientRedemptionsRedeemRequestBody" /> class.
        /// </summary>
        ...
        public ClientRedemptionsRedeemRequestBody(ClientRedemptionsRedeemRequestBodyOptions options = default(ClientRedemptionsRedeemRequestBodyOptions), List<ClientRedemptionsRedeemRequestBodyRedeemablesItem> redeemables = default(List<ClientRedemptionsRedeemRequestBodyRedeemablesItem>), Order order = default(Order), Customer customer = default(Customer), Session session = default(Session), string trackingId = default(string), Object metadata = default(Object))
        {
        ...
        public ClientRedemptionsRedeemRequestBodyOptions Options
        {
            get{ return _Options;}
            set
            {
        ...
        private ClientRedemptionsRedeemRequestBodyOptions _Options;
        ...
        public List<ClientRedemptionsRedeemRequestBodyRedeemablesItem> Redeemables
        {
        ...
        private List<ClientRedemptionsRedeemRequestBodyRedeemablesItem> _Redeemables;
