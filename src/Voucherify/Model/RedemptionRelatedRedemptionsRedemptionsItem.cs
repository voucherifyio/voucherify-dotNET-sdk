...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RedemptionRelatedRedemptionsRedemptionsItem")]
    public partial class RedemptionRelatedRedemptionsRedemptionsItem : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RedemptionRelatedRedemptionsRedemptionsItem" /> class.
        /// </summary>
        ...
        public RedemptionRelatedRedemptionsRedemptionsItem(string id = default(string), DateTimeOffset date = default(DateTimeOffset))
        {
            this._Id = id;
            if (this.Id != null)
            {
