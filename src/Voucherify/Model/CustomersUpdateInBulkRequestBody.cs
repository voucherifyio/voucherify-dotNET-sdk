...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CustomersUpdateInBulkRequestBody")]
    public partial class CustomersUpdateInBulkRequestBody : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomersUpdateInBulkRequestBody" /> class.
        /// </summary>
        /// <param name="sourceId">Unique customer source ID..</param>
        ...
        public CustomersUpdateInBulkRequestBody(string sourceId = default(string), string name = default(string), string description = default(string), string email = default(string), string phone = default(string), DateTime? birthday = default(DateTime?), DateTime? birthdate = default(DateTime?), CustomersUpdateInBulkRequestBodyAddress address = default(CustomersUpdateInBulkRequestBodyAddress), Object metadata = default(Object))
        {
        ...
        /// </summary>
        /// <value>Unique customer source ID.</value>
        ...
        public CustomersUpdateInBulkRequestBodyAddress Address
        {
            get{ return _Address;}
            set
            {
        ...
        private CustomersUpdateInBulkRequestBodyAddress _Address;
