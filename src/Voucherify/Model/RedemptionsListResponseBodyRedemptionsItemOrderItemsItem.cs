...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RedemptionsListResponseBodyRedemptionsItemOrderItemsItem")]
    public partial class RedemptionsListResponseBodyRedemptionsItemOrderItemsItem : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RedemptionsListResponseBodyRedemptionsItemOrderItemsItem" /> class.
        /// </summary>
        ...
        public RedemptionsListResponseBodyRedemptionsItemOrderItemsItem(string id = default(string), string skuId = default(string), string productId = default(string), RelatedObjectEnum? relatedObject = default(RelatedObjectEnum?), string sourceId = default(string), int? quantity = default(int?), int? discountQuantity = default(int?), int? initialQuantity = default(int?), int? amount = default(int?), int? discountAmount = default(int?), int? appliedDiscountAmount = default(int?), int? appliedDiscountQuantity = default(int?), int? appliedQuantity = default(int?), int? appliedQuantityAmount = default(int?), int? initialAmount = default(int?), int? price = default(int?), int? subtotalAmount = default(int?), RedemptionsListResponseBodyRedemptionsItemOrderItemsItemProduct product = default(RedemptionsListResponseBodyRedemptionsItemOrderItemsItemProduct), RedemptionsListResponseBodyRedemptionsItemOrderItemsItemSku sku = default(RedemptionsListResponseBodyRedemptionsItemOrderItemsItemSku), ObjectEnum? varObject = ObjectEnum.OrderItem, Object metadata = default(Object), List<ApplicationDetailsItem> applicationDetails = default(List<ApplicationDetailsItem>))
        {
            this._Id = id;
            if (this.Id != null)
            {
        ...
        public RedemptionsListResponseBodyRedemptionsItemOrderItemsItemProduct Product
        {
            get{ return _Product;}
            set
            {
        ...
        private RedemptionsListResponseBodyRedemptionsItemOrderItemsItemProduct _Product;
        ...
        public RedemptionsListResponseBodyRedemptionsItemOrderItemsItemSku Sku
        {
            get{ return _Sku;}
            set
            {
        ...
        private RedemptionsListResponseBodyRedemptionsItemOrderItemsItemSku _Sku;
