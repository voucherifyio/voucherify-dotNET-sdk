...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsQuantity")]
    public partial class LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsQuantity : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsQuantity" /> class.
        /// </summary>
        ...
        public LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsQuantity(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string), ObjectEnum? varObject = default(ObjectEnum?), string id = default(string), List<LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsQuantityApplicableToItem> applicableTo = default(List<LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsQuantityApplicableToItem>))
        {
            this._Every = every;
            if (this.Every != null)
            {
        ...
        public List<LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsQuantityApplicableToItem> ApplicableTo
        {
        ...
        private List<LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsQuantityApplicableToItem> _ApplicableTo;
