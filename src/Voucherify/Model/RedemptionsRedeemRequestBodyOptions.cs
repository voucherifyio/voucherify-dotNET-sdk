...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RedemptionsRedeemRequestBodyOptions")]
    public partial class RedemptionsRedeemRequestBodyOptions : IValidatableObject
    {
        /// <summary>
        /// Defines Expand
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RedemptionsRedeemRequestBodyOptions" /> class.
        /// </summary>
        ...
        public RedemptionsRedeemRequestBodyOptions(List<ExpandEnum> expand = default(List<ExpandEnum>), string language = default(string))
        {
            this._Expand = expand;
            if (this.Expand != null)
            {
        ...
        public List<RedemptionsRedeemRequestBodyOptions.ExpandEnum> Expand
        {
            get{ return _Expand;}
            set
            {
        ...
        private List<RedemptionsRedeemRequestBodyOptions.ExpandEnum> _Expand;
