...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MemberActivityDataRedemptionRewardVoucherLoyaltyCard")]
    public partial class MemberActivityDataRedemptionRewardVoucherLoyaltyCard : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MemberActivityDataRedemptionRewardVoucherLoyaltyCard" /> class.
        /// </summary>
        ...
        /// <param name="nextExpirationDate">nextExpirationDate.</param>
        ...
        public MemberActivityDataRedemptionRewardVoucherLoyaltyCard(int? points = default(int?), int? balance = default(int?), string nextExpirationDate = default(string), int? nextExpirationPoints = default(int?), int? pendingPoints = default(int?), int? expiredPoints = default(int?), int? subtractedPoints = default(int?))
        {
            this._Points = points;
            if (this.Points != null)
            {
        ...
        /// <summary>
        /// Gets or Sets NextExpirationDate
        /// </summary>
        ...
        private string _NextExpirationDate;
