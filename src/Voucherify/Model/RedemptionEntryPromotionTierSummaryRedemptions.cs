...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RedemptionEntryPromotionTierSummaryRedemptions")]
    public partial class RedemptionEntryPromotionTierSummaryRedemptions : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RedemptionEntryPromotionTierSummaryRedemptions" /> class.
        /// </summary>
        /// <param name="totalRedeemed">Number of times the promotion tier was redeemed..</param>
        public RedemptionEntryPromotionTierSummaryRedemptions(int? totalRedeemed = default(int?))
        {
