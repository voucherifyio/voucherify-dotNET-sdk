...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VouchersUpdateResponseBodyLoyaltyCard")]
    public partial class VouchersUpdateResponseBodyLoyaltyCard : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VouchersUpdateResponseBodyLoyaltyCard" /> class.
        /// </summary>
        ...
        public VouchersUpdateResponseBodyLoyaltyCard(int? points = default(int?), int? balance = default(int?), DateTime? nextExpirationDate = default(DateTime?), int? nextExpirationPoints = default(int?), int? pendingPoints = default(int?), int? expiredPoints = default(int?), int? subtractedPoints = default(int?))
        {
            this._Points = points;
            if (this.Points != null)
            {
