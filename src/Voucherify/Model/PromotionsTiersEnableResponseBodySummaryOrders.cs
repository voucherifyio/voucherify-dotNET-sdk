...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PromotionsTiersEnableResponseBodySummaryOrders")]
    public partial class PromotionsTiersEnableResponseBodySummaryOrders : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PromotionsTiersEnableResponseBodySummaryOrders" /> class.
        /// </summary>
        ...
        public PromotionsTiersEnableResponseBodySummaryOrders(int? totalAmount = default(int?), int? totalDiscountAmount = default(int?))
        {
