...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CampaignsVouchersCreateResponseBodyPublish")]
    public partial class CampaignsVouchersCreateResponseBodyPublish : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignsVouchersCreateResponseBodyPublish" /> class.
        /// </summary>
        ...
        public CampaignsVouchersCreateResponseBodyPublish(string varObject = default(string), int? count = default(int?), string url = default(string))
        {
