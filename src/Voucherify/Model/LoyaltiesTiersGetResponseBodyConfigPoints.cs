...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesTiersGetResponseBodyConfigPoints")]
    public partial class LoyaltiesTiersGetResponseBodyConfigPoints : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesTiersGetResponseBodyConfigPoints" /> class.
        /// </summary>
        /// <param name="from">Bottom points threshold value..</param>
        /// <param name="to">Top points threshold value..</param>
        public LoyaltiesTiersGetResponseBodyConfigPoints(int? from = default(int?), int? to = default(int?))
        {
            this._From = from;
            if (this.From != null)
            {
