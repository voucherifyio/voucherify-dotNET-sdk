...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsSubtotalAmount")]
    public partial class LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsSubtotalAmount : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsSubtotalAmount" /> class.
        /// </summary>
        ...
        public LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsSubtotalAmount(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string), ObjectEnum? varObject = default(ObjectEnum?), string id = default(string), List<LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsSubtotalAmountApplicableToItem> applicableTo = default(List<LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsSubtotalAmountApplicableToItem>))
        {
            this._Every = every;
            if (this.Every != null)
            {
        ...
        public List<LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsSubtotalAmountApplicableToItem> ApplicableTo
        {
        ...
        private List<LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsSubtotalAmountApplicableToItem> _ApplicableTo;
