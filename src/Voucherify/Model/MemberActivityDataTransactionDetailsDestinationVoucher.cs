...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MemberActivityDataTransactionDetailsDestinationVoucher")]
    public partial class MemberActivityDataTransactionDetailsDestinationVoucher : IValidatableObject
    {
        /// <summary>
        /// Type of the voucher.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MemberActivityDataTransactionDetailsDestinationVoucher" /> class.
        /// </summary>
        ...
        public MemberActivityDataTransactionDetailsDestinationVoucher(string id = default(string), string code = default(string), MemberActivityDataTransactionDetailsDestinationVoucherGift gift = default(MemberActivityDataTransactionDetailsDestinationVoucherGift), Discount discount = default(Discount), MemberActivityDataTransactionDetailsDestinationVoucherLoyaltyCard loyaltyCard = default(MemberActivityDataTransactionDetailsDestinationVoucherLoyaltyCard), TypeEnum? type = default(TypeEnum?), string campaign = default(string), string campaignId = default(string), bool? isReferralCode = default(bool?), string holderId = default(string), string referrerId = default(string), string categoryId = default(string), List<Category> categories = default(List<Category>), bool? active = default(bool?), DateTimeOffset? createdAt = default(DateTimeOffset?), DateTimeOffset? updatedAt = default(DateTimeOffset?), MemberActivityDataTransactionDetailsDestinationVoucherRedemption redemption = default(MemberActivityDataTransactionDetailsDestinationVoucherRedemption), DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? expirationDate = default(DateTimeOffset?), Object metadata = default(Object), ObjectEnum? varObject = ObjectEnum.Voucher)
        {
            this._Id = id;
            if (this.Id != null)
            {
        ...
        public MemberActivityDataTransactionDetailsDestinationVoucherGift Gift
        {
            get{ return _Gift;}
            set
            {
        ...
        private MemberActivityDataTransactionDetailsDestinationVoucherGift _Gift;
        ...
        public MemberActivityDataTransactionDetailsDestinationVoucherLoyaltyCard LoyaltyCard
        {
        ...
        private MemberActivityDataTransactionDetailsDestinationVoucherLoyaltyCard _LoyaltyCard;
        ...
        */
        ...
        public MemberActivityDataTransactionDetailsDestinationVoucherRedemption Redemption
        {
        ...
        private MemberActivityDataTransactionDetailsDestinationVoucherRedemption _Redemption;
