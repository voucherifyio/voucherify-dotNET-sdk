...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesMembersPendingPointsListResponseBody")]
    public partial class LoyaltiesMembersPendingPointsListResponseBody : IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Identifies the name of the attribute that contains the array of pending point objects.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesMembersPendingPointsListResponseBody" /> class.
        /// </summary>
        ...
        public LoyaltiesMembersPendingPointsListResponseBody(ObjectEnum? varObject = default(ObjectEnum?), DataRefEnum? dataRef = default(DataRefEnum?), List<LoyaltyPendingPoints> data = default(List<LoyaltyPendingPoints>), bool? hasMore = default(bool?), string moreStartingAfter = default(string))
        {
        ...
        /// </summary>
        /// <value>A dictionary that contains an array of pending point entries. Each entry in the array is a separate pending point object.</value>
        [DataMember(Name = "data", EmitDefaultValue = true)]
        public List<LoyaltyPendingPoints> Data
        {
            get{ return _Data;}
            set
            {
        ...
        private List<LoyaltyPendingPoints> _Data;
        ...
        /// </summary>
        /// <value>Returns an ID that can be used to return another page of results. Use the pending point entry ID in the &#x60;starting_after_id&#x60; query parameter to display another page of the results starting after the entry with that ID.</value>
