...
namespace Voucherify.Model
{
    ...
    public partial class LoyaltiesMembersPendingPointsListResponseBody : IValidatableObject
    {
        ...
        public LoyaltiesMembersPendingPointsListResponseBody(ObjectEnum? varObject = ObjectEnum.List, DataRefEnum? dataRef = DataRefEnum.Data, List<LoyaltyPendingPoints> data = default(List<LoyaltyPendingPoints>), bool? hasMore = default(bool?), string moreStartingAfter = default(string))
        {
            this._Data = data;
            if (this.Data != null)
            {
