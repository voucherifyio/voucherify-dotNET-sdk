...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrdersUpdateRequestBody")]
    public partial class OrdersUpdateRequestBody : IValidatableObject
    {
        /// <summary>
        /// The order status.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OrdersUpdateRequestBody" /> class.
        /// </summary>
        /// <param name="sourceId">Unique source ID of an existing order that will be linked to the redemption of this request.  For validation and redemption, if &#x60;source_id&#x60; is used with an existing order, the original order data will be used, like &#x60;items&#x60;, &#x60;amount&#x60;, and so on, not the one sent in the new request..</param>
        ...
        public OrdersUpdateRequestBody(string sourceId = default(string), StatusEnum? status = default(StatusEnum?), int? amount = default(int?), int? initialAmount = default(int?), int? discountAmount = default(int?), List<OrderItem> items = default(List<OrderItem>), Object metadata = default(Object), DateTimeOffset? createdAt = default(DateTimeOffset?), string referrerId = default(string), Customer customer = default(Customer), Referrer referrer = default(Referrer))
        {
        ...
        /// </summary>
        /// <value>Unique source ID of an existing order that will be linked to the redemption of this request.  For validation and redemption, if &#x60;source_id&#x60; is used with an existing order, the original order data will be used, like &#x60;items&#x60;, &#x60;amount&#x60;, and so on, not the one sent in the new request.</value>
