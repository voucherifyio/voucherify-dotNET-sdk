...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CampaignsVouchersCreateCombinedResponseBodyGift")]
    public partial class CampaignsVouchersCreateCombinedResponseBodyGift : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignsVouchersCreateCombinedResponseBodyGift" /> class.
        /// </summary>
        ...
        public CampaignsVouchersCreateCombinedResponseBodyGift(int? amount = default(int?), int? subtractedAmount = default(int?), int? balance = default(int?), EffectEnum? effect = default(EffectEnum?))
        {
            this._Amount = amount;
            if (this.Amount != null)
            {
