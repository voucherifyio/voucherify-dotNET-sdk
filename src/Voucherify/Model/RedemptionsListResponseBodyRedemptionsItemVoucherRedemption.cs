...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RedemptionsListResponseBodyRedemptionsItemVoucherRedemption")]
    public partial class RedemptionsListResponseBodyRedemptionsItemVoucherRedemption : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RedemptionsListResponseBodyRedemptionsItemVoucherRedemption" /> class.
        /// </summary>
        ...
        public RedemptionsListResponseBodyRedemptionsItemVoucherRedemption(int? quantity = default(int?), int? redeemedQuantity = default(int?), int? redeemedPoints = default(int?), string varObject = default(string), string url = default(string))
        {
