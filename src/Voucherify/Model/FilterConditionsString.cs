...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FilterConditionsString")]
    public partial class FilterConditionsString : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FilterConditionsString" /> class.
        /// </summary>
        ...
        /// <param name="contains">Value includes the specified string..</param>
        /// <param name="notContain">Value does NOT include the specified string..</param>
        public FilterConditionsString(List<string> varIn = default(List<string>), List<string> notIn = default(List<string>), string varIs = default(string), string isNot = default(string), string hasValue = default(string), string isUnknown = default(string), string startsWith = default(string), string endsWith = default(string), string contains = default(string), string notContain = default(string))
        {
            this._In = varIn;
            if (this.In != null)
            {
        ...
        /// </summary>
        /// <value>Value includes the specified string.</value>
        ...
        /// </summary>
        /// <value>Value does NOT include the specified string.</value>
