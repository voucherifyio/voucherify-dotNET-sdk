...
namespace Voucherify.Model
{
    ...
    public partial class LoyaltyTiersExpirationAllExpirationDateRounding : IValidatableObject
    {
        ...
        /// <param name="unit">Defines the type of unit of time in which the rounding period is counted. (default to UnitEnum.MONTH).</param>
        ...
        public LoyaltyTiersExpirationAllExpirationDateRounding(TypeEnum? type = default(TypeEnum?), StrategyEnum? strategy = default(StrategyEnum?), UnitEnum? unit = UnitEnum.MONTH, int? value = default(int?))
        {
            this._Type = type;
            if (this.Type != null)
            {
