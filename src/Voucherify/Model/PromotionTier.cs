...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PromotionTier")]
    public partial class PromotionTier : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PromotionTier" /> class.
        /// </summary>
        ...
        public PromotionTier(string id = default(string), DateTimeOffset? createdAt = default(DateTimeOffset?), DateTimeOffset? updatedAt = default(DateTimeOffset?), string name = default(string), string banner = default(string), PromotionTierAction action = default(PromotionTierAction), Object metadata = default(Object), int? hierarchy = default(int?), string promotionId = default(string), PromotionTierCampaign campaign = default(PromotionTierCampaign), string campaignId = default(string), bool? active = default(bool?), DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? expirationDate = default(DateTimeOffset?), ValidityTimeframe validityTimeframe = default(ValidityTimeframe), List<ValidityDayOfWeekEnum> validityDayOfWeek = default(List<ValidityDayOfWeekEnum>), ValidityHours validityHours = default(ValidityHours), PromotionTierSummary summary = default(PromotionTierSummary), string varObject = default(string), ValidationRuleAssignmentsList validationRuleAssignments = default(ValidationRuleAssignmentsList), string categoryId = default(string), List<Category> categories = default(List<Category>))
        {
            this._Id = id;
            if (this.Id != null)
            {
        ...
        */
        ...
        public PromotionTierAction Action
        {
            get{ return _Action;}
            set
            {
        ...
        private PromotionTierAction _Action;
        ...
        public PromotionTierCampaign Campaign
        {
        ...
        private PromotionTierCampaign _Campaign;
        ...
        */
        ...
        public List<PromotionTier.ValidityDayOfWeekEnum> ValidityDayOfWeek
        {
        ...
        private List<PromotionTier.ValidityDayOfWeekEnum> _ValidityDayOfWeek;
        ...
        public PromotionTierSummary Summary
        {
            get{ return _Summary;}
            set
            {
        ...
        private PromotionTierSummary _Summary;
