...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManagementProjectsUpdateResponseBodyLimitsApiCallsItem")]
    public partial class ManagementProjectsUpdateResponseBodyLimitsApiCallsItem : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagementProjectsUpdateResponseBodyLimitsApiCallsItem" /> class.
        /// </summary>
        ...
        public ManagementProjectsUpdateResponseBodyLimitsApiCallsItem(int value = default(int), string duration = default(string))
        {
            this._Value = value;
            if (this.Value != null)
            {
