...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CustomerWithSummaryLoyaltyReferrals")]
    public partial class CustomerWithSummaryLoyaltyReferrals : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerWithSummaryLoyaltyReferrals" /> class.
        /// </summary>
        ...
        public CustomerWithSummaryLoyaltyReferrals(string id = default(string), string sourceId = default(string), CustomerSummary summary = default(CustomerSummary), CustomerLoyalty loyalty = default(CustomerLoyalty), CustomerReferrals referrals = default(CustomerReferrals), Object systemMetadata = default(Object), DateTimeOffset? createdAt = default(DateTimeOffset?), DateTimeOffset? updatedAt = default(DateTimeOffset?), CustomerWithSummaryLoyaltyReferralsAssets assets = default(CustomerWithSummaryLoyaltyReferralsAssets), ObjectEnum? varObject = ObjectEnum.Customer, string name = default(string), string description = default(string), string email = default(string), string phone = default(string), DateTime? birthday = default(DateTime?), DateTime? birthdate = default(DateTime?), CustomerWithSummaryLoyaltyReferralsAddress address = default(CustomerWithSummaryLoyaltyReferralsAddress), Object metadata = default(Object))
        {
            this._Id = id;
            if (this.Id != null)
            {
        ...
        */
        ...
        public CustomerWithSummaryLoyaltyReferralsAssets Assets
        {
            get{ return _Assets;}
            set
            {
        ...
        private CustomerWithSummaryLoyaltyReferralsAssets _Assets;
        ...
        public CustomerWithSummaryLoyaltyReferralsAddress Address
        {
            get{ return _Address;}
            set
            {
        ...
        private CustomerWithSummaryLoyaltyReferralsAddress _Address;
