...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PromotionsTiersCreateResponseBodySummaryOrders")]
    public partial class PromotionsTiersCreateResponseBodySummaryOrders : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PromotionsTiersCreateResponseBodySummaryOrders" /> class.
        /// </summary>
        ...
        public PromotionsTiersCreateResponseBodySummaryOrders(int? totalAmount = default(int?), int? totalDiscountAmount = default(int?))
        {
