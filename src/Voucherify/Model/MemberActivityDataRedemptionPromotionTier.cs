...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MemberActivityDataRedemptionPromotionTier")]
    public partial class MemberActivityDataRedemptionPromotionTier : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MemberActivityDataRedemptionPromotionTier" /> class.
        /// </summary>
        ...
        /// <param name="metadata">A set of custom key/value pairs that you can attach to a promotion tier. The metadata object stores all custom attributes assigned to the promotion tier. and The metadata object stores all custom attributes assigned to the promotion tier. A set of key/value pairs that you can attach to a promotion tier object. It can be useful for storing additional information about the promotion tier in a structured format..</param>
        ...
        public MemberActivityDataRedemptionPromotionTier(string id = default(string), string name = default(string), string banner = default(string), MemberActivityDataRedemptionPromotionTierCampaign campaign = default(MemberActivityDataRedemptionPromotionTierCampaign), Object metadata = default(Object), DateTimeOffset? createdAt = default(DateTimeOffset?), DateTimeOffset? updatedAt = default(DateTimeOffset?), MemberActivityDataRedemptionPromotionTierAction action = default(MemberActivityDataRedemptionPromotionTierAction), int? hierarchy = default(int?), string promotionId = default(string), string campaignId = default(string), bool? active = default(bool?), DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? expirationDate = default(DateTimeOffset?), ValidityTimeframe validityTimeframe = default(ValidityTimeframe), List<ValidityDayOfWeekEnum> validityDayOfWeek = default(List<ValidityDayOfWeekEnum>), ValidityHours validityHours = default(ValidityHours), MemberActivityDataRedemptionPromotionTierSummary summary = default(MemberActivityDataRedemptionPromotionTierSummary), string varObject = @"promotion_tier", ValidationRuleAssignmentsList validationRuleAssignments = default(ValidationRuleAssignmentsList), string categoryId = default(string), List<Category> categories = default(List<Category>))
        {
            this._Id = id;
            if (this.Id != null)
            {
        ...
        */
        ...
        public MemberActivityDataRedemptionPromotionTierCampaign Campaign
        {
        ...
        private MemberActivityDataRedemptionPromotionTierCampaign _Campaign;
        ...
        /// </summary>
        /// <value>A set of custom key/value pairs that you can attach to a promotion tier. The metadata object stores all custom attributes assigned to the promotion tier. and The metadata object stores all custom attributes assigned to the promotion tier. A set of key/value pairs that you can attach to a promotion tier object. It can be useful for storing additional information about the promotion tier in a structured format.</value>
        ...
        */
        ...
        public MemberActivityDataRedemptionPromotionTierAction Action
        {
            get{ return _Action;}
            set
            {
        ...
        private MemberActivityDataRedemptionPromotionTierAction _Action;
        ...
        */
        ...
        public List<MemberActivityDataRedemptionPromotionTier.ValidityDayOfWeekEnum> ValidityDayOfWeek
        {
        ...
        private List<MemberActivityDataRedemptionPromotionTier.ValidityDayOfWeekEnum> _ValidityDayOfWeek;
        ...
        public MemberActivityDataRedemptionPromotionTierSummary Summary
        {
            get{ return _Summary;}
            set
            {
        ...
        private MemberActivityDataRedemptionPromotionTierSummary _Summary;
