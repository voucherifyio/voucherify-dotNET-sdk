...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard")]
    public partial class LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard" /> class.
        /// </summary>
        ...
        public LoyaltiesMembersRedemptionRedeemResponseBodyVoucherLoyaltyCard(int? points = default(int?), int? balance = default(int?), DateTime? nextExpirationDate = default(DateTime?), int? nextExpirationPoints = default(int?), int? pendingPoints = default(int?), int? expiredPoints = default(int?), int? subtractedPoints = default(int?))
        {
            this._Points = points;
            if (this.Points != null)
            {
