...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltyCardTransactionDetailsEarningRuleSource")]
    public partial class LoyaltyCardTransactionDetailsEarningRuleSource : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltyCardTransactionDetailsEarningRuleSource" /> class.
        /// </summary>
        /// <param name="banner">Name of the earning rule. This is displayed as a header for the earning rule in the Dashboard..</param>
        public LoyaltyCardTransactionDetailsEarningRuleSource(string banner = default(string))
        {
            this._Banner = banner;
            if (this.Banner != null)
            {
