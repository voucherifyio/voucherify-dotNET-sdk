...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PromotionStackBaseTiers")]
    public partial class PromotionStackBaseTiers : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PromotionStackBaseTiers" /> class.
        /// </summary>
        /// <param name="ids">Contains the list of tiers in a pre-defined sequence..</param>
        /// <param name="hierarchyMode">hierarchyMode.</param>
        public PromotionStackBaseTiers(List<string> ids = default(List<string>), HierarchyModeEnum? hierarchyMode = default(HierarchyModeEnum?))
        {
            this._Ids = ids;
            if (this.Ids != null)
            {
