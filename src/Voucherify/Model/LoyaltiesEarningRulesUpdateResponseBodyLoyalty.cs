...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesUpdateResponseBodyLoyalty")]
    public partial class LoyaltiesEarningRulesUpdateResponseBodyLoyalty : IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesUpdateResponseBodyLoyalty" /> class.
        /// </summary>
        ...
        public LoyaltiesEarningRulesUpdateResponseBodyLoyalty(TypeEnum? type = default(TypeEnum?), int? points = default(int?), string pointsFormula = default(string), CalculationTypeEnum? calculationType = default(CalculationTypeEnum?), LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrder order = default(LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrder), LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItems orderItems = default(LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItems), LoyaltiesEarningRulesUpdateResponseBodyLoyaltyCustomer customer = default(LoyaltiesEarningRulesUpdateResponseBodyLoyaltyCustomer), LoyaltiesEarningRulesUpdateResponseBodyLoyaltyCustomEvent customEvent = default(LoyaltiesEarningRulesUpdateResponseBodyLoyaltyCustomEvent))
        {
            this._Type = type;
            if (this.Type != null)
            {
        ...
        public LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrder Order
        {
            get{ return _Order;}
            set
            {
        ...
        private LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrder _Order;
        ...
        public LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItems OrderItems
        {
        ...
        private LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItems _OrderItems;
        ...
        public LoyaltiesEarningRulesUpdateResponseBodyLoyaltyCustomer Customer
        {
        ...
        private LoyaltiesEarningRulesUpdateResponseBodyLoyaltyCustomer _Customer;
        ...
        public LoyaltiesEarningRulesUpdateResponseBodyLoyaltyCustomEvent CustomEvent
        {
        ...
        private LoyaltiesEarningRulesUpdateResponseBodyLoyaltyCustomEvent _CustomEvent;
