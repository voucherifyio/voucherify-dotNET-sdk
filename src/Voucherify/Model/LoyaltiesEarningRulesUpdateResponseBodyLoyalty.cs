...
namespace Voucherify.Model
{
    ...
    public partial class LoyaltiesEarningRulesUpdateResponseBodyLoyalty : IValidatableObject
    {
        ...
        public LoyaltiesEarningRulesUpdateResponseBodyLoyalty(TypeEnum? type = default(TypeEnum?), int? points = default(int?), CalculationTypeEnum? calculationType = default(CalculationTypeEnum?), LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrder order = default(LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrder), LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItems orderItems = default(LoyaltiesEarningRulesUpdateResponseBodyLoyaltyOrderItems), LoyaltiesEarningRulesUpdateResponseBodyLoyaltyCustomer customer = default(LoyaltiesEarningRulesUpdateResponseBodyLoyaltyCustomer), LoyaltiesEarningRulesUpdateResponseBodyLoyaltyCustomEvent customEvent = default(LoyaltiesEarningRulesUpdateResponseBodyLoyaltyCustomEvent))
        {
            this._Type = type;
            if (this.Type != null)
            {
