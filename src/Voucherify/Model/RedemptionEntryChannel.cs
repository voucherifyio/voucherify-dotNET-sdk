...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RedemptionEntryChannel")]
    public partial class RedemptionEntryChannel : IValidatableObject
    {
        /// <summary>
        /// Defines ChannelType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RedemptionEntryChannel" /> class.
        /// </summary>
        /// <param name="channelId">channelId.</param>
        /// <param name="channelType">channelType.</param>
        public RedemptionEntryChannel(string channelId = default(string), ChannelTypeEnum? channelType = default(ChannelTypeEnum?))
        {
