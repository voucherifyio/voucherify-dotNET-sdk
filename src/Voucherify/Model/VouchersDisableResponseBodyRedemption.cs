...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VouchersDisableResponseBodyRedemption")]
    public partial class VouchersDisableResponseBodyRedemption : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VouchersDisableResponseBodyRedemption" /> class.
        /// </summary>
        ...
        public VouchersDisableResponseBodyRedemption(int? quantity = default(int?), int? redeemedQuantity = default(int?), int? redeemedPoints = default(int?), string varObject = default(string), string url = default(string))
        {
