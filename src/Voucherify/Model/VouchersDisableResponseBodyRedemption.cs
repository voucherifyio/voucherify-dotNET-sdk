...
namespace Voucherify.Model
{
    ...
    public partial class VouchersDisableResponseBodyRedemption : IValidatableObject
    {
        ...
        public VouchersDisableResponseBodyRedemption(int? quantity = default(int?), int? redeemedQuantity = default(int?), int? redeemedPoints = default(int?), string varObject = @"list", string url = default(string))
        {
