...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RedemptionEntryRelatedRedemptions")]
    public partial class RedemptionEntryRelatedRedemptions : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RedemptionEntryRelatedRedemptions" /> class.
        /// </summary>
        /// <param name="rollbacks">rollbacks.</param>
        /// <param name="redemptions">redemptions.</param>
        public RedemptionEntryRelatedRedemptions(List<RedemptionEntryRelatedRedemptionsRollbacksItem> rollbacks = default(List<RedemptionEntryRelatedRedemptionsRollbacksItem>), List<RedemptionEntryRelatedRedemptionsRedemptionsItem> redemptions = default(List<RedemptionEntryRelatedRedemptionsRedemptionsItem>))
        {
        ...
        public List<RedemptionEntryRelatedRedemptionsRollbacksItem> Rollbacks
        {
        ...
        private List<RedemptionEntryRelatedRedemptionsRollbacksItem> _Rollbacks;
        ...
        public List<RedemptionEntryRelatedRedemptionsRedemptionsItem> Redemptions
        {
        ...
        private List<RedemptionEntryRelatedRedemptionsRedemptionsItem> _Redemptions;
