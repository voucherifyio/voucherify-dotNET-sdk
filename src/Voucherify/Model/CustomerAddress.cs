...
namespace Voucherify.Model
{
    ...
    public partial class CustomerAddress : IValidatableObject
    {
        ...
        public CustomerAddress(string city = default(string), string state = default(string), string line1 = default(string), string line2 = default(string), string country = default(string), string postalCode = default(string))
        {
            this._City = city;
            if (this.City != null)
            {
