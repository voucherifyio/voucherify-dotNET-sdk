...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RedemptionEntryRelatedRedemptionsRedemptionsItem")]
    public partial class RedemptionEntryRelatedRedemptionsRedemptionsItem : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RedemptionEntryRelatedRedemptionsRedemptionsItem" /> class.
        /// </summary>
        ...
        public RedemptionEntryRelatedRedemptionsRedemptionsItem(string id = default(string), DateTimeOffset date = default(DateTimeOffset))
        {
            this._Id = id;
            if (this.Id != null)
            {
