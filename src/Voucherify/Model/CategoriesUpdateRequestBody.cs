...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CategoriesUpdateRequestBody")]
    public partial class CategoriesUpdateRequestBody : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CategoriesUpdateRequestBody" /> class.
        /// </summary>
        ...
        public CategoriesUpdateRequestBody(string name = default(string), int? hierarchy = default(int?))
        {
            this._Name = name;
            if (this.Name != null)
            {
