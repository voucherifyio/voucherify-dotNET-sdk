...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EarningRuleLoyaltyOrderItemsSubtotalAmount")]
    public partial class EarningRuleLoyaltyOrderItemsSubtotalAmount : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EarningRuleLoyaltyOrderItemsSubtotalAmount" /> class.
        /// </summary>
        ...
        public EarningRuleLoyaltyOrderItemsSubtotalAmount(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string), ObjectEnum? varObject = default(ObjectEnum?), string id = default(string), List<EarningRuleLoyaltyOrderItemsSubtotalAmountApplicableToItem> applicableTo = default(List<EarningRuleLoyaltyOrderItemsSubtotalAmountApplicableToItem>))
        {
            this._Every = every;
            if (this.Every != null)
            {
        ...
        public List<EarningRuleLoyaltyOrderItemsSubtotalAmountApplicableToItem> ApplicableTo
        {
        ...
        private List<EarningRuleLoyaltyOrderItemsSubtotalAmountApplicableToItem> _ApplicableTo;
