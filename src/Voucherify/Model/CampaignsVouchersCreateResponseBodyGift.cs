...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CampaignsVouchersCreateResponseBodyGift")]
    public partial class CampaignsVouchersCreateResponseBodyGift : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignsVouchersCreateResponseBodyGift" /> class.
        /// </summary>
        ...
        public CampaignsVouchersCreateResponseBodyGift(int? amount = default(int?), int? subtractedAmount = default(int?), int? balance = default(int?), EffectEnum? effect = default(EffectEnum?))
        {
            this._Amount = amount;
            if (this.Amount != null)
            {
