...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CampaignsImportVoucherItemRedemption")]
    public partial class CampaignsImportVoucherItemRedemption : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignsImportVoucherItemRedemption" /> class.
        /// </summary>
        /// <param name="quantity">How many times a voucher can be redeemed. A &#x60;null&#x60; value means unlimited..</param>
        public CampaignsImportVoucherItemRedemption(int? quantity = default(int?))
        {
