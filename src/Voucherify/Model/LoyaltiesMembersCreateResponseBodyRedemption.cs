...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesMembersCreateResponseBodyRedemption")]
    public partial class LoyaltiesMembersCreateResponseBodyRedemption : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesMembersCreateResponseBodyRedemption" /> class.
        /// </summary>
        ...
        public LoyaltiesMembersCreateResponseBodyRedemption(int? quantity = default(int?), int? redeemedQuantity = default(int?), int? redeemedPoints = default(int?), string varObject = default(string), string url = default(string))
        {
