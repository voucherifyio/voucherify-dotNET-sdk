...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VoucherRedemption")]
    public partial class VoucherRedemption : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VoucherRedemption" /> class.
        /// </summary>
        ...
        public VoucherRedemption(int? quantity = default(int?), int? redeemedQuantity = default(int?), int? redeemedPoints = default(int?), string varObject = default(string), string url = default(string))
        {
