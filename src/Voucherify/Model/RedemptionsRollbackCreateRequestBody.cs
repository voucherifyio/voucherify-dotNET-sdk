...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RedemptionsRollbackCreateRequestBody")]
    public partial class RedemptionsRollbackCreateRequestBody : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RedemptionsRollbackCreateRequestBody" /> class.
        /// </summary>
        ...
        public RedemptionsRollbackCreateRequestBody(string reason = default(string), string trackingId = default(string), Customer customer = default(Customer), Order order = default(Order), Object metadata = default(Object))
        {
            this._Reason = reason;
            if (this.Reason != null)
            {
