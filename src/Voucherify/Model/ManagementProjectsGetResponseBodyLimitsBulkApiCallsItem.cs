...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManagementProjectsGetResponseBodyLimitsBulkApiCallsItem")]
    public partial class ManagementProjectsGetResponseBodyLimitsBulkApiCallsItem : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagementProjectsGetResponseBodyLimitsBulkApiCallsItem" /> class.
        /// </summary>
        ...
        public ManagementProjectsGetResponseBodyLimitsBulkApiCallsItem(int value = default(int), string duration = default(string))
        {
            this._Value = value;
            if (this.Value != null)
            {
