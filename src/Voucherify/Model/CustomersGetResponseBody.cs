...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CustomersGetResponseBody")]
    public partial class CustomersGetResponseBody : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomersGetResponseBody" /> class.
        /// </summary>
        ...
        public CustomersGetResponseBody(string id = default(string), string sourceId = default(string), CustomerSummary summary = default(CustomerSummary), CustomerLoyalty loyalty = default(CustomerLoyalty), CustomerReferrals referrals = default(CustomerReferrals), Object systemMetadata = default(Object), DateTimeOffset? createdAt = default(DateTimeOffset?), DateTimeOffset? updatedAt = default(DateTimeOffset?), CustomersGetResponseBodyAssets assets = default(CustomersGetResponseBodyAssets), ObjectEnum? varObject = ObjectEnum.Customer, string name = default(string), string description = default(string), string email = default(string), string phone = default(string), DateTime? birthday = default(DateTime?), DateTime? birthdate = default(DateTime?), CustomersGetResponseBodyAddress address = default(CustomersGetResponseBodyAddress), Object metadata = default(Object))
        {
            this._Id = id;
            if (this.Id != null)
            {
        ...
        */
        ...
        public CustomersGetResponseBodyAssets Assets
        {
            get{ return _Assets;}
            set
            {
        ...
        private CustomersGetResponseBodyAssets _Assets;
        ...
        public CustomersGetResponseBodyAddress Address
        {
            get{ return _Address;}
            set
            {
        ...
        private CustomersGetResponseBodyAddress _Address;
