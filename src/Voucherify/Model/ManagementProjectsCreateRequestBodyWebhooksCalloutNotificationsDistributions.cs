...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManagementProjectsCreateRequestBodyWebhooksCalloutNotificationsDistributions")]
    public partial class ManagementProjectsCreateRequestBodyWebhooksCalloutNotificationsDistributions : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagementProjectsCreateRequestBodyWebhooksCalloutNotificationsDistributions" /> class.
        /// </summary>
        ...
        public ManagementProjectsCreateRequestBodyWebhooksCalloutNotificationsDistributions(bool? email = default(bool?), bool? inApp = default(bool?), List<string> emails = default(List<string>))
        {
            this._Email = email;
            if (this.Email != null)
            {
