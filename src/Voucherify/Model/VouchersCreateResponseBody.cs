...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VouchersCreateResponseBody")]
    public partial class VouchersCreateResponseBody : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VouchersCreateResponseBody" /> class.
        /// </summary>
        ...
        public VouchersCreateResponseBody(string id = default(string), string code = default(string), string campaign = default(string), string campaignId = default(string), string category = default(string), string categoryId = default(string), TypeEnum? type = default(TypeEnum?), Discount discount = default(Discount), VouchersCreateResponseBodyGift gift = default(VouchersCreateResponseBodyGift), VouchersCreateResponseBodyLoyaltyCard loyaltyCard = default(VouchersCreateResponseBodyLoyaltyCard), DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? expirationDate = default(DateTimeOffset?), ValidityTimeframe validityTimeframe = default(ValidityTimeframe), List<ValidityDayOfWeekEnum> validityDayOfWeek = default(List<ValidityDayOfWeekEnum>), ValidityHours validityHours = default(ValidityHours), bool? active = default(bool?), string additionalInfo = default(string), Object metadata = default(Object), VoucherAssets assets = default(VoucherAssets), bool? isReferralCode = default(bool?), DateTimeOffset? createdAt = default(DateTimeOffset?), DateTimeOffset? updatedAt = default(DateTimeOffset?), string holderId = default(string), string referrerId = default(string), string varObject = default(string), VouchersCreateResponseBodyPublish publish = default(VouchersCreateResponseBodyPublish), VouchersCreateResponseBodyRedemption redemption = default(VouchersCreateResponseBodyRedemption), List<Category> categories = default(List<Category>), ValidationRulesAssignmentsList validationRulesAssignments = default(ValidationRulesAssignmentsList))
        {
            this._Id = id;
            if (this.Id != null)
            {
        ...
        */
        ...
        public VouchersCreateResponseBodyGift Gift
        {
            get{ return _Gift;}
            set
            {
        ...
        private VouchersCreateResponseBodyGift _Gift;
        ...
        public VouchersCreateResponseBodyLoyaltyCard LoyaltyCard
        {
        ...
        private VouchersCreateResponseBodyLoyaltyCard _LoyaltyCard;
        ...
        */
        ...
        public List<VouchersCreateResponseBody.ValidityDayOfWeekEnum> ValidityDayOfWeek
        {
        ...
        private List<VouchersCreateResponseBody.ValidityDayOfWeekEnum> _ValidityDayOfWeek;
        ...
        */
        ...
        public VouchersCreateResponseBodyPublish Publish
        {
            get{ return _Publish;}
            set
            {
        ...
        private VouchersCreateResponseBodyPublish _Publish;
        ...
        public VouchersCreateResponseBodyRedemption Redemption
        {
        ...
        private VouchersCreateResponseBodyRedemption _Redemption;
