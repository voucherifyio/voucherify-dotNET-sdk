...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RedemptionsGetResponseBodyVoucherPublish")]
    public partial class RedemptionsGetResponseBodyVoucherPublish : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RedemptionsGetResponseBodyVoucherPublish" /> class.
        /// </summary>
        ...
        public RedemptionsGetResponseBodyVoucherPublish(string varObject = default(string), int? count = default(int?), string url = default(string))
        {
