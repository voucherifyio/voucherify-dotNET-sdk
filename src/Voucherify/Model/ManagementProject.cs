...
namespace Voucherify.Model
{
    ...
    /// ManagementProject
    /// </summary>
    [DataContract(Name = "ManagementProject")]
    public partial class ManagementProject : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagementProject" /> class.
        /// </summary>
        ...
        public ManagementProject(string id = default(string), string name = default(string), string description = default(string), string timezone = default(string), string currency = default(string), string dialCode = default(string), WebhookVersionEnum? webhookVersion = WebhookVersionEnum.V20240101, List<string> clientTrustedDomains = default(List<string>), bool? clientRedeemEnabled = default(bool?), bool? clientPublishEnabled = default(bool?), bool? clientListVouchersEnabled = default(bool?), bool? clientCreateCustomerEnabled = default(bool?), bool? clientLoyaltyEventsEnabled = default(bool?), bool? clientSetVoucherExpirationDateEnabled = default(bool?), ManagementProjectWebhooksCalloutNotifications webhooksCalloutNotifications = default(ManagementProjectWebhooksCalloutNotifications), ManagementProjectApiUsageNotifications apiUsageNotifications = default(ManagementProjectApiUsageNotifications), string clusterId = default(string), bool? caseSensitiveCodes = default(bool?), ApiVersionEnum? apiVersion = ApiVersionEnum.V20180801, bool? isSandbox = default(bool?), string webhookToken = default(string), ManagementProjectDefaultCodeConfig defaultCodeConfig = default(ManagementProjectDefaultCodeConfig), ManagementProjectLimits limits = default(ManagementProjectLimits))
        {
            this._Id = id;
            if (this.Id != null)
            {
        ...
        public ManagementProjectWebhooksCalloutNotifications WebhooksCalloutNotifications
        {
        ...
        private ManagementProjectWebhooksCalloutNotifications _WebhooksCalloutNotifications;
        ...
        public ManagementProjectApiUsageNotifications ApiUsageNotifications
        {
        ...
        private ManagementProjectApiUsageNotifications _ApiUsageNotifications;
        ...
        public ManagementProjectDefaultCodeConfig DefaultCodeConfig
        {
        ...
        private ManagementProjectDefaultCodeConfig _DefaultCodeConfig;
        ...
        public ManagementProjectLimits Limits
        {
            get{ return _Limits;}
            set
            {
        ...
        private ManagementProjectLimits _Limits;
