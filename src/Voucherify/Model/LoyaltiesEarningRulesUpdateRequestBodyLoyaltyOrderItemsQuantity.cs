...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsQuantity")]
    public partial class LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsQuantity : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsQuantity" /> class.
        /// </summary>
        ...
        public LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsQuantity(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string), ObjectEnum? varObject = default(ObjectEnum?), string id = default(string), List<LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsQuantityApplicableToItem> applicableTo = default(List<LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsQuantityApplicableToItem>))
        {
            this._Every = every;
            if (this.Every != null)
            {
        ...
        public List<LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsQuantityApplicableToItem> ApplicableTo
        {
        ...
        private List<LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderItemsQuantityApplicableToItem> _ApplicableTo;
