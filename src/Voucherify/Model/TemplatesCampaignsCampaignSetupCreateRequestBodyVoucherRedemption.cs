...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TemplatesCampaignsCampaignSetupCreateRequestBodyVoucherRedemption")]
    public partial class TemplatesCampaignsCampaignSetupCreateRequestBodyVoucherRedemption : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplatesCampaignsCampaignSetupCreateRequestBodyVoucherRedemption" /> class.
        /// </summary>
        /// <param name="quantity">How many times a voucher can be redeemed. A &#x60;null&#x60; value means unlimited..</param>
        public TemplatesCampaignsCampaignSetupCreateRequestBodyVoucherRedemption(int? quantity = default(int?))
        {
