...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesRewardAssignmentsGetResponseBodyParametersLoyalty")]
    public partial class LoyaltiesRewardAssignmentsGetResponseBodyParametersLoyalty : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesRewardAssignmentsGetResponseBodyParametersLoyalty" /> class.
        /// </summary>
        ...
        public LoyaltiesRewardAssignmentsGetResponseBodyParametersLoyalty(int? points = default(int?), bool? autoRedeem = default(bool?))
        {
            this._Points = points;
            if (this.Points != null)
            {
