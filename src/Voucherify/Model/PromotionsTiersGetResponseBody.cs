...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PromotionsTiersGetResponseBody")]
    public partial class PromotionsTiersGetResponseBody : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PromotionsTiersGetResponseBody" /> class.
        /// </summary>
        ...
        public PromotionsTiersGetResponseBody(string id = default(string), DateTimeOffset? createdAt = default(DateTimeOffset?), DateTimeOffset? updatedAt = default(DateTimeOffset?), string name = default(string), string banner = default(string), PromotionsTiersGetResponseBodyAction action = default(PromotionsTiersGetResponseBodyAction), Object metadata = default(Object), int? hierarchy = default(int?), string promotionId = default(string), PromotionsTiersGetResponseBodyCampaign campaign = default(PromotionsTiersGetResponseBodyCampaign), string campaignId = default(string), bool? active = default(bool?), DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? expirationDate = default(DateTimeOffset?), ValidityTimeframe validityTimeframe = default(ValidityTimeframe), List<ValidityDayOfWeekEnum> validityDayOfWeek = default(List<ValidityDayOfWeekEnum>), ValidityHours validityHours = default(ValidityHours), PromotionsTiersGetResponseBodySummary summary = default(PromotionsTiersGetResponseBodySummary), string varObject = default(string), ValidationRuleAssignmentsList validationRuleAssignments = default(ValidationRuleAssignmentsList), string categoryId = default(string), List<Category> categories = default(List<Category>))
        {
            this._Id = id;
            if (this.Id != null)
            {
        ...
        */
        ...
        public PromotionsTiersGetResponseBodyAction Action
        {
            get{ return _Action;}
            set
            {
        ...
        private PromotionsTiersGetResponseBodyAction _Action;
        ...
        public PromotionsTiersGetResponseBodyCampaign Campaign
        {
        ...
        private PromotionsTiersGetResponseBodyCampaign _Campaign;
        ...
        */
        ...
        public List<PromotionsTiersGetResponseBody.ValidityDayOfWeekEnum> ValidityDayOfWeek
        {
        ...
        private List<PromotionsTiersGetResponseBody.ValidityDayOfWeekEnum> _ValidityDayOfWeek;
        ...
        public PromotionsTiersGetResponseBodySummary Summary
        {
            get{ return _Summary;}
            set
            {
        ...
        private PromotionsTiersGetResponseBodySummary _Summary;
