...
namespace Voucherify.Model
{
    ...
    public partial class CustomersListResponseBody : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="varObject">The type of the object represented by JSON. This object stores information about customers in a dictionary..</param>
        /// <param name="dataRef">Identifies the name of the attribute that contains the array of customer objects..</param>
        ...
        public CustomersListResponseBody(string varObject = default(string), string dataRef = default(string), List<CustomerWithSummaryLoyaltyReferrals> customers = default(List<CustomerWithSummaryLoyaltyReferrals>), int? total = default(int?), bool? hasMore = default(bool?))
        {
