...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PromotionsStacksCreateResponseBody")]
    public partial class PromotionsStacksCreateResponseBody : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PromotionsStacksCreateResponseBody" /> class.
        /// </summary>
        ...
        public PromotionsStacksCreateResponseBody(string name = default(string), PromotionsStacksCreateResponseBodyTiers tiers = default(PromotionsStacksCreateResponseBodyTiers), string id = default(string), DateTimeOffset? createdAt = default(DateTimeOffset?), string campaignId = default(string), ObjectEnum? varObject = ObjectEnum.PromotionStack, string categoryId = default(string), List<PromotionStackBase> categories = default(List<PromotionStackBase>))
        {
            this._Name = name;
            if (this.Name != null)
            {
        ...
        public PromotionsStacksCreateResponseBodyTiers Tiers
        {
            get{ return _Tiers;}
            set
            {
        ...
        private PromotionsStacksCreateResponseBodyTiers _Tiers;
