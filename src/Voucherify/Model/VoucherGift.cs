...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VoucherGift")]
    public partial class VoucherGift : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VoucherGift" /> class.
        /// </summary>
        ...
        public VoucherGift(int? amount = default(int?), int? subtractedAmount = default(int?), int? balance = default(int?), EffectEnum? effect = default(EffectEnum?))
        {
            this._Amount = amount;
            if (this.Amount != null)
            {
