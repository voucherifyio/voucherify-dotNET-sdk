...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManagementProjectsTemplatesCampaignsCopyCreateResponseBody")]
    public partial class ManagementProjectsTemplatesCampaignsCopyCreateResponseBody : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagementProjectsTemplatesCampaignsCopyCreateResponseBody" /> class.
        /// </summary>
        ...
        public ManagementProjectsTemplatesCampaignsCopyCreateResponseBody(string id = default(string), string name = default(string), string description = default(string), CampaignTypeEnum? campaignType = default(CampaignTypeEnum?), DateTimeOffset? createdAt = default(DateTimeOffset?), ObjectEnum? varObject = ObjectEnum.CampaignTemplate)
        {
            this._Id = id;
            if (this.Id != null)
            {
