...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RedemptionsListResponseBodyRedemptionsItemOrderItemsItemProduct")]
    public partial class RedemptionsListResponseBodyRedemptionsItemOrderItemsItemProduct : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RedemptionsListResponseBodyRedemptionsItemOrderItemsItemProduct" /> class.
        /// </summary>
        ...
        public RedemptionsListResponseBodyRedemptionsItemOrderItemsItemProduct(string id = default(string), string sourceId = default(string), bool? varOverride = default(bool?), string name = default(string), Object metadata = default(Object), decimal? price = default(decimal?))
        {
            this._Id = id;
            if (this.Id != null)
            {
