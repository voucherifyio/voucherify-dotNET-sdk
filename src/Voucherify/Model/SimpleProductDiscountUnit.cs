...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SimpleProductDiscountUnit")]
    public partial class SimpleProductDiscountUnit : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SimpleProductDiscountUnit" /> class.
        /// </summary>
        /// <param name="id">Unique product ID, assigned by Voucherify..</param>
        /// <param name="sourceId">Product&#39;s source ID..</param>
        /// <param name="name">Product name..</param>
        public SimpleProductDiscountUnit(string id = default(string), string sourceId = default(string), string name = default(string))
        {
            this._Id = id;
            if (this.Id != null)
            {
