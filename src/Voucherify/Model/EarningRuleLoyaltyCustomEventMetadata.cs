...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EarningRuleLoyaltyCustomEventMetadata")]
    public partial class EarningRuleLoyaltyCustomEventMetadata : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EarningRuleLoyaltyCustomEventMetadata" /> class.
        /// </summary>
        ...
        public EarningRuleLoyaltyCustomEventMetadata(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string), string property = default(string))
        {
            this._Every = every;
            if (this.Every != null)
            {
