...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PromotionsStacksCreateResponseBodyTiers")]
    public partial class PromotionsStacksCreateResponseBodyTiers : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PromotionsStacksCreateResponseBodyTiers" /> class.
        /// </summary>
        /// <param name="ids">Contains the list of tiers in a pre-defined sequence..</param>
        /// <param name="hierarchyMode">hierarchyMode.</param>
        public PromotionsStacksCreateResponseBodyTiers(List<string> ids = default(List<string>), HierarchyModeEnum? hierarchyMode = default(HierarchyModeEnum?))
        {
            this._Ids = ids;
            if (this.Ids != null)
            {
