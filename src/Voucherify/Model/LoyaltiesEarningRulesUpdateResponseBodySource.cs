...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesUpdateResponseBodySource")]
    public partial class LoyaltiesEarningRulesUpdateResponseBodySource : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesUpdateResponseBodySource" /> class.
        /// </summary>
        ...
        public LoyaltiesEarningRulesUpdateResponseBodySource(string banner = default(string), string objectId = default(string), ObjectTypeEnum? objectType = default(ObjectTypeEnum?))
        {
            this._Banner = banner;
            if (this.Banner != null)
            {
