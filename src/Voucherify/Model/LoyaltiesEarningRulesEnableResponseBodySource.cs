...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesEnableResponseBodySource")]
    public partial class LoyaltiesEarningRulesEnableResponseBodySource : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesEnableResponseBodySource" /> class.
        /// </summary>
        ...
        public LoyaltiesEarningRulesEnableResponseBodySource(string banner = default(string), string objectId = default(string), ObjectTypeEnum? objectType = default(ObjectTypeEnum?))
        {
            this._Banner = banner;
            if (this.Banner != null)
            {
