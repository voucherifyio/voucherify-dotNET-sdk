...
namespace Voucherify.Model
{
    ...
    public partial class LoyaltiesEarningRulesEnableResponseBodySource : IValidatableObject
    {
        ...
        public LoyaltiesEarningRulesEnableResponseBodySource(string banner = default(string), string objectId = default(string), ObjectTypeEnum? objectType = ObjectTypeEnum.Campaign)
        {
            this._Banner = banner;
            if (this.Banner != null)
            {
