...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LocationShapeDistance")]
    public partial class LocationShapeDistance : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LocationShapeDistance" /> class.
        /// </summary>
        ...
        public LocationShapeDistance(string center = default(string), string radius = default(string))
        {
            this._Center = center;
            if (this.Center != null)
            {
