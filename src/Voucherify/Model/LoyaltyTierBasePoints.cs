...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltyTierBasePoints")]
    public partial class LoyaltyTierBasePoints : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltyTierBasePoints" /> class.
        /// </summary>
        /// <param name="from">Bottom points threshold value..</param>
        /// <param name="to">Top points threshold value..</param>
        public LoyaltyTierBasePoints(int? from = default(int?), int? to = default(int?))
        {
            this._From = from;
            if (this.From != null)
            {
