...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TemplatesCampaignsGetResponseBody")]
    public partial class TemplatesCampaignsGetResponseBody : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplatesCampaignsGetResponseBody" /> class.
        /// </summary>
        ...
        public TemplatesCampaignsGetResponseBody(string id = default(string), string name = default(string), string description = default(string), CampaignTypeEnum? campaignType = default(CampaignTypeEnum?), DateTimeOffset? createdAt = default(DateTimeOffset?), ObjectEnum? varObject = default(ObjectEnum?), DateTimeOffset? updatedAt = default(DateTimeOffset?))
        {
            this._Id = id;
            if (this.Id != null)
            {
