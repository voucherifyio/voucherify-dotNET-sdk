...
namespace Voucherify.Model
{
    ...
    public partial class VouchersGetResponseBodyRedemption : IValidatableObject
    {
        ...
        public VouchersGetResponseBodyRedemption(int? quantity = default(int?), int? redeemedQuantity = default(int?), int? redeemedPoints = default(int?), string varObject = @"list", string url = default(string))
        {
