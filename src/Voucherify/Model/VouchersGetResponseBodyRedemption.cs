...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VouchersGetResponseBodyRedemption")]
    public partial class VouchersGetResponseBodyRedemption : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VouchersGetResponseBodyRedemption" /> class.
        /// </summary>
        ...
        public VouchersGetResponseBodyRedemption(int? quantity = default(int?), int? redeemedQuantity = default(int?), int? redeemedPoints = default(int?), string varObject = default(string), string url = default(string))
        {
