...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManagementProjectWebhooksCalloutNotificationsDistributions")]
    public partial class ManagementProjectWebhooksCalloutNotificationsDistributions : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagementProjectWebhooksCalloutNotificationsDistributions" /> class.
        /// </summary>
        ...
        public ManagementProjectWebhooksCalloutNotificationsDistributions(bool? email = default(bool?), bool? inApp = default(bool?), List<string> emails = default(List<string>))
        {
            this._Email = email;
            if (this.Email != null)
            {
