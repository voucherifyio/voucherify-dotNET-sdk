...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VouchersCreateResponseBodyRedemption")]
    public partial class VouchersCreateResponseBodyRedemption : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VouchersCreateResponseBodyRedemption" /> class.
        /// </summary>
        ...
        public VouchersCreateResponseBodyRedemption(int? quantity = default(int?), int? redeemedQuantity = default(int?), int? redeemedPoints = default(int?), string varObject = default(string), string url = default(string))
        {
