...
namespace Voucherify.Model
{
    ...
    public partial class LoyaltiesEarningRulesDisableResponseBodyLoyalty : IValidatableObject
    {
        ...
        public LoyaltiesEarningRulesDisableResponseBodyLoyalty(TypeEnum? type = default(TypeEnum?), int? points = default(int?), CalculationTypeEnum? calculationType = default(CalculationTypeEnum?), LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrder order = default(LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrder), LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItems orderItems = default(LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItems), LoyaltiesEarningRulesDisableResponseBodyLoyaltyCustomer customer = default(LoyaltiesEarningRulesDisableResponseBodyLoyaltyCustomer), LoyaltiesEarningRulesDisableResponseBodyLoyaltyCustomEvent customEvent = default(LoyaltiesEarningRulesDisableResponseBodyLoyaltyCustomEvent))
        {
            this._Type = type;
            if (this.Type != null)
            {
