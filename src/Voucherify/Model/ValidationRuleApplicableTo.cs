...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ValidationRuleApplicableTo")]
    public partial class ValidationRuleApplicableTo : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidationRuleApplicableTo" /> class.
        /// </summary>
        ...
        public ValidationRuleApplicableTo(List<ApplicableTo> excluded = default(List<ApplicableTo>), List<ApplicableTo> included = default(List<ApplicableTo>), bool? includedAll = default(bool?))
        {
