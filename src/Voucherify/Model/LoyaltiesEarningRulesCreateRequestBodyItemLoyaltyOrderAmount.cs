...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderAmount")]
    public partial class LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderAmount : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderAmount" /> class.
        /// </summary>
        ...
        public LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderAmount(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string))
        {
            this._Every = every;
            if (this.Every != null)
            {
