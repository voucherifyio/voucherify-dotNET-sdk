...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RedemptionOrderReferrer")]
    public partial class RedemptionOrderReferrer : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RedemptionOrderReferrer" /> class.
        /// </summary>
        ...
        public RedemptionOrderReferrer(string id = default(string), ObjectEnum? varObject = ObjectEnum.Customer)
        {
            this._Id = id;
            if (this.Id != null)
            {
