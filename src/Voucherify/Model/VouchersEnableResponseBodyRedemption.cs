...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VouchersEnableResponseBodyRedemption")]
    public partial class VouchersEnableResponseBodyRedemption : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VouchersEnableResponseBodyRedemption" /> class.
        /// </summary>
        ...
        public VouchersEnableResponseBodyRedemption(int? quantity = default(int?), int? redeemedQuantity = default(int?), int? redeemedPoints = default(int?), string varObject = default(string), string url = default(string))
        {
