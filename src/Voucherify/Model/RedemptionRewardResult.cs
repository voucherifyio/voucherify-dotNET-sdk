...
namespace Voucherify.Model
{
    ...
    public partial class RedemptionRewardResult : IValidatableObject
    {
        ...
        /// <param name="varObject">The type of the object represented by the JSON (default to ObjectEnum.Reward).</param>
