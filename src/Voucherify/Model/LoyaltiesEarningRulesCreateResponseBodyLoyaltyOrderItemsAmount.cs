...
namespace Voucherify.Model
{
    ...
    public partial class LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsAmount : IValidatableObject
    {
        ...
        public LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsAmount(int? every = default(int?), int? points = default(int?), ObjectEnum? varObject = default(ObjectEnum?), string id = default(string))
        {
            this._Every = every;
            if (this.Every != null)
            {
