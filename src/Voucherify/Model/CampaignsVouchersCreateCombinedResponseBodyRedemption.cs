...
namespace Voucherify.Model
{
    ...
    public partial class CampaignsVouchersCreateCombinedResponseBodyRedemption : IValidatableObject
    {
        ...
        public CampaignsVouchersCreateCombinedResponseBodyRedemption(int? quantity = default(int?), int? redeemedQuantity = default(int?), int? redeemedPoints = default(int?), string varObject = default(string), string url = default(string))
        {
