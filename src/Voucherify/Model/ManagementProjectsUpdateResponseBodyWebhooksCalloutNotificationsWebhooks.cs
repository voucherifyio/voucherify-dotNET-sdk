...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManagementProjectsUpdateResponseBodyWebhooksCalloutNotificationsWebhooks")]
    public partial class ManagementProjectsUpdateResponseBodyWebhooksCalloutNotificationsWebhooks : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagementProjectsUpdateResponseBodyWebhooksCalloutNotificationsWebhooks" /> class.
        /// </summary>
        ...
        public ManagementProjectsUpdateResponseBodyWebhooksCalloutNotificationsWebhooks(bool? email = default(bool?), bool? inApp = default(bool?), List<string> emails = default(List<string>))
        {
            this._Email = email;
            if (this.Email != null)
            {
