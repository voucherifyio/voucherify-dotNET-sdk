...
namespace Voucherify.Model
{
    ...
    public partial class TemplatesCampaignsListResponseBody : IValidatableObject
    {
        ...
        public TemplatesCampaignsListResponseBody(ObjectEnum? varObject = ObjectEnum.List, DataRefEnum? dataRef = DataRefEnum.Data, List<CampaignTemplate> data = default(List<CampaignTemplate>), int? total = default(int?), bool? hasMore = default(bool?), string moreStartingAfter = default(string))
        {
            this._Data = data;
            if (this.Data != null)
            {
