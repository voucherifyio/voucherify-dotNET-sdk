...
namespace Voucherify.Model
{
    ...
    public partial class Gift : IValidatableObject
    {
        /// <summary>
        ...
        public Gift(decimal? amount = default(decimal?), int? subtractedAmount = default(int?), decimal? balance = default(decimal?), EffectEnum? effect = default(EffectEnum?))
        {
            this._Amount = amount;
            if (this.Amount != null)
            {
