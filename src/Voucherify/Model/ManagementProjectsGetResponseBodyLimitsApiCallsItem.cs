...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManagementProjectsGetResponseBodyLimitsApiCallsItem")]
    public partial class ManagementProjectsGetResponseBodyLimitsApiCallsItem : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagementProjectsGetResponseBodyLimitsApiCallsItem" /> class.
        /// </summary>
        ...
        public ManagementProjectsGetResponseBodyLimitsApiCallsItem(int value = default(int), string duration = default(string))
        {
            this._Value = value;
            if (this.Value != null)
            {
