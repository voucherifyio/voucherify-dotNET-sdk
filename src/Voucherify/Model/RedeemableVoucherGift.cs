...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RedeemableVoucherGift")]
    public partial class RedeemableVoucherGift : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RedeemableVoucherGift" /> class.
        /// </summary>
        ...
        public RedeemableVoucherGift(int? amount = default(int?), int? subtractedAmount = default(int?), int? balance = default(int?), EffectEnum? effect = default(EffectEnum?))
        {
            this._Amount = amount;
            if (this.Amount != null)
            {
