...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProductsCreateRequestBody")]
    public partial class ProductsCreateRequestBody : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductsCreateRequestBody" /> class.
        /// </summary>
        ...
        public ProductsCreateRequestBody(string id = default(string), string sourceId = default(string), string name = default(string), int? price = default(int?), List<string> attributes = default(List<string>), Object metadata = default(Object), string imageUrl = default(string))
        {
            this._Id = id;
            if (this.Id != null)
            {
        ...
        /*
        <example>prod_5h0wc453_1</example>
        */
