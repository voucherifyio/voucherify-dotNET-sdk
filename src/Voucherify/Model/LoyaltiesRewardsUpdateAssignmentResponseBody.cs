...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesRewardsUpdateAssignmentResponseBody")]
    public partial class LoyaltiesRewardsUpdateAssignmentResponseBody : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesRewardsUpdateAssignmentResponseBody" /> class.
        /// </summary>
        ...
        public LoyaltiesRewardsUpdateAssignmentResponseBody(string id = default(string), string rewardId = default(string), DateTimeOffset? createdAt = default(DateTimeOffset?), DateTimeOffset? updatedAt = default(DateTimeOffset?), ObjectEnum? varObject = ObjectEnum.RewardAssignment, string relatedObjectId = default(string), RelatedObjectTypeEnum? relatedObjectType = RelatedObjectTypeEnum.Campaign, LoyaltiesRewardsUpdateAssignmentResponseBodyParameters parameters = default(LoyaltiesRewardsUpdateAssignmentResponseBodyParameters))
        {
            this._Id = id;
            if (this.Id != null)
            {
        ...
        */
        ...
        public LoyaltiesRewardsUpdateAssignmentResponseBodyParameters Parameters
        {
        ...
        private LoyaltiesRewardsUpdateAssignmentResponseBodyParameters _Parameters;
