...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PromotionsTiersCreateRequestBody")]
    public partial class PromotionsTiersCreateRequestBody : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PromotionsTiersCreateRequestBody" /> class.
        /// </summary>
        ...
        public PromotionsTiersCreateRequestBody(string name = default(string), string banner = default(string), Object metadata = default(Object), int? hierarchy = default(int?), bool? active = default(bool?), DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? expirationDate = default(DateTimeOffset?), ValidityTimeframe validityTimeframe = default(ValidityTimeframe), List<ValidityDayOfWeekEnum> validityDayOfWeek = default(List<ValidityDayOfWeekEnum>), ValidityHours validityHours = default(ValidityHours), string category = default(string), string categoryId = default(string), PromotionsTiersCreateRequestBodyAction action = default(PromotionsTiersCreateRequestBodyAction), ValidationRuleAssignmentsList validationRuleAssignments = default(ValidationRuleAssignmentsList))
        {
            this._Name = name;
            if (this.Name != null)
            {
        ...
        */
        ...
        public List<PromotionsTiersCreateRequestBody.ValidityDayOfWeekEnum> ValidityDayOfWeek
        {
        ...
        private List<PromotionsTiersCreateRequestBody.ValidityDayOfWeekEnum> _ValidityDayOfWeek;
        ...
        */
        ...
        public PromotionsTiersCreateRequestBodyAction Action
        {
            get{ return _Action;}
            set
            {
        ...
        private PromotionsTiersCreateRequestBodyAction _Action;
