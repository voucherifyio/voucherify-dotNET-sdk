...
namespace Voucherify.Model
{
    ...
    public partial class SimpleCustomer : IValidatableObject
    {
        ...
        public SimpleCustomer(string id = default(string), string name = default(string), string email = default(string), string sourceId = default(string), Object metadata = default(Object), ObjectEnum? varObject = ObjectEnum.Customer)
        {
            this._Id = id;
            if (this.Id != null)
            {
