...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManagementProjectsBrandingGetResponseBodyAddress")]
    public partial class ManagementProjectsBrandingGetResponseBodyAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagementProjectsBrandingGetResponseBodyAddress" /> class.
        /// </summary>
        ...
        public ManagementProjectsBrandingGetResponseBodyAddress(string street = default(string), string city = default(string), string postal = default(string), string state = default(string), string country = default(string))
        {
            this._Street = street;
            if (this.Street != null)
            {
