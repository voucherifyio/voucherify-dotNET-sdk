...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RedemptionEntryCustomer")]
    public partial class RedemptionEntryCustomer : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RedemptionEntryCustomer" /> class.
        /// </summary>
        ...
        public RedemptionEntryCustomer(string id = default(string), string name = default(string), string email = default(string), string sourceId = default(string), Object metadata = default(Object), ObjectEnum? varObject = ObjectEnum.Customer)
        {
            this._Id = id;
            if (this.Id != null)
            {
