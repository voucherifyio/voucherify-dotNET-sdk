...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManagementProjectsUsersAssignRequestBody")]
    public partial class ManagementProjectsUsersAssignRequestBody : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagementProjectsUsersAssignRequestBody" /> class.
        /// </summary>
        ...
        /// <param name="role">The role of the user to be added. It can be one of the following predefined roles: &#x60;ADMIN&#x60;, &#x60;USER&#x60;, &#x60;VIEWER&#x60;, &#x60;MERCHANT&#x60;, or an ID of a custom role..</param>
        public ManagementProjectsUsersAssignRequestBody(string id = default(string), string login = default(string), string role = default(string))
        {
            this._Id = id;
            if (this.Id != null)
            {
