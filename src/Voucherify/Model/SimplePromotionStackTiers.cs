...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SimplePromotionStackTiers")]
    public partial class SimplePromotionStackTiers : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SimplePromotionStackTiers" /> class.
        /// </summary>
        /// <param name="ids">Contains the list of tiers in a pre-defined sequence..</param>
        /// <param name="hierarchyMode">hierarchyMode.</param>
        public SimplePromotionStackTiers(List<string> ids = default(List<string>), HierarchyModeEnum? hierarchyMode = default(HierarchyModeEnum?))
        {
            this._Ids = ids;
            if (this.Ids != null)
            {
