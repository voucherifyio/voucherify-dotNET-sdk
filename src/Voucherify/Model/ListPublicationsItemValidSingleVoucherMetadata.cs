...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListPublicationsItemValidSingleVoucherMetadata")]
    public partial class ListPublicationsItemValidSingleVoucherMetadata : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListPublicationsItemValidSingleVoucherMetadata" /> class.
        /// </summary>
        ...
        public ListPublicationsItemValidSingleVoucherMetadata(string sourceType = default(string), string sourceId = default(string), string distributionId = default(string))
        {
