...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MemberActivityDataRedemptionRewardVoucherPublish")]
    public partial class MemberActivityDataRedemptionRewardVoucherPublish : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MemberActivityDataRedemptionRewardVoucherPublish" /> class.
        /// </summary>
        ...
        public MemberActivityDataRedemptionRewardVoucherPublish(string varObject = default(string), int? count = default(int?), string url = default(string))
        {
