...
namespace Voucherify.Model
{
    ...
    public partial class LoyaltiesEarningRulesGetResponseBodyLoyalty : IValidatableObject
    {
        ...
        public LoyaltiesEarningRulesGetResponseBodyLoyalty(TypeEnum? type = default(TypeEnum?), int? points = default(int?), string pointsFormula = default(string), CalculationTypeEnum? calculationType = default(CalculationTypeEnum?), LoyaltiesEarningRulesGetResponseBodyLoyaltyOrder order = default(LoyaltiesEarningRulesGetResponseBodyLoyaltyOrder), LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItems orderItems = default(LoyaltiesEarningRulesGetResponseBodyLoyaltyOrderItems), LoyaltiesEarningRulesGetResponseBodyLoyaltyCustomer customer = default(LoyaltiesEarningRulesGetResponseBodyLoyaltyCustomer), LoyaltiesEarningRulesGetResponseBodyLoyaltyCustomEvent customEvent = default(LoyaltiesEarningRulesGetResponseBodyLoyaltyCustomEvent))
        {
            this._Type = type;
            if (this.Type != null)
            {
