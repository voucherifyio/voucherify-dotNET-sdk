...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PromotionsStacksUpdateResponseBody")]
    public partial class PromotionsStacksUpdateResponseBody : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PromotionsStacksUpdateResponseBody" /> class.
        /// </summary>
        ...
        public PromotionsStacksUpdateResponseBody(string name = default(string), PromotionsStacksUpdateResponseBodyTiers tiers = default(PromotionsStacksUpdateResponseBodyTiers), string id = default(string), DateTimeOffset? createdAt = default(DateTimeOffset?), DateTimeOffset? updatedAt = default(DateTimeOffset?), string campaignId = default(string), ObjectEnum? varObject = ObjectEnum.PromotionStack, string categoryId = default(string), List<PromotionStackBase> categories = default(List<PromotionStackBase>))
        {
            this._Name = name;
            if (this.Name != null)
            {
        ...
        public PromotionsStacksUpdateResponseBodyTiers Tiers
        {
            get{ return _Tiers;}
            set
            {
        ...
        private PromotionsStacksUpdateResponseBodyTiers _Tiers;
        ...
        public List<PromotionStackBase> Categories
        {
        ...
        private List<PromotionStackBase> _Categories;
