...
namespace Voucherify.Model
{
    ...
    /// RewardAssignment
    /// </summary>
    [DataContract(Name = "RewardAssignment")]
    public partial class RewardAssignment : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RewardAssignment" /> class.
        /// </summary>
        ...
        public RewardAssignment(string id = default(string), string rewardId = default(string), DateTimeOffset? createdAt = default(DateTimeOffset?), DateTimeOffset? updatedAt = default(DateTimeOffset?), ObjectEnum? varObject = ObjectEnum.RewardAssignment, string relatedObjectId = default(string), RelatedObjectTypeEnum? relatedObjectType = RelatedObjectTypeEnum.Campaign, RewardAssignmentParameters parameters = default(RewardAssignmentParameters))
        {
            this._Id = id;
            if (this.Id != null)
            {
        ...
        */
        ...
        public RewardAssignmentParameters Parameters
        {
        ...
        private RewardAssignmentParameters _Parameters;
