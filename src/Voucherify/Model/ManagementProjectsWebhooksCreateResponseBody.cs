...
namespace Voucherify.Model
{
    ...
    public partial class ManagementProjectsWebhooksCreateResponseBody : IValidatableObject
    {
        ...
        public ManagementProjectsWebhooksCreateResponseBody(string id = default(string), ObjectEnum? varObject = ObjectEnum.Webhook, DateTimeOffset? createdAt = default(DateTimeOffset?), string targetUrl = default(string), List<EventsEnum> events = default(List<EventsEnum>), bool? active = true)
        {
            this._Id = id;
            if (this.Id != null)
            {
