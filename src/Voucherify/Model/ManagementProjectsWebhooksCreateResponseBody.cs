...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManagementProjectsWebhooksCreateResponseBody")]
    public partial class ManagementProjectsWebhooksCreateResponseBody : IValidatableObject
    {
        /// <summary>
        ...
        /// Defines Events
        /// </summary>
        [JsonConverter(typeof(SafeEnumConverter<EventsEnum>))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagementProjectsWebhooksCreateResponseBody" /> class.
        /// </summary>
        ...
        public ManagementProjectsWebhooksCreateResponseBody(string id = default(string), ObjectEnum? varObject = default(ObjectEnum?), DateTimeOffset? createdAt = default(DateTimeOffset?), string targetUrl = default(string), List<EventsEnum> events = default(List<EventsEnum>), bool? active = default(bool?))
        {
            this._Id = id;
            if (this.Id != null)
            {
        ...
        */
        ...
        public List<ManagementProjectsWebhooksCreateResponseBody.EventsEnum> Events
        {
            get{ return _Events;}
            set
            {
        ...
        private List<ManagementProjectsWebhooksCreateResponseBody.EventsEnum> _Events;
