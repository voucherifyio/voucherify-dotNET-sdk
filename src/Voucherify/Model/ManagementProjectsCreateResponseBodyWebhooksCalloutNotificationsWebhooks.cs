...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManagementProjectsCreateResponseBodyWebhooksCalloutNotificationsWebhooks")]
    public partial class ManagementProjectsCreateResponseBodyWebhooksCalloutNotificationsWebhooks : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagementProjectsCreateResponseBodyWebhooksCalloutNotificationsWebhooks" /> class.
        /// </summary>
        ...
        public ManagementProjectsCreateResponseBodyWebhooksCalloutNotificationsWebhooks(bool? email = default(bool?), bool? inApp = default(bool?), List<string> emails = default(List<string>))
        {
            this._Email = email;
            if (this.Email != null)
            {
