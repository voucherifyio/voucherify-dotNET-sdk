...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderAmount")]
    public partial class LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderAmount : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderAmount" /> class.
        /// </summary>
        ...
        public LoyaltiesEarningRulesUpdateRequestBodyLoyaltyOrderAmount(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string))
        {
            this._Every = every;
            if (this.Every != null)
            {
