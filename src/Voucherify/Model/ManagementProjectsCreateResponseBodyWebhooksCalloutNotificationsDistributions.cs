...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManagementProjectsCreateResponseBodyWebhooksCalloutNotificationsDistributions")]
    public partial class ManagementProjectsCreateResponseBodyWebhooksCalloutNotificationsDistributions : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagementProjectsCreateResponseBodyWebhooksCalloutNotificationsDistributions" /> class.
        /// </summary>
        ...
        public ManagementProjectsCreateResponseBodyWebhooksCalloutNotificationsDistributions(bool? email = default(bool?), bool? inApp = default(bool?), List<string> emails = default(List<string>))
        {
            this._Email = email;
            if (this.Email != null)
            {
