...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManagementProjectLimitsBulkApiCallsItem")]
    public partial class ManagementProjectLimitsBulkApiCallsItem : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagementProjectLimitsBulkApiCallsItem" /> class.
        /// </summary>
        ...
        public ManagementProjectLimitsBulkApiCallsItem(int value = default(int), string duration = default(string))
        {
            this._Value = value;
            if (this.Value != null)
            {
