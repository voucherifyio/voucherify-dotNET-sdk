...
namespace Voucherify.Model
{
    ...
    public partial class Customer : IValidatableObject
    {
        ...
        public Customer(string id = default(string), string sourceId = default(string), string name = default(string), string description = default(string), string email = default(string), string phone = default(string), DateTime? birthday = default(DateTime?), DateTime? birthdate = default(DateTime?), CustomerAddress address = default(CustomerAddress), Object metadata = default(Object))
        {
            this._Id = id;
            if (this.Id != null)
            {
