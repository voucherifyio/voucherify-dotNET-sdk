...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RedemptionEntryPromotionTierSummaryOrders")]
    public partial class RedemptionEntryPromotionTierSummaryOrders : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RedemptionEntryPromotionTierSummaryOrders" /> class.
        /// </summary>
        ...
        public RedemptionEntryPromotionTierSummaryOrders(int? totalAmount = default(int?), int? totalDiscountAmount = default(int?))
        {
