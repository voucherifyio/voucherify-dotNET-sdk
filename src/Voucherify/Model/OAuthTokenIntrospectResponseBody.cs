...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OAuthTokenIntrospectResponseBody")]
    public partial class OAuthTokenIntrospectResponseBody : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConverter(typeof(SafeEnumConverter<TokenTypeEnum>))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OAuthTokenIntrospectResponseBody" /> class.
        /// </summary>
        ...
        /// <param name="active">Determines if the token is active. Nonexistent tokens are also marked as inactive..</param>
        public OAuthTokenIntrospectResponseBody(string accessToken = default(string), string clientId = default(string), int? expiresAt = default(int?), int? expiresIn = default(int?), string scope = default(string), TokenTypeEnum? tokenType = default(TokenTypeEnum?), bool? active = default(bool?))
        {
        ...
        /// </summary>
        /// <value>Determines if the token is active. Nonexistent tokens are also marked as inactive.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OAuthTokenIntrospectResponseBody {\n");
