...
namespace Voucherify.Model
{
    ...
    public partial class OAuthTokenIntrospectResponseBody : IValidatableObject
    {
        ...
        public OAuthTokenIntrospectResponseBody(string accessToken = default(string), string clientId = default(string), int? expiresAt = default(int?), int? expiresIn = default(int?), TokenTypeEnum? tokenType = default(TokenTypeEnum?), string scope = default(string), bool? active = default(bool?))
        {
