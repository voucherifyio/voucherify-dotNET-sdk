...
namespace Voucherify.Model
{
    ...
    public partial class OAuthTokenIntrospectResponseBody : IValidatableObject
    {
        ...
        public OAuthTokenIntrospectResponseBody(string accessToken = default(string), string clientId = default(string), int? expiresAt = default(int?), int? expiresIn = default(int?), string scope = default(string), TokenTypeEnum? tokenType = TokenTypeEnum.Bearer, bool? active = default(bool?))
        {
