...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsQuantity")]
    public partial class LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsQuantity : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsQuantity" /> class.
        /// </summary>
        ...
        public LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsQuantity(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string), ObjectEnum? varObject = default(ObjectEnum?), string id = default(string), List<LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsQuantityApplicableToItem> applicableTo = default(List<LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsQuantityApplicableToItem>))
        {
            this._Every = every;
            if (this.Every != null)
            {
        ...
        public List<LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsQuantityApplicableToItem> ApplicableTo
        {
        ...
        private List<LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItemsQuantityApplicableToItem> _ApplicableTo;
