...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsAmount")]
    public partial class LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsAmount : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsAmount" /> class.
        /// </summary>
        ...
        public LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsAmount(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string), ObjectEnum? varObject = default(ObjectEnum?), string id = default(string), List<LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsAmountApplicableToItem> applicableTo = default(List<LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsAmountApplicableToItem>))
        {
            this._Every = every;
            if (this.Every != null)
            {
        ...
        public List<LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsAmountApplicableToItem> ApplicableTo
        {
        ...
        private List<LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsAmountApplicableToItem> _ApplicableTo;
