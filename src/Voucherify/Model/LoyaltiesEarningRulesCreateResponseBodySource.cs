...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesCreateResponseBodySource")]
    public partial class LoyaltiesEarningRulesCreateResponseBodySource : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesCreateResponseBodySource" /> class.
        /// </summary>
        ...
        public LoyaltiesEarningRulesCreateResponseBodySource(string banner = default(string), string objectId = default(string), ObjectTypeEnum? objectType = default(ObjectTypeEnum?))
        {
            this._Banner = banner;
            if (this.Banner != null)
            {
