...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MemberActivityDataTransactionDetailsEarningRuleSource")]
    public partial class MemberActivityDataTransactionDetailsEarningRuleSource : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MemberActivityDataTransactionDetailsEarningRuleSource" /> class.
        /// </summary>
        /// <param name="banner">Name of the earning rule. This is displayed as a header for the earning rule in the Dashboard..</param>
        public MemberActivityDataTransactionDetailsEarningRuleSource(string banner = default(string))
        {
            this._Banner = banner;
            if (this.Banner != null)
            {
