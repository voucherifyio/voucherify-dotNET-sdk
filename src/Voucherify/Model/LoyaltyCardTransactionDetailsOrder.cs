...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltyCardTransactionDetailsOrder")]
    public partial class LoyaltyCardTransactionDetailsOrder : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltyCardTransactionDetailsOrder" /> class.
        /// </summary>
        ...
        public LoyaltyCardTransactionDetailsOrder(string id = default(string), string sourceId = default(string))
        {
            this._Id = id;
            if (this.Id != null)
            {
