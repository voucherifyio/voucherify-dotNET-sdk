...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RedemptionsGetResponseBodyPromotionTierSummaryOrders")]
    public partial class RedemptionsGetResponseBodyPromotionTierSummaryOrders : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RedemptionsGetResponseBodyPromotionTierSummaryOrders" /> class.
        /// </summary>
        ...
        public RedemptionsGetResponseBodyPromotionTierSummaryOrders(int? totalAmount = default(int?), int? totalDiscountAmount = default(int?))
        {
