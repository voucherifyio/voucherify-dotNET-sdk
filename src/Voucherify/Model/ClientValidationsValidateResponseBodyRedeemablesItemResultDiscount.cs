...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ClientValidationsValidateResponseBodyRedeemablesItemResultDiscount")]
    public partial class ClientValidationsValidateResponseBodyRedeemablesItemResultDiscount : IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientValidationsValidateResponseBodyRedeemablesItemResultDiscount" /> class.
        /// </summary>
        ...
        public ClientValidationsValidateResponseBodyRedeemablesItemResultDiscount(TypeEnum? type = default(TypeEnum?), decimal? amountOff = default(decimal?), string amountOffFormula = default(string), int? aggregatedAmountLimit = default(int?), EffectEnum? effect = default(EffectEnum?), bool? isDynamic = default(bool?), int? unitOff = default(int?), string unitOffFormula = default(string), string unitType = default(string), ClientValidationsValidateResponseBodyRedeemablesItemResultDiscountProduct product = default(ClientValidationsValidateResponseBodyRedeemablesItemResultDiscountProduct), SimpleSkuDiscountUnit sku = default(SimpleSkuDiscountUnit), List<DiscountUnitMultipleOneUnit> units = default(List<DiscountUnitMultipleOneUnit>), decimal? percentOff = default(decimal?), string percentOffFormula = default(string), decimal? amountLimit = default(decimal?), decimal? fixedAmount = default(decimal?), string fixedAmountFormula = default(string))
        {
            this._Type = type;
            if (this.Type != null)
            {
        ...
        public ClientValidationsValidateResponseBodyRedeemablesItemResultDiscountProduct Product
        {
            get{ return _Product;}
            set
            {
        ...
        private ClientValidationsValidateResponseBodyRedeemablesItemResultDiscountProduct _Product;
