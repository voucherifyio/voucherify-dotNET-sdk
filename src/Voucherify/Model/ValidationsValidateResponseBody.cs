...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ValidationsValidateResponseBody")]
    public partial class ValidationsValidateResponseBody : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidationsValidateResponseBody" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ValidationsValidateResponseBody() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidationsValidateResponseBody" /> class.
        /// </summary>
        ...
        public ValidationsValidateResponseBody(string id = default(string), bool? valid = default(bool?), List<ValidationsValidateResponseBodyRedeemablesItem> redeemables = default(List<ValidationsValidateResponseBodyRedeemablesItem>), List<ValidationsRedeemableSkipped> skippedRedeemables = default(List<ValidationsRedeemableSkipped>), List<ValidationsRedeemableInapplicable> inapplicableRedeemables = default(List<ValidationsRedeemableInapplicable>), ValidationsValidateResponseBodyOrder order = default(ValidationsValidateResponseBodyOrder), string trackingId = default(string), Session session = default(Session), StackingRules stackingRules = default(StackingRules))
        {
            // to ensure "stackingRules" is required (not null)
            if (stackingRules == null)
            {
                throw new ArgumentNullException("stackingRules is a required property for ValidationsValidateResponseBody and cannot be null");
            }
        ...
        */
        ...
        public List<ValidationsValidateResponseBodyRedeemablesItem> Redeemables
        {
        ...
        private List<ValidationsValidateResponseBodyRedeemablesItem> _Redeemables;
        ...
        public ValidationsValidateResponseBodyOrder Order
        {
            get{ return _Order;}
            set
            {
        ...
        private ValidationsValidateResponseBodyOrder _Order;
