...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesMembersRedemptionRedeemResponseBodyVoucherRedemption")]
    public partial class LoyaltiesMembersRedemptionRedeemResponseBodyVoucherRedemption : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesMembersRedemptionRedeemResponseBodyVoucherRedemption" /> class.
        /// </summary>
        ...
        public LoyaltiesMembersRedemptionRedeemResponseBodyVoucherRedemption(int? quantity = default(int?), int? redeemedQuantity = default(int?), int? redeemedPoints = default(int?), string varObject = default(string), string url = default(string))
        {
