...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderMetadata")]
    public partial class LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderMetadata : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderMetadata" /> class.
        /// </summary>
        /// <param name="every">For how many increments of the order metadata property to grant points for..</param>
        ...
        /// <param name="property">Order metadata property..</param>
        public LoyaltiesEarningRulesCreateRequestBodyItemLoyaltyOrderMetadata(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string), string property = default(string))
        {
            this._Every = every;
            if (this.Every != null)
            {
        ...
        /// </summary>
        /// <value>For how many increments of the order metadata property to grant points for.</value>
        ...
        /// </summary>
        /// <value>Order metadata property.</value>
