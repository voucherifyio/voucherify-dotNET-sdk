...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesUpdateResponseBodyLoyaltyCustomEventMetadata")]
    public partial class LoyaltiesEarningRulesUpdateResponseBodyLoyaltyCustomEventMetadata : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesUpdateResponseBodyLoyaltyCustomEventMetadata" /> class.
        /// </summary>
        ...
        public LoyaltiesEarningRulesUpdateResponseBodyLoyaltyCustomEventMetadata(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string), string property = default(string))
        {
            this._Every = every;
            if (this.Every != null)
            {
