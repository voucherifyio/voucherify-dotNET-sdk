...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManagementProjectsBrandingAddress")]
    public partial class ManagementProjectsBrandingAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagementProjectsBrandingAddress" /> class.
        /// </summary>
        ...
        public ManagementProjectsBrandingAddress(string street = default(string), string city = default(string), string postal = default(string), string state = default(string), string country = default(string))
        {
            this._Street = street;
            if (this.Street != null)
            {
