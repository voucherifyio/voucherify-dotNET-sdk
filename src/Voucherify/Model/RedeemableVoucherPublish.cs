...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RedeemableVoucherPublish")]
    public partial class RedeemableVoucherPublish : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RedeemableVoucherPublish" /> class.
        /// </summary>
        ...
        public RedeemableVoucherPublish(string varObject = default(string), int? count = default(int?), string url = default(string))
        {
