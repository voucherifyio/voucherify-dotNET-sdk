...
namespace Voucherify.Model
{
    ...
    /// Customer&#39;s address.
    /// </summary>
    [DataContract(Name = "ReferrerAddress")]
    public partial class ReferrerAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReferrerAddress" /> class.
        /// </summary>
        ...
        public ReferrerAddress(string city = default(string), string state = default(string), string line1 = default(string), string line2 = default(string), string country = default(string), string postalCode = default(string))
        {
            this._City = city;
            if (this.City != null)
            {
