...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManagementProjectsWebhooksGetResponseBody")]
    public partial class ManagementProjectsWebhooksGetResponseBody : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagementProjectsWebhooksGetResponseBody" /> class.
        /// </summary>
        ...
        public ManagementProjectsWebhooksGetResponseBody(string id = default(string), ObjectEnum? varObject = default(ObjectEnum?), DateTimeOffset? createdAt = default(DateTimeOffset?), string targetUrl = default(string), List<EventsEnum> events = default(List<EventsEnum>), bool? active = default(bool?))
        {
            this._Id = id;
            if (this.Id != null)
            {
        ...
        */
        ...
        public List<ManagementProjectsWebhooksGetResponseBody.EventsEnum> Events
        {
            get{ return _Events;}
            set
            {
        ...
        private List<ManagementProjectsWebhooksGetResponseBody.EventsEnum> _Events;
