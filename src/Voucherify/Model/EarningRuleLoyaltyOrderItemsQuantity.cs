...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EarningRuleLoyaltyOrderItemsQuantity")]
    public partial class EarningRuleLoyaltyOrderItemsQuantity : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EarningRuleLoyaltyOrderItemsQuantity" /> class.
        /// </summary>
        ...
        public EarningRuleLoyaltyOrderItemsQuantity(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string), ObjectEnum? varObject = default(ObjectEnum?), string id = default(string), List<EarningRuleLoyaltyOrderItemsQuantityApplicableToItem> applicableTo = default(List<EarningRuleLoyaltyOrderItemsQuantityApplicableToItem>))
        {
            this._Every = every;
            if (this.Every != null)
            {
        ...
        public List<EarningRuleLoyaltyOrderItemsQuantityApplicableToItem> ApplicableTo
        {
        ...
        private List<EarningRuleLoyaltyOrderItemsQuantityApplicableToItem> _ApplicableTo;
