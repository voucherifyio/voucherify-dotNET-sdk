...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderMetadata")]
    public partial class LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderMetadata : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderMetadata" /> class.
        /// </summary>
        ...
        public LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderMetadata(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string), string property = default(string))
        {
            this._Every = every;
            if (this.Every != null)
            {
