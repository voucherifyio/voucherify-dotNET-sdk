...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RewardsAssignmentsCreateResponseBodyParametersLoyalty")]
    public partial class RewardsAssignmentsCreateResponseBodyParametersLoyalty : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RewardsAssignmentsCreateResponseBodyParametersLoyalty" /> class.
        /// </summary>
        ...
        public RewardsAssignmentsCreateResponseBodyParametersLoyalty(int? points = default(int?), bool? autoRedeem = default(bool?))
        {
            this._Points = points;
            if (this.Points != null)
            {
