...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesGetResponseBodyLoyaltyCustomEventMetadata")]
    public partial class LoyaltiesEarningRulesGetResponseBodyLoyaltyCustomEventMetadata : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesGetResponseBodyLoyaltyCustomEventMetadata" /> class.
        /// </summary>
        ...
        public LoyaltiesEarningRulesGetResponseBodyLoyaltyCustomEventMetadata(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string), string property = default(string))
        {
            this._Every = every;
            if (this.Every != null)
            {
