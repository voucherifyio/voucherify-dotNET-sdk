...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManagementProjectsUsersGetUserResponseBody")]
    public partial class ManagementProjectsUsersGetUserResponseBody : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagementProjectsUsersGetUserResponseBody" /> class.
        /// </summary>
        ...
        public ManagementProjectsUsersGetUserResponseBody(string id = default(string), string login = default(string), string email = default(string), string firstName = default(string), string lastName = default(string), Dictionary<string, string> projects = default(Dictionary<string, string>), bool? isOwner = default(bool?))
        {
            this._Id = id;
            if (this.Id != null)
            {
