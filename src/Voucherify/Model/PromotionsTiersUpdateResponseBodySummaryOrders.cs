...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PromotionsTiersUpdateResponseBodySummaryOrders")]
    public partial class PromotionsTiersUpdateResponseBodySummaryOrders : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PromotionsTiersUpdateResponseBodySummaryOrders" /> class.
        /// </summary>
        ...
        public PromotionsTiersUpdateResponseBodySummaryOrders(int? totalAmount = default(int?), int? totalDiscountAmount = default(int?))
        {
