...
namespace Voucherify.Model
{
    ...
    public partial class VouchersUpdateResponseBodyRedemption : IValidatableObject
    {
        ...
        public VouchersUpdateResponseBodyRedemption(int? quantity = default(int?), int? redeemedQuantity = default(int?), int? redeemedPoints = default(int?), string varObject = @"list", string url = default(string))
        {
