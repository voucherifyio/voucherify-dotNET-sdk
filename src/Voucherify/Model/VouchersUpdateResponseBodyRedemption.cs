...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VouchersUpdateResponseBodyRedemption")]
    public partial class VouchersUpdateResponseBodyRedemption : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VouchersUpdateResponseBodyRedemption" /> class.
        /// </summary>
        ...
        public VouchersUpdateResponseBodyRedemption(int? quantity = default(int?), int? redeemedQuantity = default(int?), int? redeemedPoints = default(int?), string varObject = default(string), string url = default(string))
        {
