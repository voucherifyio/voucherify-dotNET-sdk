...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesDisableResponseBodySource")]
    public partial class LoyaltiesEarningRulesDisableResponseBodySource : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConverter(typeof(SafeEnumConverter<ObjectTypeEnum>))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesDisableResponseBodySource" /> class.
        /// </summary>
        ...
        public LoyaltiesEarningRulesDisableResponseBodySource(string banner = default(string), string objectId = default(string), ObjectTypeEnum? objectType = default(ObjectTypeEnum?))
        {
            this._Banner = banner;
            if (this.Banner != null)
            {
