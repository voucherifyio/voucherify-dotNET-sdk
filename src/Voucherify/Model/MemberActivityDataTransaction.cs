...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MemberActivityDataTransaction")]
    public partial class MemberActivityDataTransaction : IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MemberActivityDataTransaction" /> class.
        /// </summary>
        ...
        public MemberActivityDataTransaction(string id = default(string), string sourceId = default(string), string voucherId = default(string), string campaignId = default(string), string source = default(string), string reason = default(string), string relatedTransactionId = default(string), DateTimeOffset? createdAt = default(DateTimeOffset?), MemberActivityDataTransactionDetails details = default(MemberActivityDataTransactionDetails), TypeEnum? type = default(TypeEnum?))
        {
            this._Id = id;
            if (this.Id != null)
            {
        ...
        public MemberActivityDataTransactionDetails Details
        {
            get{ return _Details;}
            set
            {
        ...
        private MemberActivityDataTransactionDetails _Details;
