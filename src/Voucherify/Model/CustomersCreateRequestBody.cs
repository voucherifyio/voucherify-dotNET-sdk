...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CustomersCreateRequestBody")]
    public partial class CustomersCreateRequestBody : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomersCreateRequestBody" /> class.
        /// </summary>
        ...
        public CustomersCreateRequestBody(string id = default(string), string sourceId = default(string), string name = default(string), string description = default(string), string email = default(string), string phone = default(string), DateTime? birthday = default(DateTime?), DateTime? birthdate = default(DateTime?), CustomersCreateRequestBodyAddress address = default(CustomersCreateRequestBodyAddress), Object metadata = default(Object))
        {
            this._Id = id;
            if (this.Id != null)
            {
        ...
        public CustomersCreateRequestBodyAddress Address
        {
            get{ return _Address;}
            set
            {
        ...
        private CustomersCreateRequestBodyAddress _Address;
