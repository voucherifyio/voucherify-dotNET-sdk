...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ValidationsValidateResponseBodyRedeemablesItemResultGift")]
    public partial class ValidationsValidateResponseBodyRedeemablesItemResultGift : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidationsValidateResponseBodyRedeemablesItemResultGift" /> class.
        /// </summary>
        ...
        public ValidationsValidateResponseBodyRedeemablesItemResultGift(int? balance = default(int?), int? credits = default(int?))
        {
