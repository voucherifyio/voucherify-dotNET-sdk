...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrderCalculatedItemProduct")]
    public partial class OrderCalculatedItemProduct : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderCalculatedItemProduct" /> class.
        /// </summary>
        ...
        public OrderCalculatedItemProduct(string id = default(string), string sourceId = default(string), bool? varOverride = default(bool?), string name = default(string), Object metadata = default(Object), decimal? price = default(decimal?))
        {
            this._Id = id;
            if (this.Id != null)
            {
