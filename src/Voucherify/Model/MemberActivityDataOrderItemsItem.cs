...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MemberActivityDataOrderItemsItem")]
    public partial class MemberActivityDataOrderItemsItem : IValidatableObject
    {
        /// <summary>
        /// Defines Object
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MemberActivityDataOrderItemsItem" /> class.
        /// </summary>
        ...
        public MemberActivityDataOrderItemsItem(string id = default(string), ObjectEnum? varObject = ObjectEnum.OrderItem, string sourceId = default(string), RelatedObjectEnum? relatedObject = default(RelatedObjectEnum?), string productId = default(string), string skuId = default(string), int quantity = default(int), int? appliedQuantity = default(int?), int? appliedQuantityAmount = default(int?), int discountQuantity = default(int), int? appliedDiscountQuantity = default(int?), int amount = default(int), int? discountAmount = default(int?), int appliedDiscountAmount = default(int), int? price = default(int?), int subtotalAmount = default(int), int? initialQuantity = default(int?), int? initialAmount = default(int?), MemberActivityDataOrderItemsItemProduct product = default(MemberActivityDataOrderItemsItemProduct), MemberActivityDataOrderItemsItemSku sku = default(MemberActivityDataOrderItemsItemSku), Object metadata = default(Object))
        {
            this._Id = id;
            if (this.Id != null)
            {
        ...
        public MemberActivityDataOrderItemsItemProduct Product
        {
            get{ return _Product;}
            set
            {
        ...
        private MemberActivityDataOrderItemsItemProduct _Product;
        ...
        public MemberActivityDataOrderItemsItemSku Sku
        {
            get{ return _Sku;}
            set
            {
        ...
        private MemberActivityDataOrderItemsItemSku _Sku;
