...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MemberActivityDataOrderCustomer")]
    public partial class MemberActivityDataOrderCustomer : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MemberActivityDataOrderCustomer" /> class.
        /// </summary>
        ...
        public MemberActivityDataOrderCustomer(string id = default(string), ObjectEnum? varObject = ObjectEnum.Customer)
        {
            this._Id = id;
            if (this.Id != null)
            {
