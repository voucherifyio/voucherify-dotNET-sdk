...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EarningRuleLoyaltyOrderTotalAmount")]
    public partial class EarningRuleLoyaltyOrderTotalAmount : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EarningRuleLoyaltyOrderTotalAmount" /> class.
        /// </summary>
        ...
        public EarningRuleLoyaltyOrderTotalAmount(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string))
        {
            this._Every = every;
            if (this.Every != null)
            {
