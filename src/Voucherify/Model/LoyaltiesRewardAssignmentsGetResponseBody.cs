...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesRewardAssignmentsGetResponseBody")]
    public partial class LoyaltiesRewardAssignmentsGetResponseBody : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesRewardAssignmentsGetResponseBody" /> class.
        /// </summary>
        ...
        public LoyaltiesRewardAssignmentsGetResponseBody(string id = default(string), string rewardId = default(string), DateTimeOffset? createdAt = default(DateTimeOffset?), DateTimeOffset? updatedAt = default(DateTimeOffset?), ObjectEnum? varObject = ObjectEnum.RewardAssignment, string relatedObjectId = default(string), RelatedObjectTypeEnum? relatedObjectType = RelatedObjectTypeEnum.Campaign, LoyaltiesRewardAssignmentsGetResponseBodyParameters parameters = default(LoyaltiesRewardAssignmentsGetResponseBodyParameters))
        {
            this._Id = id;
            if (this.Id != null)
            {
        ...
        */
        ...
        public LoyaltiesRewardAssignmentsGetResponseBodyParameters Parameters
        {
        ...
        private LoyaltiesRewardAssignmentsGetResponseBodyParameters _Parameters;
