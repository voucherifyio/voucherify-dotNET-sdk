...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManagementProjectsBrandingUpdateResponseBodyAddress")]
    public partial class ManagementProjectsBrandingUpdateResponseBodyAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagementProjectsBrandingUpdateResponseBodyAddress" /> class.
        /// </summary>
        ...
        public ManagementProjectsBrandingUpdateResponseBodyAddress(string street = default(string), string city = default(string), string postal = default(string), string state = default(string), string country = default(string))
        {
            this._Street = street;
            if (this.Street != null)
            {
