...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MemberActivityDataRedemptionRewardSku")]
    public partial class MemberActivityDataRedemptionRewardSku : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MemberActivityDataRedemptionRewardSku" /> class.
        /// </summary>
        ...
        public MemberActivityDataRedemptionRewardSku(string id = default(string), string sourceId = default(string), string sku = default(string), string productId = default(string), int? price = default(int?), string currency = default(string), Object attributes = default(Object), string imageUrl = default(string), Object metadata = default(Object), DateTimeOffset? createdAt = default(DateTimeOffset?), DateTimeOffset? updatedAt = default(DateTimeOffset?), ObjectEnum? varObject = ObjectEnum.Sku)
        {
            this._Id = id;
            if (this.Id != null)
            {
