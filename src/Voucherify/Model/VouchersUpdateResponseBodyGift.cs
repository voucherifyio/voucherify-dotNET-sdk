...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VouchersUpdateResponseBodyGift")]
    public partial class VouchersUpdateResponseBodyGift : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VouchersUpdateResponseBodyGift" /> class.
        /// </summary>
        ...
        public VouchersUpdateResponseBodyGift(int? amount = default(int?), int? subtractedAmount = default(int?), int? balance = default(int?), EffectEnum? effect = default(EffectEnum?))
        {
            this._Amount = amount;
            if (this.Amount != null)
            {
