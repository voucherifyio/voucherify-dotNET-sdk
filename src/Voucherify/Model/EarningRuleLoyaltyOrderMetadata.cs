...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EarningRuleLoyaltyOrderMetadata")]
    public partial class EarningRuleLoyaltyOrderMetadata : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EarningRuleLoyaltyOrderMetadata" /> class.
        /// </summary>
        ...
        public EarningRuleLoyaltyOrderMetadata(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string), string property = default(string))
        {
            this._Every = every;
            if (this.Every != null)
            {
