...
namespace Voucherify.Model
{
    ...
    /// Customer&#39;s address.
    /// </summary>
    [DataContract(Name = "CustomersUpdateResponseBodyAddress")]
    public partial class CustomersUpdateResponseBodyAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomersUpdateResponseBodyAddress" /> class.
        /// </summary>
        ...
        public CustomersUpdateResponseBodyAddress(string city = default(string), string state = default(string), string line1 = default(string), string line2 = default(string), string country = default(string), string postalCode = default(string))
        {
            this._City = city;
            if (this.City != null)
            {
