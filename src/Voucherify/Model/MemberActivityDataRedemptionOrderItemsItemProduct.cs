...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MemberActivityDataRedemptionOrderItemsItemProduct")]
    public partial class MemberActivityDataRedemptionOrderItemsItemProduct : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MemberActivityDataRedemptionOrderItemsItemProduct" /> class.
        /// </summary>
        ...
        public MemberActivityDataRedemptionOrderItemsItemProduct(string id = default(string), string sourceId = default(string), bool? varOverride = default(bool?), string name = default(string), Object metadata = default(Object), decimal? price = default(decimal?))
        {
            this._Id = id;
            if (this.Id != null)
            {
