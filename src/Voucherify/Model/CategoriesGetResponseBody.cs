...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CategoriesGetResponseBody")]
    public partial class CategoriesGetResponseBody : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CategoriesGetResponseBody" /> class.
        /// </summary>
        ...
        public CategoriesGetResponseBody(string id = default(string), string name = default(string), int? hierarchy = default(int?), ObjectEnum? varObject = ObjectEnum.Category, DateTimeOffset? createdAt = default(DateTimeOffset?), DateTimeOffset? updatedAt = default(DateTimeOffset?))
        {
            this._Id = id;
            if (this.Id != null)
            {
