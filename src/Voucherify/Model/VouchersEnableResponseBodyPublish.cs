...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VouchersEnableResponseBodyPublish")]
    public partial class VouchersEnableResponseBodyPublish : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VouchersEnableResponseBodyPublish" /> class.
        /// </summary>
        ...
        public VouchersEnableResponseBodyPublish(string varObject = default(string), int? count = default(int?), string url = default(string))
        {
