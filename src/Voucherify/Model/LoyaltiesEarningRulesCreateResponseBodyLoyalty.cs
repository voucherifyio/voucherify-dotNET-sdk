...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesCreateResponseBodyLoyalty")]
    public partial class LoyaltiesEarningRulesCreateResponseBodyLoyalty : IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesCreateResponseBodyLoyalty" /> class.
        /// </summary>
        ...
        public LoyaltiesEarningRulesCreateResponseBodyLoyalty(TypeEnum? type = default(TypeEnum?), int? points = default(int?), string pointsFormula = default(string), CalculationTypeEnum? calculationType = default(CalculationTypeEnum?), LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrder order = default(LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrder), LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItems orderItems = default(LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItems), LoyaltiesEarningRulesCreateResponseBodyLoyaltyCustomer customer = default(LoyaltiesEarningRulesCreateResponseBodyLoyaltyCustomer), LoyaltiesEarningRulesCreateResponseBodyLoyaltyCustomEvent customEvent = default(LoyaltiesEarningRulesCreateResponseBodyLoyaltyCustomEvent))
        {
            this._Type = type;
            if (this.Type != null)
            {
        ...
        public LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrder Order
        {
            get{ return _Order;}
            set
            {
        ...
        private LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrder _Order;
        ...
        public LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItems OrderItems
        {
        ...
        private LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItems _OrderItems;
        ...
        public LoyaltiesEarningRulesCreateResponseBodyLoyaltyCustomer Customer
        {
        ...
        private LoyaltiesEarningRulesCreateResponseBodyLoyaltyCustomer _Customer;
        ...
        public LoyaltiesEarningRulesCreateResponseBodyLoyaltyCustomEvent CustomEvent
        {
        ...
        private LoyaltiesEarningRulesCreateResponseBodyLoyaltyCustomEvent _CustomEvent;
