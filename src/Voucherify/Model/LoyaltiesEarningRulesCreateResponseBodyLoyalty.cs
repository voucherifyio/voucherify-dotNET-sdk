...
namespace Voucherify.Model
{
    ...
    public partial class LoyaltiesEarningRulesCreateResponseBodyLoyalty : IValidatableObject
    {
        ...
        public LoyaltiesEarningRulesCreateResponseBodyLoyalty(TypeEnum? type = default(TypeEnum?), int? points = default(int?), CalculationTypeEnum? calculationType = default(CalculationTypeEnum?), LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrder order = default(LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrder), LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItems orderItems = default(LoyaltiesEarningRulesCreateResponseBodyLoyaltyOrderItems), LoyaltiesEarningRulesCreateResponseBodyLoyaltyCustomer customer = default(LoyaltiesEarningRulesCreateResponseBodyLoyaltyCustomer), LoyaltiesEarningRulesCreateResponseBodyLoyaltyCustomEvent customEvent = default(LoyaltiesEarningRulesCreateResponseBodyLoyaltyCustomEvent))
        {
            this._Type = type;
            if (this.Type != null)
            {
