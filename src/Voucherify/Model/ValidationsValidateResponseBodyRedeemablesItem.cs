...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ValidationsValidateResponseBodyRedeemablesItem")]
    public partial class ValidationsValidateResponseBodyRedeemablesItem : IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidationsValidateResponseBodyRedeemablesItem" /> class.
        /// </summary>
        ...
        public ValidationsValidateResponseBodyRedeemablesItem(StatusEnum? status = default(StatusEnum?), string id = default(string), ObjectEnum? varObject = default(ObjectEnum?), ValidationsValidateResponseBodyRedeemablesItemOrder order = default(ValidationsValidateResponseBodyRedeemablesItemOrder), ApplicableToResultList applicableTo = default(ApplicableToResultList), InapplicableToResultList inapplicableTo = default(InapplicableToResultList), ValidationsValidateResponseBodyRedeemablesItemResult result = default(ValidationsValidateResponseBodyRedeemablesItemResult), Object metadata = default(Object), List<CategoryWithStackingRulesType> categories = default(List<CategoryWithStackingRulesType>), string campaignName = default(string), string campaignId = default(string), string name = default(string))
        {
            this._Status = status;
            if (this.Status != null)
            {
        ...
        public ValidationsValidateResponseBodyRedeemablesItemOrder Order
        {
            get{ return _Order;}
            set
            {
        ...
        private ValidationsValidateResponseBodyRedeemablesItemOrder _Order;
        ...
        public ValidationsValidateResponseBodyRedeemablesItemResult Result
        {
            get{ return _Result;}
            set
            {
        ...
        private ValidationsValidateResponseBodyRedeemablesItemResult _Result;
