...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrderCalculatedItemSku")]
    public partial class OrderCalculatedItemSku : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderCalculatedItemSku" /> class.
        /// </summary>
        ...
        public OrderCalculatedItemSku(string id = default(string), string sourceId = default(string), bool? varOverride = default(bool?), string sku = default(string), decimal? price = default(decimal?), Object metadata = default(Object))
        {
            this._Id = id;
            if (this.Id != null)
            {
