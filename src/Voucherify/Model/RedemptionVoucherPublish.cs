...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RedemptionVoucherPublish")]
    public partial class RedemptionVoucherPublish : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RedemptionVoucherPublish" /> class.
        /// </summary>
        ...
        public RedemptionVoucherPublish(string varObject = default(string), int? count = default(int?), string url = default(string))
        {
