...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesEnableResponseBodyLoyaltyCustomEventMetadata")]
    public partial class LoyaltiesEarningRulesEnableResponseBodyLoyaltyCustomEventMetadata : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesEnableResponseBodyLoyaltyCustomEventMetadata" /> class.
        /// </summary>
        ...
        public LoyaltiesEarningRulesEnableResponseBodyLoyaltyCustomEventMetadata(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string), string property = default(string))
        {
            this._Every = every;
            if (this.Every != null)
            {
