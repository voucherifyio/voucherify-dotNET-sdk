...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesEnableResponseBodyLoyalty")]
    public partial class LoyaltiesEarningRulesEnableResponseBodyLoyalty : IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesEnableResponseBodyLoyalty" /> class.
        /// </summary>
        ...
        public LoyaltiesEarningRulesEnableResponseBodyLoyalty(TypeEnum? type = default(TypeEnum?), int? points = default(int?), string pointsFormula = default(string), CalculationTypeEnum? calculationType = default(CalculationTypeEnum?), LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrder order = default(LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrder), LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItems orderItems = default(LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItems), LoyaltiesEarningRulesEnableResponseBodyLoyaltyCustomer customer = default(LoyaltiesEarningRulesEnableResponseBodyLoyaltyCustomer), LoyaltiesEarningRulesEnableResponseBodyLoyaltyCustomEvent customEvent = default(LoyaltiesEarningRulesEnableResponseBodyLoyaltyCustomEvent))
        {
            this._Type = type;
            if (this.Type != null)
            {
        ...
        public LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrder Order
        {
            get{ return _Order;}
            set
            {
        ...
        private LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrder _Order;
        ...
        public LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItems OrderItems
        {
        ...
        private LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItems _OrderItems;
        ...
        public LoyaltiesEarningRulesEnableResponseBodyLoyaltyCustomer Customer
        {
        ...
        private LoyaltiesEarningRulesEnableResponseBodyLoyaltyCustomer _Customer;
        ...
        public LoyaltiesEarningRulesEnableResponseBodyLoyaltyCustomEvent CustomEvent
        {
        ...
        private LoyaltiesEarningRulesEnableResponseBodyLoyaltyCustomEvent _CustomEvent;
