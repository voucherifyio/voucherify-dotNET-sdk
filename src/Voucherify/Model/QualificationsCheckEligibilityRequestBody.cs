...
namespace Voucherify.Model
{
    ...
    public partial class QualificationsCheckEligibilityRequestBody : IValidatableObject
    {
        ...
        public QualificationsCheckEligibilityRequestBody(Customer customer = default(Customer), Order order = default(Order), string trackingId = default(string), ScenarioEnum? scenario = default(ScenarioEnum?), QualificationsOption options = default(QualificationsOption), QualificationsCheckEligibilityRequestBodySession session = default(QualificationsCheckEligibilityRequestBodySession), Object metadata = default(Object))
        {
        ...
        public QualificationsCheckEligibilityRequestBodySession Session
        {
            get{ return _Session;}
            set
            {
        ...
        private QualificationsCheckEligibilityRequestBodySession _Session;
