...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RedemptionRelatedRedemptions")]
    public partial class RedemptionRelatedRedemptions : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RedemptionRelatedRedemptions" /> class.
        /// </summary>
        /// <param name="rollbacks">rollbacks.</param>
        /// <param name="redemptions">redemptions.</param>
        public RedemptionRelatedRedemptions(List<RedemptionRelatedRedemptionsRollbacksItem> rollbacks = default(List<RedemptionRelatedRedemptionsRollbacksItem>), List<RedemptionRelatedRedemptionsRedemptionsItem> redemptions = default(List<RedemptionRelatedRedemptionsRedemptionsItem>))
        {
        ...
        public List<RedemptionRelatedRedemptionsRollbacksItem> Rollbacks
        {
        ...
        private List<RedemptionRelatedRedemptionsRollbacksItem> _Rollbacks;
        ...
        public List<RedemptionRelatedRedemptionsRedemptionsItem> Redemptions
        {
        ...
        private List<RedemptionRelatedRedemptionsRedemptionsItem> _Redemptions;
