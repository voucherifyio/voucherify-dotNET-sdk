...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CampaignsVouchersCreateRequestBodyRedemption")]
    public partial class CampaignsVouchersCreateRequestBodyRedemption : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignsVouchersCreateRequestBodyRedemption" /> class.
        /// </summary>
        /// <param name="quantity">How many times a voucher can be redeemed. A &#x60;null&#x60; value means unlimited..</param>
        public CampaignsVouchersCreateRequestBodyRedemption(int? quantity = default(int?))
        {
