...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesMembersRedemptionRedeemResponseBodyVoucherGift")]
    public partial class LoyaltiesMembersRedemptionRedeemResponseBodyVoucherGift : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesMembersRedemptionRedeemResponseBodyVoucherGift" /> class.
        /// </summary>
        ...
        public LoyaltiesMembersRedemptionRedeemResponseBodyVoucherGift(int? amount = default(int?), int? subtractedAmount = default(int?), int? balance = default(int?), EffectEnum? effect = default(EffectEnum?))
        {
            this._Amount = amount;
            if (this.Amount != null)
            {
