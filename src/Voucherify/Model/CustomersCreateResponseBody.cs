...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CustomersCreateResponseBody")]
    public partial class CustomersCreateResponseBody : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomersCreateResponseBody" /> class.
        /// </summary>
        ...
        public CustomersCreateResponseBody(string id = default(string), string sourceId = default(string), CustomerSummary summary = default(CustomerSummary), CustomerLoyalty loyalty = default(CustomerLoyalty), CustomerReferrals referrals = default(CustomerReferrals), Object systemMetadata = default(Object), DateTimeOffset? createdAt = default(DateTimeOffset?), DateTimeOffset? updatedAt = default(DateTimeOffset?), CustomersCreateResponseBodyAssets assets = default(CustomersCreateResponseBodyAssets), ObjectEnum? varObject = ObjectEnum.Customer, string name = default(string), string description = default(string), string email = default(string), string phone = default(string), DateTime? birthday = default(DateTime?), DateTime? birthdate = default(DateTime?), CustomersCreateResponseBodyAddress address = default(CustomersCreateResponseBodyAddress), Object metadata = default(Object))
        {
            this._Id = id;
            if (this.Id != null)
            {
        ...
        */
        ...
        public CustomersCreateResponseBodyAssets Assets
        {
            get{ return _Assets;}
            set
            {
        ...
        private CustomersCreateResponseBodyAssets _Assets;
        ...
        public CustomersCreateResponseBodyAddress Address
        {
            get{ return _Address;}
            set
            {
        ...
        private CustomersCreateResponseBodyAddress _Address;
