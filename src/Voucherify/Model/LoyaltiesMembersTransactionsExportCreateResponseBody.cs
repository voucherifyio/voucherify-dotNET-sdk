...
namespace Voucherify.Model
{
    ...
    public partial class LoyaltiesMembersTransactionsExportCreateResponseBody : IValidatableObject
    {
        ...
        public LoyaltiesMembersTransactionsExportCreateResponseBody(string id = default(string), ObjectEnum? varObject = default(ObjectEnum?), DateTimeOffset? createdAt = default(DateTimeOffset?), StatusEnum? status = default(StatusEnum?), string channel = default(string), Object result = default(Object), string userId = default(string), ExportedObjectEnum? exportedObject = default(ExportedObjectEnum?), LoyaltiesMembersTransactionsExportCreateResponseBodyParameters parameters = default(LoyaltiesMembersTransactionsExportCreateResponseBodyParameters))
        {
            this._Id = id;
            if (this.Id != null)
            {
