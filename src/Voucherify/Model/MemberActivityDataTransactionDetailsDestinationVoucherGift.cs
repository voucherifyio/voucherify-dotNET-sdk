...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MemberActivityDataTransactionDetailsDestinationVoucherGift")]
    public partial class MemberActivityDataTransactionDetailsDestinationVoucherGift : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MemberActivityDataTransactionDetailsDestinationVoucherGift" /> class.
        /// </summary>
        ...
        /// <param name="subtractedAmount">Total amount of subtracted credits over the gift card lifetime..</param>
        ...
        public MemberActivityDataTransactionDetailsDestinationVoucherGift(decimal? amount = default(decimal?), int? subtractedAmount = default(int?), decimal? balance = default(decimal?), EffectEnum? effect = default(EffectEnum?))
        {
            this._Amount = amount;
            if (this.Amount != null)
            {
        ...
        /// </summary>
        /// <value>Total amount of subtracted credits over the gift card lifetime.</value>
