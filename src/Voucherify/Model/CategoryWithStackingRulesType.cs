...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CategoryWithStackingRulesType")]
    public partial class CategoryWithStackingRulesType : IValidatableObject
    {
        /// <summary>
        ...
        {
            get{ return _StackingRulesType;}
            set
            {
                _StackingRulesType = value;
                _flagStackingRulesType = true;
            }
        }
        private StackingRulesTypeEnum? _StackingRulesType;
        private bool _flagStackingRulesType;

        /// <summary>
        /// Returns false as StackingRulesType should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeStackingRulesType()
        {
            return _flagStackingRulesType;
        }
        /// <summary>
        /// Initializes a new instance of the <see cref="CategoryWithStackingRulesType" /> class.
        /// </summary>
        ...
        public CategoryWithStackingRulesType(string id = default(string), string name = default(string), int? hierarchy = default(int?), ObjectEnum? varObject = default(ObjectEnum?), DateTimeOffset? createdAt = default(DateTimeOffset?), DateTimeOffset? updatedAt = default(DateTimeOffset?), StackingRulesTypeEnum? stackingRulesType = default(StackingRulesTypeEnum?))
        {
            ...
            this._StackingRulesType = stackingRulesType;
            if (this.StackingRulesType != null)
            {
                this._flagStackingRulesType = true;
            }
        }
        ...
        */
        ...
        /// </summary>
        /// <value>Timestamp representing the date and time when the category was updated. The value is shown in the ISO 8601 format.</value>
        /*
        <example>2022-08-16T10:52:08.094Z</example>
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("  StackingRulesType: ").Append(StackingRulesType).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
