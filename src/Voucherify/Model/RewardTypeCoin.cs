...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RewardTypeCoin")]
    public partial class RewardTypeCoin : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RewardTypeCoin" /> class.
        /// </summary>
        ...
        public RewardTypeCoin(decimal? exchangeRatio = default(decimal?), int? pointsRatio = default(int?))
        {
