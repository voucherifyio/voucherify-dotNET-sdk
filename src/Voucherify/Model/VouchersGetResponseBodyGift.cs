...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VouchersGetResponseBodyGift")]
    public partial class VouchersGetResponseBodyGift : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VouchersGetResponseBodyGift" /> class.
        /// </summary>
        ...
        public VouchersGetResponseBodyGift(int? amount = default(int?), int? subtractedAmount = default(int?), int? balance = default(int?), EffectEnum? effect = default(EffectEnum?))
        {
            this._Amount = amount;
            if (this.Amount != null)
            {
