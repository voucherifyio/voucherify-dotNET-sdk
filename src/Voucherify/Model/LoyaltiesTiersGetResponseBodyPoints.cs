...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesTiersGetResponseBodyPoints")]
    public partial class LoyaltiesTiersGetResponseBodyPoints : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesTiersGetResponseBodyPoints" /> class.
        /// </summary>
        /// <param name="from">Bottom points threshold value..</param>
        /// <param name="to">Top points threshold value..</param>
        public LoyaltiesTiersGetResponseBodyPoints(int? from = default(int?), int? to = default(int?))
        {
            this._From = from;
            if (this.From != null)
            {
