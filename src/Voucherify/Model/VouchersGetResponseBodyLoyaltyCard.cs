...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VouchersGetResponseBodyLoyaltyCard")]
    public partial class VouchersGetResponseBodyLoyaltyCard : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VouchersGetResponseBodyLoyaltyCard" /> class.
        /// </summary>
        ...
        public VouchersGetResponseBodyLoyaltyCard(int? points = default(int?), int? balance = default(int?), DateTime? nextExpirationDate = default(DateTime?), int? nextExpirationPoints = default(int?), int? pendingPoints = default(int?), int? expiredPoints = default(int?), int? subtractedPoints = default(int?))
        {
            this._Points = points;
            if (this.Points != null)
            {
