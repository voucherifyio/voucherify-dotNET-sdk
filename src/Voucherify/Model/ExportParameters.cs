...
namespace Voucherify.Model
{
    ...
    /// ExportParameters
    /// </summary>
    [DataContract(Name = "ExportParameters")]
    public partial class ExportParameters : IValidatableObject
    {
        /// <summary>
        /// Defines Order
        /// </summary>
        ...
        public ExportParameters(OrderEnum? order = default(OrderEnum?), List<FieldsEnum> fields = default(List<FieldsEnum>), Object filters = default(Object), string campaignId = default(string))
        {
            this._Order = order;
            if (this.Order != null)
            {
        ...
        public List<ExportParameters.FieldsEnum> Fields
        {
            get{ return _Fields;}
            set
            {
        ...
        private List<ExportParameters.FieldsEnum> _Fields;
