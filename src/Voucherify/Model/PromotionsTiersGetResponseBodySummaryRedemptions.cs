...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PromotionsTiersGetResponseBodySummaryRedemptions")]
    public partial class PromotionsTiersGetResponseBodySummaryRedemptions : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PromotionsTiersGetResponseBodySummaryRedemptions" /> class.
        /// </summary>
        /// <param name="totalRedeemed">Number of times the promotion tier was redeemed..</param>
        public PromotionsTiersGetResponseBodySummaryRedemptions(int? totalRedeemed = default(int?))
        {
