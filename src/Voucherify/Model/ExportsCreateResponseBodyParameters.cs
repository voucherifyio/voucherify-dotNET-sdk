...
namespace Voucherify.Model
{
    ...
    public partial class ExportsCreateResponseBodyParameters : IValidatableObject
    {
        ...
        public ExportsCreateResponseBodyParameters(OrderEnum? order = default(OrderEnum?), List<FieldsEnum> fields = default(List<FieldsEnum>), Object filters = default(Object), string campaignId = default(string))
        {
            this._Order = order;
            if (this.Order != null)
            {
