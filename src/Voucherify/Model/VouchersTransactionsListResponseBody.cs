...
namespace Voucherify.Model
{
    ...
    public partial class VouchersTransactionsListResponseBody : IValidatableObject
    {
        ...
        public VouchersTransactionsListResponseBody(ObjectEnum? varObject = ObjectEnum.List, DataRefEnum? dataRef = DataRefEnum.Data, List<VoucherTransaction> data = default(List<VoucherTransaction>), bool? hasMore = default(bool?), string moreStartingAfter = default(string))
        {
            this._Data = data;
            if (this.Data != null)
            {
