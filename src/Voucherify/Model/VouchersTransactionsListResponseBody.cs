...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VouchersTransactionsListResponseBody")]
    public partial class VouchersTransactionsListResponseBody : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VouchersTransactionsListResponseBody" /> class.
        /// </summary>
        ...
        public VouchersTransactionsListResponseBody(ObjectEnum? varObject = default(ObjectEnum?), DataRefEnum? dataRef = default(DataRefEnum?), List<VoucherTransaction> data = default(List<VoucherTransaction>), bool? hasMore = default(bool?), string moreStartingAfter = default(string))
        {
