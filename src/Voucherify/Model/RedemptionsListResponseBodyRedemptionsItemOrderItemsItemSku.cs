...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RedemptionsListResponseBodyRedemptionsItemOrderItemsItemSku")]
    public partial class RedemptionsListResponseBodyRedemptionsItemOrderItemsItemSku : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RedemptionsListResponseBodyRedemptionsItemOrderItemsItemSku" /> class.
        /// </summary>
        ...
        public RedemptionsListResponseBodyRedemptionsItemOrderItemsItemSku(string id = default(string), string sourceId = default(string), bool? varOverride = default(bool?), string sku = default(string), decimal? price = default(decimal?), Object metadata = default(Object))
        {
            this._Id = id;
            if (this.Id != null)
            {
