...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesRewardsCreateAssignmentResponseBodyParametersLoyalty")]
    public partial class LoyaltiesRewardsCreateAssignmentResponseBodyParametersLoyalty : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesRewardsCreateAssignmentResponseBodyParametersLoyalty" /> class.
        /// </summary>
        ...
        public LoyaltiesRewardsCreateAssignmentResponseBodyParametersLoyalty(int? points = default(int?), bool? autoRedeem = default(bool?))
        {
            this._Points = points;
            if (this.Points != null)
            {
