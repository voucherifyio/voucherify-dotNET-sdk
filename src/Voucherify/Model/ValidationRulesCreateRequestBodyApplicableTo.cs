...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ValidationRulesCreateRequestBodyApplicableTo")]
    public partial class ValidationRulesCreateRequestBodyApplicableTo : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidationRulesCreateRequestBodyApplicableTo" /> class.
        /// </summary>
        ...
        public ValidationRulesCreateRequestBodyApplicableTo(List<ApplicableTo> excluded = default(List<ApplicableTo>), List<ApplicableTo> included = default(List<ApplicableTo>), bool? includedAll = default(bool?))
        {
