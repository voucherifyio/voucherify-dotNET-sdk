...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesRewardsUpdateAssignmentResponseBodyParametersLoyalty")]
    public partial class LoyaltiesRewardsUpdateAssignmentResponseBodyParametersLoyalty : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesRewardsUpdateAssignmentResponseBodyParametersLoyalty" /> class.
        /// </summary>
        ...
        public LoyaltiesRewardsUpdateAssignmentResponseBodyParametersLoyalty(int? points = default(int?), bool? autoRedeem = default(bool?))
        {
            this._Points = points;
            if (this.Points != null)
            {
