...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PromotionsTiersCreateResponseBodySummaryRedemptions")]
    public partial class PromotionsTiersCreateResponseBodySummaryRedemptions : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PromotionsTiersCreateResponseBodySummaryRedemptions" /> class.
        /// </summary>
        /// <param name="totalRedeemed">Number of times the promotion tier was redeemed..</param>
        public PromotionsTiersCreateResponseBodySummaryRedemptions(int? totalRedeemed = default(int?))
        {
