...
namespace Voucherify.Model
{
    ...
    public partial class LoyaltyTier : IValidatableObject
    {
        ...
        public LoyaltyTier(string name = default(string), Dictionary<string, MappingPoints> earningRules = default(Dictionary<string, MappingPoints>), Dictionary<string, MappingPoints> rewards = default(Dictionary<string, MappingPoints>), LoyaltyTierPoints points = default(LoyaltyTierPoints), string id = default(string), string campaignId = default(string), Object metadata = default(Object), DateTimeOffset? createdAt = default(DateTimeOffset?), DateTimeOffset? updatedAt = default(DateTimeOffset?), LoyaltyTierConfig config = default(LoyaltyTierConfig), LoyaltyTierExpiration expiration = default(LoyaltyTierExpiration), ObjectEnum? varObject = ObjectEnum.LoyaltyTier)
        {
            this._Name = name;
            if (this.Name != null)
            {
        ...
        public LoyaltyTierPoints Points
        {
            get{ return _Points;}
            set
            {
        ...
        private LoyaltyTierPoints _Points;
        ...
        public LoyaltyTierConfig Config
        {
            get{ return _Config;}
            set
            {
        ...
        private LoyaltyTierConfig _Config;
