...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManagementProjectsUpdateResponseBodyWebhooksCalloutNotificationsDistributions")]
    public partial class ManagementProjectsUpdateResponseBodyWebhooksCalloutNotificationsDistributions : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagementProjectsUpdateResponseBodyWebhooksCalloutNotificationsDistributions" /> class.
        /// </summary>
        ...
        public ManagementProjectsUpdateResponseBodyWebhooksCalloutNotificationsDistributions(bool? email = default(bool?), bool? inApp = default(bool?), List<string> emails = default(List<string>))
        {
            this._Email = email;
            if (this.Email != null)
            {
