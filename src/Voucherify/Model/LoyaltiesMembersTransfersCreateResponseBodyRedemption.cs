...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesMembersTransfersCreateResponseBodyRedemption")]
    public partial class LoyaltiesMembersTransfersCreateResponseBodyRedemption : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesMembersTransfersCreateResponseBodyRedemption" /> class.
        /// </summary>
        ...
        public LoyaltiesMembersTransfersCreateResponseBodyRedemption(int? quantity = default(int?), int? redeemedPoints = default(int?), int? redeemedQuantity = default(int?), ObjectEnum? varObject = default(ObjectEnum?), string url = default(string))
        {
