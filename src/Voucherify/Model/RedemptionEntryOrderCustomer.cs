...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RedemptionEntryOrderCustomer")]
    public partial class RedemptionEntryOrderCustomer : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RedemptionEntryOrderCustomer" /> class.
        /// </summary>
        ...
        public RedemptionEntryOrderCustomer(string id = default(string), ObjectEnum? varObject = ObjectEnum.Customer)
        {
            this._Id = id;
            if (this.Id != null)
            {
