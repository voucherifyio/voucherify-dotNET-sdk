...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CategoriesUpdateResponseBody")]
    public partial class CategoriesUpdateResponseBody : IValidatableObject
    {
        /// <summary>
        /// Defines Object
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CategoriesUpdateResponseBody" /> class.
        /// </summary>
        ...
        public CategoriesUpdateResponseBody(string id = default(string), string name = default(string), int? hierarchy = default(int?), ObjectEnum? varObject = ObjectEnum.Category, DateTimeOffset? createdAt = default(DateTimeOffset?), DateTimeOffset? updatedAt = default(DateTimeOffset?))
        {
            this._Id = id;
            if (this.Id != null)
            {
