...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RedemptionEntryOrderItemsItemSku")]
    public partial class RedemptionEntryOrderItemsItemSku : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RedemptionEntryOrderItemsItemSku" /> class.
        /// </summary>
        ...
        public RedemptionEntryOrderItemsItemSku(string id = default(string), string sourceId = default(string), bool? varOverride = default(bool?), string sku = default(string), decimal? price = default(decimal?), Object metadata = default(Object))
        {
            this._Id = id;
            if (this.Id != null)
            {
