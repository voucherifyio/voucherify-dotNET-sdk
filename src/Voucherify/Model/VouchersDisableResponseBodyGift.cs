...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VouchersDisableResponseBodyGift")]
    public partial class VouchersDisableResponseBodyGift : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VouchersDisableResponseBodyGift" /> class.
        /// </summary>
        ...
        public VouchersDisableResponseBodyGift(int? amount = default(int?), int? subtractedAmount = default(int?), int? balance = default(int?), EffectEnum? effect = default(EffectEnum?))
        {
            this._Amount = amount;
            if (this.Amount != null)
            {
