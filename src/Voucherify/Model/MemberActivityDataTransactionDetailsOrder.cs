...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MemberActivityDataTransactionDetailsOrder")]
    public partial class MemberActivityDataTransactionDetailsOrder : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MemberActivityDataTransactionDetailsOrder" /> class.
        /// </summary>
        ...
        public MemberActivityDataTransactionDetailsOrder(string id = default(string), string sourceId = default(string))
        {
            this._Id = id;
            if (this.Id != null)
            {
