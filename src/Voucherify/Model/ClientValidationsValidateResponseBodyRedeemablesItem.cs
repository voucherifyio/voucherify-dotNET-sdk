...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ClientValidationsValidateResponseBodyRedeemablesItem")]
    public partial class ClientValidationsValidateResponseBodyRedeemablesItem : IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        {
            /// <summary>
            /// Enum APPLICABLE for value: APPLICABLE
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientValidationsValidateResponseBodyRedeemablesItem" /> class.
        /// </summary>
        ...
        public ClientValidationsValidateResponseBodyRedeemablesItem(StatusEnum? status = default(StatusEnum?), string id = default(string), ObjectEnum? varObject = default(ObjectEnum?), ClientValidationsValidateResponseBodyRedeemablesItemOrder order = default(ClientValidationsValidateResponseBodyRedeemablesItemOrder), ApplicableToResultList applicableTo = default(ApplicableToResultList), InapplicableToResultList inapplicableTo = default(InapplicableToResultList), ClientValidationsValidateResponseBodyRedeemablesItemResult result = default(ClientValidationsValidateResponseBodyRedeemablesItemResult), Object metadata = default(Object), List<CategoryWithStackingRulesType> categories = default(List<CategoryWithStackingRulesType>), string campaignName = default(string), string campaignId = default(string), string name = default(string))
        {
            this._Status = status;
            if (this.Status != null)
            {
        ...
        public ClientValidationsValidateResponseBodyRedeemablesItemOrder Order
        {
            get{ return _Order;}
            set
            {
        ...
        private ClientValidationsValidateResponseBodyRedeemablesItemOrder _Order;
        ...
        public ClientValidationsValidateResponseBodyRedeemablesItemResult Result
        {
            get{ return _Result;}
            set
            {
        ...
        private ClientValidationsValidateResponseBodyRedeemablesItemResult _Result;
