...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CampaignsVouchersCreateCombinedResponseBodyPublish")]
    public partial class CampaignsVouchersCreateCombinedResponseBodyPublish : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignsVouchersCreateCombinedResponseBodyPublish" /> class.
        /// </summary>
        ...
        public CampaignsVouchersCreateCombinedResponseBodyPublish(string varObject = default(string), int? count = default(int?), string url = default(string))
        {
