...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProductsSkusUpdateRequestBody")]
    public partial class ProductsSkusUpdateRequestBody : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductsSkusUpdateRequestBody" /> class.
        /// </summary>
        ...
        public ProductsSkusUpdateRequestBody(string sku = default(string), int? price = default(int?), string currency = default(string), Object attributes = default(Object), string imageUrl = default(string), Object metadata = default(Object))
        {
            this._Sku = sku;
            if (this.Sku != null)
            {
