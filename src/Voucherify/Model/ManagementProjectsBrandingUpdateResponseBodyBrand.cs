...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManagementProjectsBrandingUpdateResponseBodyBrand")]
    public partial class ManagementProjectsBrandingUpdateResponseBodyBrand : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagementProjectsBrandingUpdateResponseBodyBrand" /> class.
        /// </summary>
        ...
        public ManagementProjectsBrandingUpdateResponseBodyBrand(string name = default(string), string privacyPolicyUrl = default(string), string termsOfUseUrl = default(string), string permissionReminder = default(string), string websiteUrl = default(string))
        {
            this._Name = name;
            if (this.Name != null)
            {
