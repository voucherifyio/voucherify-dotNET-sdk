...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltyPendingPointsDetailsEarningRuleSource")]
    public partial class LoyaltyPendingPointsDetailsEarningRuleSource : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltyPendingPointsDetailsEarningRuleSource" /> class.
        /// </summary>
        /// <param name="banner">Name of the earning rule. This is displayed as a header for the earning rule in the Dashboard..</param>
        public LoyaltyPendingPointsDetailsEarningRuleSource(string banner = default(string))
        {
            this._Banner = banner;
            if (this.Banner != null)
            {
