...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VouchersCreateResponseBodyGift")]
    public partial class VouchersCreateResponseBodyGift : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VouchersCreateResponseBodyGift" /> class.
        /// </summary>
        ...
        public VouchersCreateResponseBodyGift(int? amount = default(int?), int? subtractedAmount = default(int?), int? balance = default(int?), EffectEnum? effect = default(EffectEnum?))
        {
            this._Amount = amount;
            if (this.Amount != null)
            {
