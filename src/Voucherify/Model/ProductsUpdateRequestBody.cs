...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProductsUpdateRequestBody")]
    public partial class ProductsUpdateRequestBody : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductsUpdateRequestBody" /> class.
        /// </summary>
        ...
        public ProductsUpdateRequestBody(string name = default(string), int? price = default(int?), List<string> attributes = default(List<string>), Object metadata = default(Object), string imageUrl = default(string))
        {
            this._Name = name;
            if (this.Name != null)
            {
