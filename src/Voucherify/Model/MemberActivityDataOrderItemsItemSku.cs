...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MemberActivityDataOrderItemsItemSku")]
    public partial class MemberActivityDataOrderItemsItemSku : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MemberActivityDataOrderItemsItemSku" /> class.
        /// </summary>
        ...
        public MemberActivityDataOrderItemsItemSku(string id = default(string), string sourceId = default(string), bool? varOverride = default(bool?), string sku = default(string), decimal? price = default(decimal?), Object metadata = default(Object))
        {
            this._Id = id;
            if (this.Id != null)
            {
