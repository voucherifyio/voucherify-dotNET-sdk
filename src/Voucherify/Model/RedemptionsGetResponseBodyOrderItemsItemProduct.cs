...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RedemptionsGetResponseBodyOrderItemsItemProduct")]
    public partial class RedemptionsGetResponseBodyOrderItemsItemProduct : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RedemptionsGetResponseBodyOrderItemsItemProduct" /> class.
        /// </summary>
        ...
        public RedemptionsGetResponseBodyOrderItemsItemProduct(string id = default(string), string sourceId = default(string), bool? varOverride = default(bool?), string name = default(string), Object metadata = default(Object), decimal? price = default(decimal?))
        {
            this._Id = id;
            if (this.Id != null)
            {
