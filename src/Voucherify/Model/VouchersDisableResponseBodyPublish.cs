...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VouchersDisableResponseBodyPublish")]
    public partial class VouchersDisableResponseBodyPublish : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VouchersDisableResponseBodyPublish" /> class.
        /// </summary>
        ...
        public VouchersDisableResponseBodyPublish(string varObject = default(string), int? count = default(int?), string url = default(string))
        {
