...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PromotionsTiersUpdateResponseBodySummaryRedemptions")]
    public partial class PromotionsTiersUpdateResponseBodySummaryRedemptions : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PromotionsTiersUpdateResponseBodySummaryRedemptions" /> class.
        /// </summary>
        /// <param name="totalRedeemed">Number of times the promotion tier was redeemed..</param>
        public PromotionsTiersUpdateResponseBodySummaryRedemptions(int? totalRedeemed = default(int?))
        {
