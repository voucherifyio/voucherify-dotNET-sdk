...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RewardsAssignmentsCreateRequestBodyParametersLoyalty")]
    public partial class RewardsAssignmentsCreateRequestBodyParametersLoyalty : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RewardsAssignmentsCreateRequestBodyParametersLoyalty" /> class.
        /// </summary>
        /// <param name="points">Number of points that will be subtracted from the loyalty card points balance if the reward is redeemed. Must be positive integer..</param>
        ...
        public RewardsAssignmentsCreateRequestBodyParametersLoyalty(int? points = default(int?), bool? autoRedeem = default(bool?))
        {
            this._Points = points;
            if (this.Points != null)
            {
        ...
        /// </summary>
        /// <value>Number of points that will be subtracted from the loyalty card points balance if the reward is redeemed. Must be positive integer.</value>
        ...
        {
            // Points (int?) minimum
            if (this.Points < (int?)1)
            {
                yield return new ValidationResult("Invalid value for Points, must be a value greater than or equal to 1.", new [] { "Points" });
            }
