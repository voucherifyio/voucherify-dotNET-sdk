...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderTotalAmount")]
    public partial class LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderTotalAmount : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderTotalAmount" /> class.
        /// </summary>
        ...
        public LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderTotalAmount(int? every = default(int?), int? points = default(int?), string pointsFormula = default(string))
        {
            this._Every = every;
            if (this.Every != null)
            {
