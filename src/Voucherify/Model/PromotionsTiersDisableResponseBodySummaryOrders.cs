...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PromotionsTiersDisableResponseBodySummaryOrders")]
    public partial class PromotionsTiersDisableResponseBodySummaryOrders : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PromotionsTiersDisableResponseBodySummaryOrders" /> class.
        /// </summary>
        ...
        public PromotionsTiersDisableResponseBodySummaryOrders(int? totalAmount = default(int?), int? totalDiscountAmount = default(int?))
        {
