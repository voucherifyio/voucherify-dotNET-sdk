...
namespace Voucherify.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VoucherWithCategoriesGift")]
    public partial class VoucherWithCategoriesGift : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VoucherWithCategoriesGift" /> class.
        /// </summary>
        ...
        public VoucherWithCategoriesGift(int? amount = default(int?), int? subtractedAmount = default(int?), int? balance = default(int?), EffectEnum? effect = default(EffectEnum?))
        {
            this._Amount = amount;
            if (this.Amount != null)
            {
