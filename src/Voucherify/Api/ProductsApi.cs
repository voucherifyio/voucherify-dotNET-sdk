...
namespace Voucherify.Api
{
    ...
    public partial class ProductsApi : IProductsApi
    {
        ...
        /// <summary>
        /// Create Product Creates a product object. &lt;Note&gt; &lt;Badge color blue&gt;Upsert Mode&lt;/Badge&gt; If you pass an id or a source_id that already exists in the product database, Voucherify will return a related product object with updated fields. &lt;/Note&gt;
        /// </summary>
        /// <exception cref="Voucherify.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="productsCreateRequestBody">Specify the product parameters.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        ...
        /// <summary>
        /// Create SKU This method adds product variants to a [created product](/api-reference/products/create-product).  &lt;Note&gt; &lt;Badge color blue&gt;Upsert Mode&lt;/Badge&gt; If you pass an id or a source_id that already exists in the sku database, Voucherify will return a related sku object with updated fields. &lt;/Note&gt;
        /// </summary>
        /// <exception cref="Voucherify.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="productId">A Voucherify [product](/api-reference/products/get-product) ID or product source ID.</param>
        /// <param name="productsSkusCreateRequestBody">Specify the SKU parameters to be created.</param>
