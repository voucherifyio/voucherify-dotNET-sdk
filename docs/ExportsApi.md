...
namespace Example
{
    public class DeleteExportExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new ExportsApi(config);
            var exportId = "exportId_example";  // string | Unique export object ID of previously created export. This object can be a: voucher, redemption, publication, customer, order, points_expiration, voucher_transactions, product, or sku.
