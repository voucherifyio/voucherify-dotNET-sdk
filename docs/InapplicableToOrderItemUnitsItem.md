# Voucherify.Model.InapplicableToOrderItemUnitsItem
...
**UnitsLimitExceeded** | **bool** | Returned as &#x60;true&#x60; only when the sum total of &#x60;quantity&#x60; of all order items exceeds 1000. | [optional] 
