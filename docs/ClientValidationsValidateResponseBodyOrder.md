# Voucherify.Model.ClientValidationsValidateResponseBodyOrder
...
**Items** | [**List&lt;ClientValidationsValidateResponseBodyOrderItemsItem&gt;**](ClientValidationsValidateResponseBodyOrderItemsItem.md) | Array of items applied to the order. It can include up to 500 items. | [optional] 
