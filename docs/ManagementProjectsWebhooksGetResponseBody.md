# Voucherify.Model.ManagementProjectsWebhooksGetResponseBody
...
**Events** | **List&lt;ManagementProjectsWebhooksGetResponseBody.EventsEnum&gt;** | Lists the events that trigger webhook sendout. | [optional] 
